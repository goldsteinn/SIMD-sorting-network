...
#define TYPE      uint8_t
#define N         4
#define SORT_NAME batcher_4_uint8_t

#ifndef _SIMD_SORT_batcher_4_uint8_t_H_
#define _SIMD_SORT_batcher_4_uint8_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) batcher_4_uint8_t_vec(__m64 v) {
