...
#define N 7
#define SORT_NAME oddeven_7_uint32_t

#ifndef _SIMD_SORT_oddeven_7_uint32_t_H_
#define _SIMD_SORT_oddeven_7_uint32_t_H_
...
oddeven_7_uint32_t_vec(__m256i v) {
      ...
      /* Pairs: ([7,7], [5,6], [0,4], [3,3], [1,2]) */
      /* Perm:  ( 7,  5,  6,  0,  3,  1,  2,  4) */
      ...
      __m256i v2 = _mm256_blend_epi32(max2, min2, 0x23);
      ...
      __m256i perm4 = _mm256_permute4x64_epi64(v3, 0xd8);
      __m256i min4 = _mm256_min_epu32(v3, perm4);
      __m256i max4 = _mm256_max_epu32(v3, perm4);
      __m256i v4 = _mm256_blend_epi32(max4, min4, 0xc);
...
oddeven_7_uint32_t(uint32_t * const 
                             arr) {
