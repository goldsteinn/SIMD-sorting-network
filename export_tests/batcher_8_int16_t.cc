...
#define TYPE int16_t
#define N 8
#define SORT_NAME batcher_8_int16_t

#ifndef _SIMD_SORT_batcher_8_int16_t_H_
#define _SIMD_SORT_batcher_8_int16_t_H_
...
batcher_8_int16_t_vec(__m128i v) {
...
batcher_8_int16_t(int16_t * const arr) 
                             {
