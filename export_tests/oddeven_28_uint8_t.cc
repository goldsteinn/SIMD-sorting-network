...
#define TYPE uint8_t
#define N 28
#define SORT_NAME oddeven_28_uint8_t

#ifndef _SIMD_SORT_oddeven_28_uint8_t_H_
#define _SIMD_SORT_oddeven_28_uint8_t_H_
...
oddeven_28_uint8_t_vec(__m256i v) {
      ...
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0xffe, min10);
...
oddeven_28_uint8_t(uint8_t * const arr) 
                             {
