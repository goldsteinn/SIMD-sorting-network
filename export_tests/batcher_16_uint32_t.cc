...
#define N 16
#define SORT_NAME batcher_16_uint32_t

#ifndef _SIMD_SORT_batcher_16_uint32_t_H_
#define _SIMD_SORT_batcher_16_uint32_t_H_
...
batcher_16_uint32_t_vec(__m512i v) {
      ...
      __m512i v3 = _mm512_mask_mov_epi32(max3, 0x4331, min3);
...
batcher_16_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_16_uint32_t_vec(v);
