...
bitonic_13_int16_t_vec(__m256i v) {
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [9,12], [10,11], [8,8], [6,7], 
                 [5,5], [3,4], [0,2], [1,1]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [10,12], [11,11], [7,9], [6,8], 
                 [3,5], [2,4], [0,1]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [1,12], [10,11], [8,9], [6,7], 
                 [4,5], [2,3], [0,0]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [8,12], [9,11], [10,10], [2,7], 
                 [3,6], [1,5], [0,4]) */
...
bitonic_13_int16_t(int16_t * const arr) 
                             {
