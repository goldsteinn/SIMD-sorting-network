...
#define TYPE int32_t
#define N 4
#define SORT_NAME bosenelson_4_int32_t

#ifndef _SIMD_SORT_bosenelson_4_int32_t_H_
#define _SIMD_SORT_bosenelson_4_int32_t_H_
...
bosenelson_4_int32_t_vec(__m128i v) {
...
bosenelson_4_int32_t(int32_t * const 
                             arr) {
