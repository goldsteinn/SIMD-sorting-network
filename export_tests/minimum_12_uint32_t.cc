...
#define N 12
#define SORT_NAME minimum_12_uint32_t

#ifndef _SIMD_SORT_minimum_12_uint32_t_H_
#define _SIMD_SORT_minimum_12_uint32_t_H_
...
minimum_12_uint32_t_vec(__m512i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [3,11], [4,10], [5,9], 
                 [0,8], [1,7], [2,6]) */
      /* Perm:  (15, 14, 13, 12,  3,  4,  5,  0,  1,  2,  9, 10, 11,  6,  7,  
                 8) */
      ...
      __m512i v7 = _mm512_mask_mov_epi32(max7, 0x2aa, min7);
...
minimum_12_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_12_uint32_t_vec(v);
