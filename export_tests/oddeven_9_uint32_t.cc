...
#define N 9
#define SORT_NAME oddeven_9_uint32_t

#ifndef _SIMD_SORT_oddeven_9_uint32_t_H_
#define _SIMD_SORT_oddeven_9_uint32_t_H_
...
oddeven_9_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x55, min0);
      ...
      __m512i v6 = _mm512_mask_mov_epi32(max6, 0x18, min6);
      ...
      __m512i v7 = _mm512_mask_mov_epi32(max7, 0x44, min7);
