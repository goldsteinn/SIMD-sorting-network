...
#define TYPE int16_t
#define N 16
#define SORT_NAME oddeven_16_int16_t

#ifndef _SIMD_SORT_oddeven_16_int16_t_H_
#define _SIMD_SORT_oddeven_16_int16_t_H_
...
oddeven_16_int16_t_vec(__m256i v) {
...
oddeven_16_int16_t(int16_t * const arr) 
                             {
