...
#define TYPE int32_t
#define N 4
#define SORT_NAME batcher_4_int32_t

#ifndef _SIMD_SORT_batcher_4_int32_t_H_
#define _SIMD_SORT_batcher_4_int32_t_H_
...
batcher_4_int32_t_vec(__m128i v) {
...
batcher_4_int32_t(int32_t * const arr) 
                             {
