...
#define TYPE int32_t
#define N 9
#define SORT_NAME minimum_9_int32_t

#ifndef _SIMD_SORT_minimum_9_int32_t_H_
#define _SIMD_SORT_minimum_9_int32_t_H_
...
minimum_9_int32_t_vec(__m512i v) {
...
minimum_9_int32_t(int32_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_9_int32_t_vec(v);
