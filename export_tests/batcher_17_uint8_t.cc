...
#define TYPE uint8_t
#define N 17
#define SORT_NAME batcher_17_uint8_t

#ifndef _SIMD_SORT_batcher_17_uint8_t_H_
#define _SIMD_SORT_batcher_17_uint8_t_H_
...
batcher_17_uint8_t_vec(__m256i v) {
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17,  
                 0,  7,  6,  5,  4,  3,  2,  1,  8, 15, 14, 13, 12, 11, 10,  
                 9, 16) */
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 17, 0, 7, 6, 5, 4, 3, 
                                              2, 1, 8, 15, 14, 13, 12, 11, 
                                              10, 9, 16), v);
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17, 
                 16, 11, 10,  9, 12, 15, 14, 13,  0,  3,  2,  1,  4,  7,  6,  
                 5,  8) */
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0xe0f, min1);
      ...
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0x2aaa, min10);
...
batcher_17_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = batcher_17_uint8_t_vec(v);
