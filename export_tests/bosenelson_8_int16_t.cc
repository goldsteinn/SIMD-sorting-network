...
#define TYPE int16_t
#define N 8
#define SORT_NAME bosenelson_8_int16_t

#ifndef _SIMD_SORT_bosenelson_8_int16_t_H_
#define _SIMD_SORT_bosenelson_8_int16_t_H_
...
bosenelson_8_int16_t_vec(__m128i v) {
...
bosenelson_8_int16_t(int16_t * const 
                             arr) {
