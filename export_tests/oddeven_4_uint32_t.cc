...
#define N 4
#define SORT_NAME oddeven_4_uint32_t

#ifndef _SIMD_SORT_oddeven_4_uint32_t_H_
#define _SIMD_SORT_oddeven_4_uint32_t_H_
...
oddeven_4_uint32_t_vec(__m128i v) {
...
oddeven_4_uint32_t(uint32_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_4_uint32_t_vec(v);
