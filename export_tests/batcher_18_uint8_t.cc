...
#define TYPE uint8_t
#define N 18
#define SORT_NAME batcher_18_uint8_t

#ifndef _SIMD_SORT_batcher_18_uint8_t_H_
#define _SIMD_SORT_batcher_18_uint8_t_H_
...
batcher_18_uint8_t_vec(__m256i v) {
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0xc0f, min1);
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 9, 8, 15, 14, 13, 12, 
                                              7, 6, 17, 16, 11, 10, 1, 0, 3, 
                                              2, 5, 4), v1);
      __m256i min2 = _mm256_min_epu8(v1, perm2);
      __m256i max2 = _mm256_max_epu8(v1, perm2);
      __m256i v2 = _mm256_mask_mov_epi8(max2, 0x3c3, min2);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 5, 4, 15, 14, 9, 8, 11, 
                                              10, 13, 12, 7, 6, 17, 16, 1, 0, 
                                              3, 2), v2);
      __m256i min3 = _mm256_min_epu8(v2, perm3);
      __m256i max3 = _mm256_max_epu8(v2, perm3);
      __m256i v3 = _mm256_mask_mov_epi8(max3, 0x333, min3);
      ...
      __m256i v4 = _mm256_mask_mov_epi8(max4, 0x3031, min4);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 3, 2, 13, 12, 15, 14, 
                                              9, 8, 11, 10, 5, 4, 7, 6, 17, 
                                              16, 1, 0), v4);
      __m256i min5 = _mm256_min_epu8(v4, perm5);
      __m256i max5 = _mm256_max_epu8(v4, perm5);
      __m256i v5 = _mm256_mask_mov_epi8(max5, 0x333c, min5);
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 17, 1, 15, 7, 13, 5, 
                                              11, 3, 9, 8, 14, 6, 12, 4, 10, 
                                              2, 16, 0), v8);
      __m256i min9 = _mm256_min_epu8(v8, perm9);
      __m256i max9 = _mm256_max_epu8(v8, perm9);
      __m256i v9 = _mm256_mask_mov_epi8(max9, 0xaa, min9);
      ...
      __m256i perm10 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 
                                               ...
                                               21, 20, 19, 18, 17, 9, 15, 11, 
                                               13, 12, 14, 7, 16, 1, 10, 3, 
                                               5, 4, 6, 2, 8, 0), v9);
      __m256i min10 = _mm256_min_epu8(v9, perm10);
      __m256i max10 = _mm256_max_epu8(v9, perm10);
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0xa8a, min10);
      ...
      __m256i v11 = _mm256_mask_mov_epi8(max11, 0x2222, min11);
...
batcher_18_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = batcher_18_uint8_t_vec(v);
