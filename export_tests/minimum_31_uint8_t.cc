...
#define TYPE uint8_t
#define N 31
#define SORT_NAME minimum_31_uint8_t

#ifndef _SIMD_SORT_minimum_31_uint8_t_H_
#define _SIMD_SORT_minimum_31_uint8_t_H_
...
minimum_31_uint8_t_vec(__m256i v) {
      ...
      /* Perm:  (31, 28, 29, 30, 25, 24, 27, 26, 21, 20, 23, 22, 17, 16, 19, 
                 ...
                 3,  2) */
      __m256i perm1 = _mm256_shuffle_epi8(v0, _mm256_set_epi8(31, 28, 29, 30, 
      ...
      /* Perm:  (31, 26, 25, 24, 27, 30, 29, 28, 19, 18, 17, 16, 23, 22, 21, 
                 ...
                 5,  4) */
      __m256i perm2 = _mm256_shuffle_epi8(v1, _mm256_set_epi8(31, 26, 25, 24, 
                                          27, 30, 29, 28, 19, 18, 17, 16, 23, 
      ...
      /* Perm:  (31, 22, 21, 20, 19, 18, 17, 16, 23, 30, 29, 28, 27, 26, 25, 
                 ...
                 9,  8) */
      __m256i perm3 = _mm256_shuffle_epi8(v2, _mm256_set_epi8(31, 22, 21, 20, 
      ...
      /* Perm:  (31, 23, 27, 19, 29, 21, 22, 17, 30, 25, 26, 18, 28, 20, 24,  
                 ...
                 8, 16) */
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 23, 27, 19, 
                                              29, 21, 22, 17, 30, 25, 26, 18, 
                                              28, 20, 24, 0, 15, 7, 11, 3, 
                                              13, 5, 6, 1, 14, 9, 10, 2, 12, 
                                              4, 8, 16), v3);
      ...
      /* Perm:  (31, 29, 30, 26, 23, 28,  9, 20, 27,  6, 19, 24, 21, 17, 18, 
                 ...
                 2,  0) */
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 29, 30, 26, 
                                              23, 28, 9, 20, 27, 6, 19, 24, 
                                              21, 17, 18, 16, 15, 13, 14, 10, 
                                              7, 12, 25, 4, 11, 22, 3, 8, 5, 
                                              1, 2, 0), v4);
      ...
      /* Perm:  (31, 14, 13, 12, 11, 21, 25,  8,  7, 22, 26,  4,  3,  2,  1, 
                 ...
                 17,  0) */
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 14, 13, 12, 
                                              11, 21, 25, 8, 7, 22, 26, 4, 3, 
                                              2, 1, 16, 15, 30, 29, 28, 27, 
                                              5, 9, 24, 23, 6, 10, 20, 19, 
                                              18, 17, 0), v5);
      ...
      /* Perm:  (31, 30, 29, 14, 15, 10, 13, 22, 11, 24,  5,  8, 19,  6,  3,  
                 ...
                 1,  0) */
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 14, 
                                              15, 10, 13, 22, 11, 24, 5, 8, 
                                              19, 6, 3, 4, 27, 28, 25, 12, 
                                              23, 26, 7, 20, 9, 18, 21, 16, 
                                              17, 2, 1, 0), v6);
      ...
      /* Perm:  (31, 27, 29, 23, 30, 15, 25, 14, 28, 10,  9, 12, 11, 18,  7,  
                 ...
                 4,  0) */
      __m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 27, 29, 23, 
                                              30, 15, 25, 14, 28, 10, 9, 12, 
                                              11, 18, 7, 5, 26, 24, 13, 20, 
                                              19, 22, 21, 3, 17, 6, 16, 1, 8, 
                                              2, 4, 0), v7);
      ...
      /* Perm:  (31, 30, 26, 28, 27, 29, 25, 23, 24, 13, 21, 14, 15,  9, 11, 
                 ...
                 1,  0) */
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 26, 28, 
                                              27, 29, 25, 23, 24, 13, 21, 14, 
                                              15, 9, 11, 12, 19, 20, 22, 16, 
                                              17, 10, 18, 7, 8, 6, 2, 4, 3, 
                                              5, 1, 0), v8);
      ...
      /* Perm:  (31, 30, 27, 28, 29, 26, 19, 24, 23, 15, 20, 21, 25, 14, 13,  
                 ...
                 1,  0) */
      __m256i perm10 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 27, 
                                               28, 29, 26, 19, 24, 23, 15, 
                                               20, 21, 25, 14, 13, 9, 22, 18, 
                                               17, 6, 10, 11, 16, 8, 7, 12, 
                                               5, 2, 3, 4, 1, 0), v9);
...
minimum_31_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = minimum_31_uint8_t_vec(v);
