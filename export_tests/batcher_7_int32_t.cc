...
#define TYPE int32_t
#define N 7
#define SORT_NAME batcher_7_int32_t

#ifndef _SIMD_SORT_batcher_7_int32_t_H_
#define _SIMD_SORT_batcher_7_int32_t_H_
...
batcher_7_int32_t_vec(__m256i v) {
...
batcher_7_int32_t(int32_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = batcher_7_int32_t_vec(v);
