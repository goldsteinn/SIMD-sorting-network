...
#define TYPE uint8_t
#define N 7
#define SORT_NAME oddeven_7_uint8_t

#ifndef _SIMD_SORT_oddeven_7_uint8_t_H_
#define _SIMD_SORT_oddeven_7_uint8_t_H_
...
oddeven_7_uint8_t_vec(__m64 v) {
      ...
      __m64 perm4 = _mm_shuffle_pi16(v3, 0xd8);
      __m64 min4 = _mm_min_pu8(v3, perm4);
      __m64 max4 = _mm_max_pu8(v3, perm4);
      __m64 _tmp5 = (__m64)(0xffff0000UL);
...
oddeven_7_uint8_t(uint8_t * const arr) 
                             {
