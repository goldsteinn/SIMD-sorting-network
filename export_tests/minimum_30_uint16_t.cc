...
#define N 30
#define SORT_NAME minimum_30_uint16_t

#ifndef _SIMD_SORT_minimum_30_uint16_t_H_
#define _SIMD_SORT_minimum_30_uint16_t_H_
...
minimum_30_uint16_t_vec(__m512i v) {
      ...
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0x30f0f0f, min2);
      ...
      /* Perm:  (31, 30, 21, 20, 19, 18, 17, 16, 23, 22, 29, 28, 27, 26, 25, 
                 ...
                 9,  8) */
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 21, 
      ...
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x3f00ff, min3);
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x49a26da, min5);
      ...
      /* Perm:  (31, 30, 13, 12, 11, 21, 25,  8,  7, 22, 26,  4,  3,  2,  1, 
                 ...
                 17,  0) */
      __m512i perm6 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 13, 
...
minimum_30_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_30_uint16_t_vec(v);
