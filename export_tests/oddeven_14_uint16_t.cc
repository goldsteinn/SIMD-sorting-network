...
#define N 14
#define SORT_NAME oddeven_14_uint16_t

#ifndef _SIMD_SORT_oddeven_14_uint16_t_H_
#define _SIMD_SORT_oddeven_14_uint16_t_H_
...
oddeven_14_uint16_t_vec(__m256i v) {
...
oddeven_14_uint16_t(uint16_t * const 
                             arr) {
