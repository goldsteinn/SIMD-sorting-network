...
#define TYPE uint8_t
#define N 16
#define SORT_NAME minimum_16_uint8_t

#ifndef _SIMD_SORT_minimum_16_uint8_t_H_
#define _SIMD_SORT_minimum_16_uint8_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_16_uint8_t_vec(__m128i v) {
...
void inline __attribute__((always_inline)) minimum_16_uint8_t(uint8_t * const arr) {

__m128i _tmp0 = _mm_set1_epi8(uint8_t(0xff));
__m128i v = _mm_mask_loadu_epi32(_tmp0, 0xf, (int32_t * const)arr);
fill_works(v);
v = minimum_16_uint8_t_vec(v);
