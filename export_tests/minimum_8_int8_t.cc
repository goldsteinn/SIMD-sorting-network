...
#define TYPE int8_t
#define N 8
#define SORT_NAME minimum_8_int8_t

#ifndef _SIMD_SORT_minimum_8_int8_t_H_
#define _SIMD_SORT_minimum_8_int8_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) minimum_8_int8_t_vec(__m64 v) {
...
__m64 perm1 = _mm_shuffle_pi16(v0, 0x4e);
...
__m64 _tmp6 = (__m64)(0xffffffffUL);
...
__m64 _tmp12 = (__m64)(0xffff0000UL);
...
__m64 perm4 = _mm_shuffle_pi8(v3, _mm_set_pi8(7, 3, 5, 1, 6, 2, 4, 0));
...
void inline __attribute__((always_inline)) minimum_8_int8_t(int8_t * const arr) {

__m64 _tmp0 = _mm_set1_pi8(int8_t(0x7f));
__builtin_memcpy(&_tmp0, arr, 8);
__m64 v = _tmp0;
fill_works(v);
v = minimum_8_int8_t_vec(v);
