...
#define TYPE int8_t
#define N 12
#define SORT_NAME oddeven_12_int8_t

#ifndef _SIMD_SORT_oddeven_12_int8_t_H_
#define _SIMD_SORT_oddeven_12_int8_t_H_
...
oddeven_12_int8_t_vec(__m128i v) {
      ...
      __m128i v0 = _mm_mask_mov_epi8(max0, 0x555, min0);
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [3,11], [2,10], [1,9], 
                 [4,8], [7,7], [6,6], [5,5], [0,0]) */
      /* Perm:  (15, 14, 13, 12,  3,  2,  1,  4,  7,  6,  5,  8, 11, 10,  9,  
                 0) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 3, 2, 
                                       1, 4, 7, 6, 5, 8, 11, 10, 9, 0));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [7,11], [6,10], [5,9], 
                 [8,8], [2,4], [3,3], [1,1], [0,0]) */
      /* Perm:  (15, 14, 13, 12,  7,  6,  5,  8, 11, 10,  9,  2,  3,  4,  1,  
                 0) */
      __m128i perm7 = _mm_shuffle_epi8(v6, _mm_set_epi8(15, 14, 13, 12, 7, 6, 
                                       5, 8, 11, 10, 9, 2, 3, 4, 1, 0));
      __m128i min7 = _mm_min_epi8(v6, perm7);
      __m128i max7 = _mm_max_epi8(v6, perm7);
      __m128i v7 = _mm_mask_mov_epi8(max7, 0xe4, min7);
...
oddeven_12_int8_t(int8_t * const arr) 
                             {
