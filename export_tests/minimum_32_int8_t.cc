...
#define TYPE int8_t
#define N 32
#define SORT_NAME minimum_32_int8_t

#ifndef _SIMD_SORT_minimum_32_int8_t_H_
#define _SIMD_SORT_minimum_32_int8_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_32_int8_t_vec(__m256i v) {
