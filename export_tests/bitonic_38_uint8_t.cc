...
#define TYPE uint8_t
#define N 38
#define SORT_NAME bitonic_38_uint8_t

#ifndef _SIMD_SORT_bitonic_38_uint8_t_H_
#define _SIMD_SORT_bitonic_38_uint8_t_H_
...
bitonic_38_uint8_t_vec(__m512i v) {
...
bitonic_38_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i _tmp0 = _mm512_set1_epi8(uint8_t(0xff));
      __m512i v = _mm512_mask_loadu_epi8(_tmp0, 0x3fffffffff, arr);
      fill_works(v);
      v = bitonic_38_uint8_t_vec(v);
      
      fill_works(v);_mm512_mask_storeu_epi8((void *)arr, 0x3fffffffff, v);
