...
#define TYPE uint8_t
#define N 26
#define SORT_NAME oddeven_26_uint8_t

#ifndef _SIMD_SORT_oddeven_26_uint8_t_H_
#define _SIMD_SORT_oddeven_26_uint8_t_H_
...
oddeven_26_uint8_t_vec(__m256i v) {
      ...
      __m256i perm6 = _mm256_shuffle_epi8(v5, _mm256_set_epi8(31, 30, 29, 28, 
                                          27, 26, 17, 20, 23, 22, 21, 24, 19, 
                                          18, 25, 16, 15, 6, 5, 4, 3, 2, 1, 
                                          8, 7, 14, 13, 12, 11, 10, 9, 0));
      __m256i min6 = _mm256_min_epu8(v5, perm6);
      __m256i max6 = _mm256_max_epu8(v5, perm6);
      __m256i v6 = _mm256_mask_mov_epi8(max6, 0x12007e, min6);
      ...
      __m256i v9 = _mm256_mask_mov_epi8(max9, 0xa82aaa, min9);
      ...
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0x3fe, min10);
      ...
      __m256i v12 = _mm256_mask_mov_epi8(max12, 0x30f0f0, min12);
