...
batcher_13_uint16_t_vec(__m256i v) {
      ...
      __m256i v0 = _mm256_mask_mov_epi16(max0, 0x1f, min0);
      ...
      __m256i v1 = _mm256_mask_mov_epi16(max1, 0x10f, min1);
      ...
      __m256i v3 = _mm256_mask_mov_epi16(max3, 0x331, min3);
      ...
      __m256i v4 = _mm256_mask_mov_epi16(max4, 0x4c, min4);
      ...
      __m256i v5 = _mm256_mask_mov_epi16(max5, 0x4cc, min5);
      ...
      __m256i v6 = _mm256_mask_mov_epi16(max6, 0x554, min6);
      ...
      __m256i v7 = _mm256_mask_mov_epi16(max7, 0x2a, min7);
      ...
      __m256i v8 = _mm256_mask_mov_epi16(max8, 0x2aa, min8);
