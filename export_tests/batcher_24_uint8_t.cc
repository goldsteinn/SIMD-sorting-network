...
#define TYPE uint8_t
#define N 24
#define SORT_NAME batcher_24_uint8_t

#ifndef _SIMD_SORT_batcher_24_uint8_t_H_
#define _SIMD_SORT_batcher_24_uint8_t_H_
...
batcher_24_uint8_t_vec(__m256i v) {
...
batcher_24_uint8_t(uint8_t * const arr) 
                             {
