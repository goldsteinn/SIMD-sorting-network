...
bitonic_11_int8_t_vec(__m128i v) {
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [9,10], [10,9], 
                 [8,8], [6,7], [7,6], [5,5], [3,4], [4,3], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 11,  9, 10,  8,  6,  7,  5,  3,  4,  0,  1) 
                 */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [8,10], [9,9], 
                 [10,8], [7,7], [5,6], [6,5], [2,3], [3,2]) */
      /* Perm:  (15, 14, 13, 12, 11,  8,  9, 10,  7,  5,  6,  2,  3) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], 
                 [9,8], [3,4], [4,3], [0,2], [2,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  3,  4,  0,  2) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [6,10], [7,9], 
                 [8,8], [9,7], [10,6], [5,5], [2,4], [1,3], [4,2], [3,1]) */
      ...
      __m128i v3 = _mm_blendv_epi8(max3, min3, _mm_set_epi8(0, 0, 0, 0, 0, 0, 
                                   0, 0, 128, 128, 0, 0, 0, 128, 128, 0));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [9,10], [10,9], 
                 [6,8], [5,7], [8,6], [7,5], [3,4], [4,3], [1,2], [2,1]) */
      ...
      __m128i v4 = _mm_blendv_epi8(max4, min4, _mm_set_epi8(0, 0, 0, 0, 0, 0, 
                                   128, 0, 0, 128, 128, 0, 128, 0, 128, 0));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [2,10], [3,9], 
                 [7,8], [8,7], [5,6], [6,5], [9,3], [10,2]) */
      /* Perm:  (15, 14, 13, 12, 11,  2,  3,  7,  8,  5,  6,  9, 10) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [4,8], [1,7], [2,6], [3,5], [8,4], [5,3], [6,2], [7,1]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [8,10], [9,9], 
                 [10,8], [0,4], [1,3], [3,1], [4,0]) */
      /* Perm:  (15, 14, 13, 12, 11,  8,  9, 10,  0,  1,  3,  4) */
      ...
      __m128i v7 = _mm_blendv_epi8(max7, min7, _mm_set_epi8(0, 0, 0, 0, 0, 0, 
                                   0, 128, 0, 0, 128, 0, 0, 0, 128, 128));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], 
                 [9,8], [7,7], [4,6], [6,4], [0,2], [2,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  7,  4,  6,  0,  2) */
