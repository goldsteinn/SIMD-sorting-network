...
#define N 26
#define SORT_NAME minimum_26_uint16_t

#ifndef _SIMD_SORT_minimum_26_uint16_t_H_
#define _SIMD_SORT_minimum_26_uint16_t_H_
...
minimum_26_uint16_t_vec(__m512i v) {
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [12,25], [19,24], [17,23], [5,22], [18,21], [3,20], [9,16], 
                 [10,15], [11,14], [0,13], [2,8], [4,7], [1,6]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 12, 19, 17,  5, 18,  3, 24, 21, 23,  
                 9, 10, 11,  0, 25, 14, 15, 16,  2,  4,  1, 22,  7, 20,  8,  
                 6, 13) */
      __m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 12, 19, 17, 5, 18, 
                                               3, 24, 21, 23, 9, 10, 11, 0, 
                                               25, 14, 15, 16, 2, 4, 1, 22, 
                                               7, 20, 8, 6, 13), v);
      __m512i min0 = _mm512_min_epu16(v, perm0);
      __m512i max0 = _mm512_max_epu16(v, perm0);
      __m512i v0 = _mm512_mask_mov_epi16(max0, 0xe1e3f, min0);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [22,25], [6,24], [23,23], [7,21], [13,20], [1,19], [4,18], 
                 [9,17], [8,16], [14,15], [5,12], [10,11], [0,3], [2,2]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 22,  6, 23, 25,  7, 13,  1,  4,  9,  
                 8, 14, 15, 20,  5, 10, 11, 17, 16, 21, 24, 12, 18,  0,  2, 
                 19,  3) */
      __m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 22, 6, 23, 25, 7, 
                                               13, 1, 4, 9, 8, 14, 15, 20, 5, 
                                               10, 11, 17, 16, 21, 24, 12, 
                                               18, 0, 2, 19, 3), v0);
      __m512i min1 = _mm512_min_epu16(v0, perm1);
      __m512i max1 = _mm512_max_epu16(v0, perm1);
      __m512i v1 = _mm512_mask_mov_epi16(max1, 0x4067f3, min1);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [15,25], [20,24], [8,23], [13,22], [21,21], [14,19], [9,18], 
                 [2,17], [7,16], [3,12], [6,11], [0,10], [1,5], [4,4]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 15, 20,  8, 13, 21, 24, 14,  9,  2,  
                 7, 25, 19, 22,  3,  6,  0, 18, 23, 16, 11,  1,  4, 12, 17,  
                 5, 10) */
      __m512i perm2 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 15, 20, 8, 13, 21, 
                                               24, 14, 9, 2, 7, 25, 19, 22, 
                                               3, 6, 0, 18, 23, 16, 11, 1, 4, 
                                               12, 17, 5, 10), v1);
      __m512i min2 = _mm512_min_epu16(v1, perm2);
      __m512i max2 = _mm512_max_epu16(v1, perm2);
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0x10e3cf, min2);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [24,25], [16,23], [11,22], [17,21], [15,20], [12,19], 
                 [7,18], [3,14], [6,13], [5,10], [2,9], [4,8], [0,1]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 24, 25, 16, 11, 17, 15, 12,  7, 21, 
                 23, 20,  3,  6, 19, 22,  5,  2,  4, 18, 13, 10,  8, 14,  9,  
                 0,  1) */
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 24, 25, 16, 11, 
                                               17, 15, 12, 7, 21, 23, 20, 3, 
                                               6, 19, 22, 5, 2, 4, 18, 13, 
                                               10, 8, 14, 9, 0, 1), v2);
      __m512i min3 = _mm512_min_epu16(v2, perm3);
      __m512i max3 = _mm512_max_epu16(v2, perm3);
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x10398fd, min3);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [23,25], [22,24], [18,21], [19,20], [15,17], [9,16], 
                 [13,14], [11,12], [8,10], [4,7], [5,6], [1,3], [0,2]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 23, 22, 25, 24, 18, 19, 20, 21, 15,  
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0xccab33, min5);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [16,24], [14,23], [22,22], [19,21], [18,20], 
                 [17,17], [13,15], [10,12], [2,11], [1,9], [8,8], [5,7], 
                 [4,6], [3,3], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 16, 14, 22, 19, 18, 21, 20, 17, 
                 24, 13, 23, 15, 10,  2, 12,  1,  8,  5,  4,  7,  6,  3, 11,  
                 9,  0) */
      __m512i perm7 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 16, 14, 22, 
                                               19, 18, 21, 20, 17, 24, 13, 
                                               23, 15, 10, 2, 12, 1, 8, 5, 4, 
                                               7, 6, 3, 11, 9, 0), v6);
      __m512i min7 = _mm512_min_epu16(v6, perm7);
      __m512i max7 = _mm512_max_epu16(v6, perm7);
      __m512i v7 = _mm512_mask_mov_epi16(max7, 0xd6436, min7);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [22,24], [17,23], [21,21], [20,20], [11,19], 
                 [12,18], [15,16], [6,14], [7,13], [9,10], [2,8], [5,5], 
                 [4,4], [1,3], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 22, 17, 24, 21, 20, 11, 12, 23, 
                 15, 16,  6,  7, 18, 19,  9, 10,  2, 13, 14,  5,  4,  1,  8,  
                 3,  0) */
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 22, 17, 24, 
                                               21, 20, 11, 12, 23, 15, 16, 6, 
                                               7, 18, 19, 9, 10, 2, 13, 14, 
                                               5, 4, 1, 8, 3, 0), v7);
      __m512i min8 = _mm512_min_epu16(v7, perm8);
      __m512i max8 = _mm512_max_epu16(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x429ac6, min8);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [20,22], [18,21], [14,19], 
                 [16,17], [13,15], [10,12], [6,11], [8,9], [4,7], [3,5], 
                 [2,2], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 20, 18, 22, 14, 21, 16, 
      ...
      __m512i perm10 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                                ...
                                                18, 22, 14, 21, 16, 17, 13, 
                                                19, 15, 10, 6, 12, 8, 9, 4, 
                                                11, 3, 7, 5, 2, 1, 0), v9);
      __m512i min10 = _mm512_min_epu16(v9, perm10);
      __m512i max10 = _mm512_max_epu16(v9, perm10);
      __m512i v10 = _mm512_mask_mov_epi16(max10, 0x156558, min10);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [22,23], [21,21], [18,20], [17,19], 
                 [14,16], [12,15], [10,13], [9,11], [6,8], [5,7], [4,4], 
                 [2,3], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 22, 23, 21, 18, 17, 20, 19, 
      ...
      __m512i v11 = _mm512_mask_mov_epi16(max11, 0x465664, min11);
...
minimum_26_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_26_uint16_t_vec(v);
