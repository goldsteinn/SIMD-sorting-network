...
#define TYPE int32_t
#define N 4
#define SORT_NAME oddeven_4_int32_t

#ifndef _SIMD_SORT_oddeven_4_int32_t_H_
#define _SIMD_SORT_oddeven_4_int32_t_H_
...
oddeven_4_int32_t_vec(__m128i v) {
...
oddeven_4_int32_t(int32_t * const arr) 
                             {
