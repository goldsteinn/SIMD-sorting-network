...
#define N 6
#define SORT_NAME minimum_6_uint64_t

#ifndef _SIMD_SORT_minimum_6_uint64_t_H_
#define _SIMD_SORT_minimum_6_uint64_t_H_
...
minimum_6_uint64_t_vec(__m512i v) {
      
      /* Pairs: ([7,7], [6,6], [0,5], [2,4], [1,3]) */
      /* Perm:  ( 7,  6,  0,  2,  1,  4,  3,  5) */
      __m512i perm0 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 0, 2, 
                                               1, 4, 3, 5), v);
      ...
      __m512i perm1 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 3, 
                                               4, 1, 2, 0), v0);
      __m512i min1 = _mm512_min_epu64(v0, perm1);
      __m512i max1 = _mm512_max_epu64(v0, perm1);
      __m512i v1 = _mm512_mask_mov_epi64(max1, 0xa, min1);
      
      /* Pairs: ([7,7], [6,6], [2,5], [4,4], [0,3], [1,1]) */
      /* Perm:  ( 7,  6,  2,  4,  0,  5,  1,  3) */
      __m512i perm2 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 2, 4, 
                                               0, 5, 1, 3), v1);
      ...
      __m512i v3 = _mm512_mask_mov_epi64(max3, 0x15, min3);
...
minimum_6_uint64_t(uint64_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_6_uint64_t_vec(v);
