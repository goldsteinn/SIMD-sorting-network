...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_10_int8_t_vec(__m128i v) {

/* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], [4,7], [3,6], [2,5], [0,1]) */
/* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  4,  3,  2,  7,  6,  5,  0,  1) */
__m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 11, 10, 8, 9, 4, 3, 2, 7, 6, 5, 0, 1));
...
__m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 11, 10, 3, 1, 5, 0, 7, 2, 9, 4, 8, 6));
...
__m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 11, 10, 7, 6, 9, 8, 4, 5, 1, 0, 3, 2));
...
__m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 11, 10, 8, 9, 2, 4, 3, 6, 5, 7, 0, 1));
...
__m128i perm5 = _mm_shuffle_epi8(v4, _mm_set_epi8(15, 14, 13, 12, 11, 10, 9, 6, 5, 8, 7, 2, 1, 4, 3, 0));
...
__m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 11, 10, 9, 8, 6, 7, 4, 5, 2, 3, 1, 0));
...
void inline __attribute__((always_inline)) minimum_10_int8_t(int8_t * const arr) {
