...
#define N 29
#define SORT_NAME oddeven_29_uint16_t

#ifndef _SIMD_SORT_oddeven_29_uint16_t_H_
#define _SIMD_SORT_oddeven_29_uint16_t_H_
...
oddeven_29_uint16_t_vec(__m512i v) {
      ...
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x4cc0ccc, min8);
      ...
      __m512i v10 = _mm512_mask_mov_epi16(max10, 0x1ffe, min10);
      ...
      __m512i v13 = _mm512_mask_mov_epi16(max13, 0x4cccccc, min13);
