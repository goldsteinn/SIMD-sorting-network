...
#define N 11
#define SORT_NAME oddeven_11_uint32_t

#ifndef _SIMD_SORT_oddeven_11_uint32_t_H_
#define _SIMD_SORT_oddeven_11_uint32_t_H_
...
oddeven_11_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x155, min0);
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          59, 58, 57, 56, 55, 54, 53, 52, 51, 
                                          50, 49, 48, 47, 46, 45, 44, 35, 34, 
                                          33, 32, 39, 38, 37, 36, 43, 42, 41, 
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x133, min1);
      ...
      __m512i v6 = _mm512_mask_mov_epi32(max6, 0x16, min6);
      ...
      __m512i v9 = _mm512_mask_mov_epi32(max9, 0x2a8, min9);
...
oddeven_11_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = oddeven_11_uint32_t_vec(v);
