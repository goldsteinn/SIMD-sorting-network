...
#define N 8
#define SORT_NAME minimum_8_uint16_t

#ifndef _SIMD_SORT_minimum_8_uint16_t_H_
#define _SIMD_SORT_minimum_8_uint16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_8_uint16_t_vec(__m128i v) {
...
void inline __attribute__((always_inline)) minimum_8_uint16_t(uint16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(uint16_t(0xffff));
__m128i v = _mm_mask_loadu_epi32(_tmp0, 0xf, (int32_t * const)arr);
fill_works(v);
v = minimum_8_uint16_t_vec(v);
