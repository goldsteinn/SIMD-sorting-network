...
#define TYPE int16_t
#define N 26
#define SORT_NAME oddeven_26_int16_t

#ifndef _SIMD_SORT_oddeven_26_int16_t_H_
#define _SIMD_SORT_oddeven_26_int16_t_H_
...
oddeven_26_int16_t_vec(__m512i v) {
...
oddeven_26_int16_t(int16_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = oddeven_26_int16_t_vec(v);
