...
#define TYPE uint8_t
#define N 40
#define SORT_NAME batcher_40_uint8_t

#ifndef _SIMD_SORT_batcher_40_uint8_t_H_
#define _SIMD_SORT_batcher_40_uint8_t_H_
...
batcher_40_uint8_t_vec(__m512i v) {
      ...
      __m512i v2 = _mm512_mask_mov_epi8(max2, 0xff00ff, min2);
      ...
      __m512i v3 = _mm512_mask_mov_epi8(max3, 0xffff0f, min3);
      ...
      __m512i v5 = _mm512_mask_mov_epi8(max5, 0xf0f0f0f01, min5);
      
      __m512i perm6 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              59, 58, 57, 56, 55, 54, 53, 52, 
                                              51, 50, 49, 48, 47, 46, 45, 44, 
                                              43, 42, 41, 40, 37, 36, 39, 38, 
                                              7, 6, 5, 4, 31, 30, 29, 28, 15, 
                                              14, 13, 12, 23, 22, 21, 20, 19, 
                                              18, 17, 16, 27, 26, 25, 24, 11, 
                                              10, 9, 8, 35, 34, 33, 32, 3, 2, 
                                              1, 0), v5);
      __m512i min6 = _mm512_min_epu8(v5, perm6);
      __m512i max6 = _mm512_max_epu8(v5, perm6);
      __m512i v6 = _mm512_mask_mov_epi8(max6, 0x300000f0f0, min6);
...
batcher_40_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_40_uint8_t_vec(v);
