...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_20_uint16_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_20_uint16_t(uint16_t * const arr) {

__m512i v = _mm512_mask_loadu_epi16(_mm512_set1_epi16(uint16_t(0xffff)), 0xfffff, arr);
