...
#define N 20
#define SORT_NAME bitonic_20_uint16_t

#ifndef _SIMD_SORT_bitonic_20_uint16_t_H_
#define _SIMD_SORT_bitonic_20_uint16_t_H_
...
bitonic_20_uint16_t_vec(__m512i v) {
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 18, 19, 17, 
                 15, 16, 13, 14, 12, 10, 11,  8,  9,  7,  5,  6,  3,  4,  2,  
                 0,  1) */
      __m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 18, 19, 17, 15, 16, 
                                               13, 14, 12, 10, 11, 8, 9, 7, 
                                               5, 6, 3, 4, 2, 0, 1), v);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [17,19], [18,18], [16,16], [15,15], [14,14], [12,13], 
                 [11,11], [10,10], [9,9], [7,8], [6,6], [5,5], [2,4], [3,3], 
                 [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 17, 18, 19, 
                 16, 15, 14, 12, 13, 11, 10,  9,  7,  8,  6,  5,  2,  3,  4,  
                 1,  0) */
      __m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 17, 18, 19, 16, 15, 
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [16,19], [17,18], [15,15], [13,14], [10,12], [11,11], [8,9], 
                 [5,7], [6,6], [1,4], [2,3], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 16, 17, 18, 
                 19, 15, 13, 14, 10, 11, 12,  8,  9,  5,  6,  7,  1,  2,  3,  
                 4,  0) */
      __m512i perm2 = _mm512_shuffle_epi8(v1, _mm512_set_epi8(63, 62, 61, 60, 
                                          59, 58, 57, 56, 55, 54, 53, 52, 51, 
                                          50, 49, 48, 47, 46, 45, 44, 43, 42, 
                                          41, 40, 33, 32, 35, 34, 37, 36, 39, 
                                          38, 31, 30, 27, 26, 29, 28, 21, 20, 
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [19,19], [15,18], [16,17], [12,14], [11,13], [10,10], [7,9], 
                 [6,8], [5,5], [4,4], [0,3], [1,2]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 15, 16, 
                 17, 18, 12, 11, 14, 13, 10,  7,  6,  9,  8,  5,  4,  0,  1,  
                 2,  3) */
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [19,19], [17,18], [15,16], [13,14], [11,12], [10,10], [8,9], 
                 [6,7], [5,5], [4,4], [2,3], [0,1]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 17, 18, 
                 15, 16, 13, 14, 11, 12, 10,  8,  9,  6,  7,  5,  4,  2,  3,  
                 0,  1) */
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [13,19], [14,18], [11,17], [12,16], [15,15], [10,10], [9,9], 
                 [2,8], [3,7], [0,6], [1,5], [4,4]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 13, 14, 11, 
                 12, 15, 18, 19, 16, 17, 10,  9,  2,  3,  0,  1,  4,  7,  8,  
                 5,  6) */
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 13, 14, 11, 12, 15, 
                                               18, 19, 16, 17, 10, 9, 2, 3, 
                                               0, 1, 4, 7, 8, 5, 6), v4);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [18,19], [17,17], [16,16], [13,15], [10,14], [12,12], 
                 [11,11], [5,9], [8,8], [7,7], [4,6], [3,3], [2,2], [0,1]) 
                 */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 18, 19, 17, 
                 16, 13, 10, 15, 12, 11, 14,  5,  8,  7,  4,  9,  6,  3,  2,  
                 0,  1) */
      __m512i perm6 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 18, 19, 17, 16, 13, 
                                               10, 15, 12, 11, 14, 5, 8, 7, 
                                               4, 9, 6, 3, 2, 0, 1), v5);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [6,19], [7,18], [8,17], [9,16], [2,15], [3,14], [4,13], 
                 [5,12], [11,11], [10,10], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20,  6,  7,  8,  
                 9,  2,  3,  4,  5, 11, 10, 16, 17, 18, 19, 12, 13, 14, 15,  
                 1,  0) */
      __m512i perm9 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 6, 7, 8, 9, 2, 3, 4, 
                                               5, 11, 10, 16, 17, 18, 19, 12, 
                                               13, 14, 15, 1, 0), v8);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [17,19], [16,18], [15,15], [14,14], [13,13], [12,12], 
                 [6,11], [7,10], [1,9], [0,8], [5,5], [4,4], [3,3], [2,2]) 
                 */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 17, 16, 19, 
                 18, 15, 14, 13, 12,  6,  7,  1,  0, 10, 11,  5,  4,  3,  2,  
                 9,  8) */
      __m512i perm10 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                                28, 27, 26, 25, 24, 23, 22, 
                                                21, 20, 17, 16, 19, 18, 15, 
                                                14, 13, 12, 6, 7, 1, 0, 10, 
                                                11, 5, 4, 3, 2, 9, 8), v9);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [22,22], [21,21], [20,20], 
                 [18,19], [16,17], [11,15], [10,14], [8,13], [9,12], [3,7], 
                 [2,6], [1,5], [0,4]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 18, 19, 16, 
                 17, 11, 10,  8,  9, 15, 14, 12, 13,  3,  2,  1,  0,  7,  6,  
                 5,  4) */
      __m512i perm11 = _mm512_shuffle_epi8(v10, _mm512_set_epi8(63, 62, 61, 
                                           ...
                                           20, 17, 16, 19, 18, 31, 30, 29, 
                                           28, 25, 24, 27, 26, 7, 6, 5, 4, 3, 
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 ...
                 [8,11], [9,10], [5,7], [4,6], [1,3], [0,2]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17, 
                 16, 13, 12, 15, 14,  8,  9, 10, 11,  5,  4,  7,  6,  1,  0,  
                 3,  2) */
...
bitonic_20_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_20_uint16_t_vec(v);
