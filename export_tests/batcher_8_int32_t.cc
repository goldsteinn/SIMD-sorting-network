...
#define TYPE int32_t
#define N 8
#define SORT_NAME batcher_8_int32_t

#ifndef _SIMD_SORT_batcher_8_int32_t_H_
#define _SIMD_SORT_batcher_8_int32_t_H_
...
batcher_8_int32_t_vec(__m256i v) {
...
batcher_8_int32_t(int32_t * const arr) 
                             {
