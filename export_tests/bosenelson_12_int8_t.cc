...
#define TYPE int8_t
#define N 12
#define SORT_NAME bosenelson_12_int8_t

#ifndef _SIMD_SORT_bosenelson_12_int8_t_H_
#define _SIMD_SORT_bosenelson_12_int8_t_H_
...
bosenelson_12_int8_t_vec(__m128i v) {
...
bosenelson_12_int8_t(int8_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_12_int8_t_vec(v);
