...
#define N 5
#define SORT_NAME minimum_5_uint32_t

#ifndef _SIMD_SORT_minimum_5_uint32_t_H_
#define _SIMD_SORT_minimum_5_uint32_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_5_uint32_t_vec(__m256i v) {

/* Pairs: ([7,7], [6,6], [5,5], [1,4], [0,3], [2,2]) */
/* Perm:  ( 7,  6,  5,  1,  0,  2,  4,  3) */
__m256i perm0 = _mm256_permutevar8x32_epi32(v, _mm256_set_epi32(7, 6, 5, 1, 0, 2, 4, 3));
...
__m256i perm2 = _mm256_permutevar8x32_epi32(v1, _mm256_set_epi32(7, 6, 5, 2, 3, 4, 0, 1));
...
__m256i perm3 = _mm256_permutevar8x32_epi32(v2, _mm256_set_epi32(7, 6, 5, 3, 4, 1, 2, 0));
__m256i min3 = _mm256_min_epu32(v2, perm3);
__m256i max3 = _mm256_max_epu32(v2, perm3);
__m256i v3 = _mm256_blend_epi32(max3, min3, 0xa);

/* Pairs: ([7,7], [6,6], [5,5], [4,4], [2,3], [1,1], [0,0]) */
/* Perm:  ( 7,  6,  5,  4,  2,  3,  1,  0) */
__m256i perm4 = _mm256_shuffle_epi8(v3, _mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17, 16, 11, 10, 9, 8, 15, 14, 13, 12, 7, 6, 5, 4, 3, 2, 1, 0));
...
void inline __attribute__((always_inline)) minimum_5_uint32_t(uint32_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi32(uint32_t(0xffffffff));
__m256i v = _mm256_mask_loadu_epi32(_tmp0, 0x1f, (int32_t * const)arr);
fill_works(v);
v = minimum_5_uint32_t_vec(v);

fill_works(v);_mm256_mask_storeu_epi32((void *)arr, 0x1f, v);
