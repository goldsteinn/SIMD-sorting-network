...
#define TYPE uint8_t
#define N 27
#define SORT_NAME oddeven_27_uint8_t

#ifndef _SIMD_SORT_oddeven_27_uint8_t_H_
#define _SIMD_SORT_oddeven_27_uint8_t_H_
...
oddeven_27_uint8_t_vec(__m256i v) {
      ...
      __m256i v0 = _mm256_mask_mov_epi8(max0, 0x1555555, min0);
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0x1333333, min1);
      ...
      __m256i v4 = _mm256_mask_mov_epi8(max4, 0xc0c0d, min4);
      ...
      __m256i perm8 = _mm256_shuffle_epi8(v7, _mm256_set_epi8(31, 30, 29, 28, 
                                          ...
                                          17, 18, 16, 15, 14, 11, 10, 13, 12, 
                                          7, 6, 9, 8, 3, 2, 5, 4, 1, 0));
      __m256i min8 = _mm256_min_epu8(v7, perm8);
      __m256i max8 = _mm256_max_epu8(v7, perm8);
      __m256i v8 = _mm256_mask_mov_epi8(max8, 0xca0ccc, min8);
      ...
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0x7fe, min10);
      ...
      __m256i v12 = _mm256_mask_mov_epi8(max12, 0x70f0f0, min12);
      ...
      __m256i v13 = _mm256_mask_mov_epi8(max13, 0xcccccc, min13);
