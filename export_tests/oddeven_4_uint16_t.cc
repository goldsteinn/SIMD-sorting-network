...
#define N 4
#define SORT_NAME oddeven_4_uint16_t

#ifndef _SIMD_SORT_oddeven_4_uint16_t_H_
#define _SIMD_SORT_oddeven_4_uint16_t_H_
...
oddeven_4_uint16_t_vec(__m64 v) {
...
oddeven_4_uint16_t(uint16_t * const 
                             arr) {
