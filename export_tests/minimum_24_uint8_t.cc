...
minimum_24_uint8_t_vec(__m256i v) {
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 19, 18, 15, 14, 
                                              23, 22, 13, 12, 21, 20, 17, 16, 
      ...
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 11, 10, 19, 18, 
                                              21, 20, 15, 14, 17, 16, 1, 0, 
                                              23, 22, 7, 6, 9, 8, 3, 2, 5, 4, 
                                              13, 12), v3);
...
minimum_24_uint8_t(uint8_t * const arr) 
                             {
