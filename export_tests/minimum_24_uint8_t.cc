...
#define TYPE uint8_t
#define N 24
#define SORT_NAME minimum_24_uint8_t

#ifndef _SIMD_SORT_minimum_24_uint8_t_H_
#define _SIMD_SORT_minimum_24_uint8_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_24_uint8_t_vec(__m256i v) {

/* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], [25,25], [24,24], [22,23], [20,21], [18,19], [16,17], [14,15], [12,13], [10,11], [8,9], [6,7], [4,5], [2,3], [0,1]) */
/* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 12, 13, 10, 11,  8,  9,  6,  7,  4,  5,  2,  3,  0,  1) */
__m256i perm0 = _mm256_shuffle_epi8(v, _mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 12, 13, 10, 11, 8, 9, 6, 7, 4, 5, 2, 3, 0, 1));
__m256i min0 = _mm256_min_epu8(v, perm0);
__m256i max0 = _mm256_max_epu8(v, perm0);
__m256i v0 = _mm256_mask_mov_epi8(max0, 0x555555, min0);

/* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], [25,25], [24,24], [21,23], [20,22], [17,19], [16,18], [13,15], [12,14], [9,11], [8,10], [5,7], [4,6], [1,3], [0,2]) */
/* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 21, 20, 23, 22, 17, 16, 19, 18, 13, 12, 15, 14,  9,  8, 11, 10,  5,  4,  7,  6,  1,  0,  3,  2) */
__m256i perm1 = _mm256_shuffle_epi8(v0, _mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 21, 20, 23, 22, 17, 16, 19, 18, 13, 12, 15, 14, 9, 8, 11, 10, 5, 4, 7, 6, 1, 0, 3, 2));
__m256i min1 = _mm256_min_epu8(v0, perm1);
__m256i max1 = _mm256_max_epu8(v0, perm1);
__m256i v1 = _mm256_mask_mov_epi8(max1, 0x333333, min1);

/* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], [25,25], [24,24], [19,23], [18,22], [15,21], [14,20], [13,17], [12,16], [7,11], [6,10], [3,9], [2,8], [1,5], [0,4]) */
/* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 19, 18, 15, 14, 23, 22, 13, 12, 21, 20, 17, 16,  7,  6,  3,  2, 11, 10,  1,  0,  9,  8,  5,  4) */
__m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 19, 18, 15, 14, 23, 22, 13, 12, 21, 20, 17, 16, 7, 6, 3, 2, 11, 10, 1, 0, 9, 8, 5, 4), v1);
__m256i min2 = _mm256_min_epu8(v1, perm2);
__m256i max2 = _mm256_max_epu8(v1, perm2);
__m256i v2 = _mm256_mask_mov_epi8(max2, 0xcf0cf, min2);

/* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], [25,25], [24,24], [21,23], [20,22], [17,19], [16,18], [13,15], [12,14], [9,11], [8,10], [5,7], [4,6], [1,3], [0,2]) */
/* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 21, 20, 23, 22, 17, 16, 19, 18, 13, 12, 15, 14,  9,  8, 11, 10,  5,  4,  7,  6,  1,  0,  3,  2) */
__m256i perm3 = _mm256_shuffle_epi8(v2, _mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 21, 20, 23, 22, 17, 16, 19, 18, 13, 12, 15, 14, 9, 8, 11, 10, 5, 4, 7, 6, 1, 0, 3, 2));
__m256i min3 = _mm256_min_epu8(v2, perm3);
__m256i max3 = _mm256_max_epu8(v2, perm3);
__m256i v3 = _mm256_mask_mov_epi8(max3, 0x333333, min3);

/* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], [25,25], [24,24], [11,23], [10,22], [19,21], [18,20], [15,17], [14,16], [1,13], [0,12], [7,9], [6,8], [3,5], [2,4]) */
/* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 11, 10, 19, 18, 21, 20, 15, 14, 17, 16,  1,  0, 23, 22,  7,  6,  9,  8,  3,  2,  5,  4, 13, 12) */
__m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 11, 10, 19, 18, 21, 20, 15, 14, 17, 16, 1, 0, 23, 22, 7, 6, 9, 8, 3, 2, 5, 4, 13, 12), v3);
__m256i min4 = _mm256_min_epu8(v3, perm4);
__m256i max4 = _mm256_max_epu8(v3, perm4);
__m256i v4 = _mm256_mask_mov_epi8(max4, 0xccccf, min4);
