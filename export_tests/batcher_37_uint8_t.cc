...
#define TYPE uint8_t
#define N 37
#define SORT_NAME batcher_37_uint8_t

#ifndef _SIMD_SORT_batcher_37_uint8_t_H_
#define _SIMD_SORT_batcher_37_uint8_t_H_
...
batcher_37_uint8_t_vec(__m512i v) {
      ...
      __m512i perm0 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              ...
                                              10, 9, 8, 7, 6, 5, 20, 19, 18, 
                                              17, 16, 31, 30, 29, 28, 27, 26, 
                                              25, 24, 23, 22, 21, 36, 35, 34, 
                                              33, 32), v);
      ...
      __m512i v13 = _mm512_mask_mov_epi8(max13, 0x444444444, min13);
      ...
      __m512i v19 = _mm512_mask_mov_epi8(max19, 0xaaaaaaaaa, min19);
...
batcher_37_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_37_uint8_t_vec(v);
