...
minimum_25_uint8_t_vec(__m256i v) {
      ...
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 19, 17, 5, 18, 3, 
                                              24, 21, 23, 9, 10, 11, 0, 12, 
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 20, 8, 13, 21, 24, 
                                              14, 9, 2, 7, 15, 19, 22, 3, 6, 
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 14, 22, 19, 18, 
                                              21, 20, 17, 16, 13, 23, 15, 10, 
...
minimum_25_uint8_t(uint8_t * const arr) 
                             {
