...
#define TYPE int8_t
#define N 15
#define SORT_NAME oddeven_15_int8_t

#ifndef _SIMD_SORT_oddeven_15_int8_t_H_
#define _SIMD_SORT_oddeven_15_int8_t_H_
...
oddeven_15_int8_t_vec(__m128i v) {
      ...
      /* Perm:  (15, 14, 11, 10, 13, 12,  9,  8,  7,  6,  3,  2,  5,  4,  1,  
                 0) */
      __m128i perm4 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v3, 0xd8), 
                                          0xd8);
      __m128i min4 = _mm_min_epi8(v3, perm4);
      __m128i max4 = _mm_max_epi8(v3, perm4);
      __m128i v4 = _mm_blend_epi16(max4, min4, 0x22);
      ...
      __m128i v5 = _mm_mask_mov_epi8(max5, 0x2a2a, min5);
      
      /* Pairs: ([15,15], [6,14], [5,13], [4,12], [3,11], [2,10], [1,9], 
                 [8,8], [7,7], [0,0]) */
      /* Perm:  (15,  6,  5,  4,  3,  2,  1,  8,  7, 14, 13, 12, 11, 10,  9,  
                 0) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 6, 5, 4, 3, 2, 1, 
...
oddeven_15_int8_t(int8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_15_int8_t_vec(v);
