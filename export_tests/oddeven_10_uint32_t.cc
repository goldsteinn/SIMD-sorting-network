...
#define N 10
#define SORT_NAME oddeven_10_uint32_t

#ifndef _SIMD_SORT_oddeven_10_uint32_t_H_
#define _SIMD_SORT_oddeven_10_uint32_t_H_
...
oddeven_10_uint32_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x33, min1);
      ...
      __m512i v3 = _mm512_mask_mov_epi32(max3, 0x7, min3);
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [7,9], 
                 [8,8], [6,6], [3,5], [4,4], [1,2], [0,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  7,  8,  9,  6,  3,  4,  5,  1,  2,  
                 0) */
      __m512i perm8 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 14, 13, 
                                               12, 11, 10, 7, 8, 9, 6, 3, 4, 
                                               5, 1, 2, 0), v7);
      __m512i min8 = _mm512_min_epu32(v7, perm8);
      __m512i max8 = _mm512_max_epu32(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi32(max8, 0x8a, min8);
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [7,8], [5,6], [3,4], [2,2], [1,1], [0,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  7,  8,  5,  6,  3,  4,  2,  1,  
                 0) */
      ...
      __m512i v9 = _mm512_mask_mov_epi32(max9, 0xa8, min9);
...
oddeven_10_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i _tmp0 = _mm512_set1_epi32(uint32_t(0xffffffff));
      __m512i v = _mm512_mask_load_epi32(_tmp0, 0x3ff, arr);
      fill_works(v);
      v = oddeven_10_uint32_t_vec(v);
      
      fill_works(v);_mm512_mask_store_epi32((void *)arr, 0x3ff, v);
