...
#define TYPE uint8_t
#define N 7
#define SORT_NAME batcher_7_uint8_t

#ifndef _SIMD_SORT_batcher_7_uint8_t_H_
#define _SIMD_SORT_batcher_7_uint8_t_H_
...
batcher_7_uint8_t(uint8_t * const arr) 
                             {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = batcher_7_uint8_t_vec(v);
