...
#define TYPE int8_t
#define N 30
#define SORT_NAME minimum_30_int8_t

#ifndef _SIMD_SORT_minimum_30_int8_t_H_
#define _SIMD_SORT_minimum_30_int8_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_30_int8_t_vec(__m256i v) {
...
void inline __attribute__((always_inline)) minimum_30_int8_t(int8_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi8(int8_t(0x7f));
__m256i v = _mm256_mask_loadu_epi8(_tmp0, 0x3fffffff, arr);
fill_works(v);
v = minimum_30_int8_t_vec(v);
