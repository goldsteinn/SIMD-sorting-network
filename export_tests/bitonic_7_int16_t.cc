...
#ifndef _SIMD_SORT_bitonic_7_int16_t_H_
#define _SIMD_SORT_bitonic_7_int16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) bitonic_7_int16_t_vec(__m128i v) {
...
void inline __attribute__((always_inline)) bitonic_7_int16_t(int16_t * const arr) {
...
const uint32_t _tmp2 = (uint32_t)arr[6];
...
#define TYPE int16_t
#define N 7
#define SORT_NAME bitonic_7_int16_t
