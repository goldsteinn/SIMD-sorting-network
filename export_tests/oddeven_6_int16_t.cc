...
#define TYPE int16_t
#define N 6
#define SORT_NAME oddeven_6_int16_t

#ifndef _SIMD_SORT_oddeven_6_int16_t_H_
#define _SIMD_SORT_oddeven_6_int16_t_H_
...
oddeven_6_int16_t_vec(__m128i v) {
...
oddeven_6_int16_t(int16_t * const arr) 
                             {
