...
#define TYPE int16_t
#define N 4
#define SORT_NAME oddeven_4_int16_t

#ifndef _SIMD_SORT_oddeven_4_int16_t_H_
#define _SIMD_SORT_oddeven_4_int16_t_H_
...
oddeven_4_int16_t(int16_t * const arr) 
                             {
