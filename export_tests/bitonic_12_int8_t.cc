...
#define TYPE int8_t
#define N 12
#define SORT_NAME bitonic_12_int8_t

#ifndef _SIMD_SORT_bitonic_12_int8_t_H_
#define _SIMD_SORT_bitonic_12_int8_t_H_
...
bitonic_12_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [10,11], [11,10], [9,9], 
                 [7,8], [8,7], [1,2], [2,1]) */
      /* Perm:  (15, 14, 13, 12, 10, 11,  9,  7,  8,  1,  2) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 10, 
                                       11, 9, 7, 8, 6, 4, 5, 3, 1, 2, 0));
      __m128i min0 = _mm_min_epi8(v, perm0);
      __m128i max0 = _mm_max_epi8(v, perm0);
      __m128i v0 = _mm_blendv_epi8(max0, min0, _mm_set_epi8(0, 0, 0, 0, 0, 
                                   128, 0, 0, 128, 0, 0, 128, 0, 0, 128, 
                                   0));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [9,11], [10,10], [11,9], 
                 [8,8], [6,7], [7,6], [3,4], [4,3], [0,2], [2,0]) */
      /* Perm:  (15, 14, 13, 12,  9, 10, 11,  8,  6,  7,  3,  4,  0,  2) */
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 9, 
                                       10, 11, 8, 6, 7, 5, 3, 4, 0, 1, 2));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [9,10], [10,9], 
                 [7,8], [8,7], [6,6], [4,5], [5,4], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 11,  9, 10,  7,  8,  6,  4,  5,  0,  1) */
      ...
      __m128i v2 = _mm_blendv_epi8(max2, min2, _mm_set_epi8(0, 0, 0, 0, 0, 0, 
                                   128, 0, 128, 0, 0, 128, 0, 0, 0, 128));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [7,11], [8,10], [9,9], 
                 [10,8], [11,7], [5,5], [0,4], [1,3], [3,1], [4,0]) */
      /* Perm:  (15, 14, 13, 12,  7,  8,  9, 10, 11,  5,  0,  1,  3,  4) */
      __m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 7, 8, 
                                       9, 10, 11, 6, 5, 0, 1, 2, 3, 4));
      ...
      __m128i v3 = _mm_blendv_epi8(max3, min3, _mm_set_epi8(0, 0, 0, 0, 0, 0, 
                                   0, 128, 128, 0, 0, 0, 0, 0, 128, 128));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [10,11], [11,10], [7,9], 
                 [9,7], [3,5], [2,4], [5,3], [4,2], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 10, 11,  7,  9,  3,  2,  5,  4,  0,  1) */
      __m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 12, 10, 
                                       11, 7, 6, 9, 8, 3, 2, 5, 4, 0, 1));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [9,11], [8,10], [11,9], 
                 [10,8], [2,7], [3,6], [1,5], [0,4], [6,3], [7,2], [5,1], 
                 [4,0]) */
      /* Perm:  (15, 14, 13, 12,  9,  8, 11, 10,  2,  3,  1,  0,  6,  7,  5,  
                 4) */
      __m128i perm7 = _mm_shuffle_epi8(v6, _mm_set_epi8(15, 14, 13, 12, 9, 8, 
                                       11, 10, 2, 3, 1, 0, 6, 7, 5, 4));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [10,11], [11,10], [8,9], 
                 [9,8], [4,7], [5,6], [6,5], [7,4], [1,3], [0,2], [3,1], 
                 [2,0]) */
      /* Perm:  (15, 14, 13, 12, 10, 11,  8,  9,  4,  5,  6,  7,  1,  0,  3,  
                 2) */
      __m128i perm8 = _mm_shuffle_epi8(v7, _mm_set_epi8(15, 14, 13, 12, 10, 
                                       11, 8, 9, 4, 5, 6, 7, 1, 0, 3, 2));
      __m128i min8 = _mm_min_epi8(v7, perm8);
      __m128i max8 = _mm_max_epi8(v7, perm8);
      __m128i v8 = _mm_blendv_epi8(max8, min8, _mm_set_epi8(0, 0, 0, 0, 0, 
                                   128, 0, 128, 0, 0, 128, 128, 0, 0, 128, 
                                   128));
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [6,7], [7,6], [4,5], [5,4], [2,3], [3,2], [0,1], 
                 [1,0]) */
...
bitonic_12_int8_t(int8_t * const arr) 
                             {
