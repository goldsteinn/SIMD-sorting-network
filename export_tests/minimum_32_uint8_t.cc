...
#define TYPE uint8_t
#define N 32
#define SORT_NAME minimum_32_uint8_t

#ifndef _SIMD_SORT_minimum_32_uint8_t_H_
#define _SIMD_SORT_minimum_32_uint8_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_32_uint8_t_vec(__m256i v) {

/* Pairs: ([30,31], [28,29], [26,27], [24,25], [22,23], [20,21], [18,19], [16,17], [14,15], [12,13], [10,11], [8,9], [6,7], [4,5], [2,3], [0,1]) */
/* Perm:  (30, 31, 28, 29, 26, 27, 24, 25, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 12, 13, 10, 11,  8,  9,  6,  7,  4,  5,  2,  3,  0,  1) */
...
/* Pairs: ([29,31], [28,30], [25,27], [24,26], [21,23], [20,22], [17,19], [16,18], [13,15], [12,14], [9,11], [8,10], [5,7], [4,6], [1,3], [0,2]) */
/* Perm:  (29, 28, 31, 30, 25, 24, 27, 26, 21, 20, 23, 22, 17, 16, 19, 18, 13, 12, 15, 14,  9,  8, 11, 10,  5,  4,  7,  6,  1,  0,  3,  2) */
__m256i perm1 = _mm256_shufflehi_epi16(_mm256_shufflelo_epi16(v0, 0xb1), 0xb1);
__m256i min1 = _mm256_min_epu8(v0, perm1);
__m256i max1 = _mm256_max_epu8(v0, perm1);
__m256i v1 = _mm256_blend_epi16(max1, min1, 0x55);

/* Pairs: ([27,31], [26,30], [25,29], [24,28], [19,23], [18,22], [17,21], [16,20], [11,15], [10,14], [9,13], [8,12], [3,7], [2,6], [1,5], [0,4]) */
/* Perm:  (27, 26, 25, 24, 31, 30, 29, 28, 19, 18, 17, 16, 23, 22, 21, 20, 11, 10,  9,  8, 15, 14, 13, 12,  3,  2,  1,  0,  7,  6,  5,  4) */
...
/* Pairs: ([23,31], [22,30], [21,29], [20,28], [19,27], [18,26], [17,25], [16,24], [7,15], [6,14], [5,13], [4,12], [3,11], [2,10], [1,9], [0,8]) */
/* Perm:  (23, 22, 21, 20, 19, 18, 17, 16, 31, 30, 29, 28, 27, 26, 25, 24,  7,  6,  5,  4,  3,  2,  1,  0, 15, 14, 13, 12, 11, 10,  9,  8) */
__m256i perm3 = _mm256_shuffle_epi32(v2, uint8_t(0x4e));
__m256i min3 = _mm256_min_epu8(v2, perm3);
__m256i max3 = _mm256_max_epu8(v2, perm3);
__m256i v3 = _mm256_blend_epi32(max3, min3, 0x33);

/* Pairs: ([15,31], [23,30], [27,29], [19,28], [21,26], [22,25], [17,24], [18,20], [0,16], [7,14], [11,13], [3,12], [5,10], [6,9], [1,8], [2,4]) */
/* Perm:  (15, 23, 27, 19, 29, 21, 22, 17, 30, 25, 26, 18, 28, 20, 24,  0, 31,  7, 11,  3, 13,  5,  6,  1, 14,  9, 10,  2, 12,  4,  8, 16) */
__m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(15, 23, 27, 19, 29, 21, 22, 17, 30, 25, 26, 18, 28, 20, 24, 0, 31, 7, 11, 3, 13, 5, 6, 1, 14, 9, 10, 2, 12, 4, 8, 16), v3);
__m256i min4 = _mm256_min_epu8(v3, perm4);
__m256i max4 = _mm256_max_epu8(v3, perm4);
__m256i v4 = _mm256_mask_mov_epi8(max4, 0x8ee88ef, min4);
...
void inline __attribute__((always_inline)) minimum_32_uint8_t(uint8_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi8(uint8_t(0xff));
__m256i v = _mm256_mask_loadu_epi32(_tmp0, 0xff, (int32_t * const)arr);
fill_works(v);
v = minimum_32_uint8_t_vec(v);
