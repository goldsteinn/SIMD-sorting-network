...
#define N 19
#define SORT_NAME batcher_19_uint16_t

#ifndef _SIMD_SORT_batcher_19_uint16_t_H_
#define _SIMD_SORT_batcher_19_uint16_t_H_
...
batcher_19_uint16_t_vec(__m512i v) {
      ...
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0x7071, min4);
      ...
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x4444, min8);
...
batcher_19_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_19_uint16_t_vec(v);
