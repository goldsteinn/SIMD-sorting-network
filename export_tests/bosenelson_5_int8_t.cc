...
#define TYPE int8_t
#define N 5
#define SORT_NAME bosenelson_5_int8_t

#ifndef _SIMD_SORT_bosenelson_5_int8_t_H_
#define _SIMD_SORT_bosenelson_5_int8_t_H_
...
bosenelson_5_int8_t_vec(__m64 v) {
      ...
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 5, 4, 0, 2, 1, 
                                                    3));
      ...
      __m64 perm4 = _mm_shuffle_pi16(v3, 0xe1);
      ...
      __m64 perm5 = _mm_shuffle_pi8(v4, _mm_set_pi8(7, 6, 5, 4, 3, 1, 2, 
                                                    0));
...
bosenelson_5_int8_t(int8_t * const arr) 
                             {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = bosenelson_5_int8_t_vec(v);
