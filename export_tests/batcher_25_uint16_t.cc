...
#define N 25
#define SORT_NAME batcher_25_uint16_t

#ifndef _SIMD_SORT_batcher_25_uint16_t_H_
#define _SIMD_SORT_batcher_25_uint16_t_H_
...
batcher_25_uint16_t_vec(__m512i v) {
      ...
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0xff0f, min2);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [12,24], [21,23], [22,22], [20,20], [7,19], [6,18], 
                 [5,17], [4,16], [15,15], [14,14], [13,13], [11,11], [10,10], 
                 [9,9], [8,8], [3,3], [2,2], [0,1]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 12, 21, 22, 23, 20,  7,  6,  5,  
                 4, 15, 14, 13, 24, 11, 10,  9,  8, 19, 18, 17, 16,  3,  2,  
                 0,  1) */
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 12, 21, 22, 
                                               23, 20, 7, 6, 5, 4, 15, 14, 
                                               13, 24, 11, 10, 9, 8, 19, 18, 
                                               17, 16, 3, 2, 0, 1), v3);
      __m512i min4 = _mm512_min_epu16(v3, perm4);
      __m512i max4 = _mm512_max_epu16(v3, perm4);
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0x2010f1, min4);
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x10f0f0, min5);
      ...
      __m512i v6 = _mm512_mask_mov_epi16(max6, 0x133330, min6);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [10,24], [23,23], [22,22], [7,21], [6,20], [19,19], 
                 [18,18], [3,17], [2,16], [15,15], [14,14], [13,13], [12,12], 
                 [11,11], [9,9], [8,8], [5,5], [4,4], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 10, 23, 22,  7,  6, 19, 18,  3,  
                 2, 15, 14, 13, 12, 11, 24,  9,  8, 21, 20,  5,  4, 17, 16,  
                 1,  0) */
      __m512i perm7 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 10, 23, 22, 7, 
                                               6, 19, 18, 3, 2, 15, 14, 13, 
                                               12, 11, 24, 9, 8, 21, 20, 5, 
                                               4, 17, 16, 1, 0), v6);
      __m512i min7 = _mm512_min_epu16(v6, perm7);
      __m512i max7 = _mm512_max_epu16(v6, perm7);
      __m512i v7 = _mm512_mask_mov_epi16(max7, 0x4cc, min7);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [18,24], [23,23], [22,22], [15,21], [14,20], 
                 [19,19], [11,17], [10,16], [7,13], [6,12], [3,9], [2,8], 
                 [5,5], [4,4], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 18, 23, 22, 15, 14, 19, 24, 11, 
                 10, 21, 20,  7,  6, 17, 16,  3,  2, 13, 12,  5,  4,  9,  8,  
                 1,  0) */
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 18, 23, 22, 
                                               15, 14, 19, 24, 11, 10, 21, 
                                               20, 7, 6, 17, 16, 3, 2, 13, 
                                               12, 5, 4, 9, 8, 1, 0), v7);
      __m512i min8 = _mm512_min_epu16(v7, perm8);
      __m512i max8 = _mm512_max_epu16(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x4cccc, min8);
      ...
      __m512i v9 = _mm512_mask_mov_epi16(max9, 0x4ccccc, min9);
      ...
      __m512i v10 = _mm512_mask_mov_epi16(max10, 0x555554, min10);
      ...
      __m512i v11 = _mm512_mask_mov_epi16(max11, 0x2aa, min11);
      ...
      __m512i v12 = _mm512_mask_mov_epi16(max12, 0x2aaaa, min12);
      ...
      __m512i v13 = _mm512_mask_mov_epi16(max13, 0x2aaaaa, min13);
...
batcher_25_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_25_uint16_t_vec(v);
