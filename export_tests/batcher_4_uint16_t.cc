...
#define N 4
#define SORT_NAME batcher_4_uint16_t

#ifndef _SIMD_SORT_batcher_4_uint16_t_H_
#define _SIMD_SORT_batcher_4_uint16_t_H_
...
batcher_4_uint16_t_vec(__m64 v) {
      
      /* Pairs: ([1, 3], [0, 2], [3, 1], [2, 0]) */
      /* Perm:  ( 1,  0,  3,  2) */
...
batcher_4_uint16_t(uint16_t * const 
                             arr) {
