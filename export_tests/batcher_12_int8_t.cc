...
#define TYPE int8_t
#define N 12
#define SORT_NAME batcher_12_int8_t

#ifndef _SIMD_SORT_batcher_12_int8_t_H_
#define _SIMD_SORT_batcher_12_int8_t_H_
...
Sorting Network Information:
	...
	SIMD Type                        : __m128i
	SIMD Instruction Set(s) Used     : SSE2, SSE4.1, AVX2, SSSE3, AVX512vl, AVX512bw
...
batcher_12_int8_t_vec(__m128i v) {
      ...
      __m128i v5 = _mm_blend_epi16(max5, min5, 0xa);
...
batcher_12_int8_t(int8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = batcher_12_int8_t_vec(v);
