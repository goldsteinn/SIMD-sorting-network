...
batcher_12_int8_t_vec(__m128i v) {
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [3,11], [2,10], [1,9], 
                 [0,8], [7,7], [6,6], [5,5], [4,4], [11,3], [10,2], [9,1], 
                 [8,0]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [3,7], [2,6], [1,5], [0,4], [7,3], [6,2], [5,1], 
                 [4,0]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [10,11], [11,10], [3,9], 
                 [2,8], [7,7], [6,6], [5,5], [4,4], [9,3], [8,2]) */
      /* Perm:  (15, 14, 13, 12, 10, 11,  3,  2,  7,  6,  5,  4,  9,  8) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [7,9], 
                 [9,7], [3,5], [2,4], [5,3], [4,2]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  7,  9,  3,  2,  5,  4) */
