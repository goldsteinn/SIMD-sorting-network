...
#define N 21
#define SORT_NAME minimum_21_uint16_t

#ifndef _SIMD_SORT_minimum_21_uint16_t_H_
#define _SIMD_SORT_minimum_21_uint16_t_H_
...
minimum_21_uint16_t_vec(__m512i v) {
      ...
      __m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               21, 18, 9, 20, 12, 15, 16, 11, 
                                               6, 17, 14, 1, 19, 4, 0, 13, 3, 
                                               8, 5, 2, 10, 7), v);
      __m512i min0 = _mm512_min_epu16(v, perm0);
      __m512i max0 = _mm512_max_epu16(v, perm0);
      __m512i v0 = _mm512_mask_mov_epi16(max0, 0x49a5b, min0);
      ...
      __m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 17, 13, 18, 20, 10, 1, 7, 
                                               19, 2, 0, 16, 6, 5, 14, 9, 8, 
                                               3, 4, 12, 15, 11), v0);
      __m512i min1 = _mm512_min_epu16(v0, perm1);
      __m512i max1 = _mm512_max_epu16(v0, perm1);
      __m512i v1 = _mm512_mask_mov_epi16(max1, 0x224ef, min1);
      ...
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 16, 13, 7, 10, 20, 15, 8, 
                                               19, 5, 9, 17, 11, 14, 18, 2, 
                                               12, 4, 3, 6, 1, 0), v2);
      __m512i min3 = _mm512_min_epu16(v2, perm3);
      __m512i max3 = _mm512_max_epu16(v2, perm3);
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x127a4, min3);
      ...
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 14, 15, 6, 16, 18, 19, 
                                               10, 11, 12, 13, 5, 8, 4, 17, 
                                               9, 7, 3, 1, 2, 0), v3);
      __m512i min4 = _mm512_min_epu16(v3, perm4);
      __m512i max4 = _mm512_max_epu16(v3, perm4);
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0xcc72, min4);
      ...
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 19, 20, 13, 14, 12, 9, 17, 
                                               18, 16, 8, 7, 15, 11, 10, 3, 
                                               4, 5, 6, 0, 1, 2), v4);
      __m512i min5 = _mm512_min_epu16(v4, perm5);
      __m512i max5 = _mm512_max_epu16(v4, perm5);
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x87399, min5);
      ...
      __m512i v10 = _mm512_mask_mov_epi16(max10, 0x9a68, min10);
      ...
      __m512i v11 = _mm512_mask_mov_epi16(max11, 0x15550, min11);
...
minimum_21_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_21_uint16_t_vec(v);
