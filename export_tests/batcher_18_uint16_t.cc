...
#define N 18
#define SORT_NAME batcher_18_uint16_t

#ifndef _SIMD_SORT_batcher_18_uint16_t_H_
#define _SIMD_SORT_batcher_18_uint16_t_H_
...
batcher_18_uint16_t_vec(__m512i v) {
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18,  1,  
                 0,  7,  6,  5,  4,  3,  2,  9,  8, 15, 14, 13, 12, 11, 10, 
                 17, 16) */
      __m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 19, 18, 1, 0, 7, 6, 5, 
                                               4, 3, 2, 9, 8, 15, 14, 13, 12, 
                                               11, 10, 17, 16), v);
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17, 
                 16, 11, 10, 13, 12, 15, 14,  1,  0,  3,  2,  5,  4,  7,  6,  
                 9,  8) */
      ...
      __m512i v1 = _mm512_mask_mov_epi16(max1, 0xc0f, min1);
      ...
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 13, 
                 12, 15, 14, 17, 16, 11, 10,  5,  4,  7,  6,  9,  8,  3,  2,  
                 0,  1) */
      ...
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0x3031, min4);
...
batcher_18_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_18_uint16_t_vec(v);
