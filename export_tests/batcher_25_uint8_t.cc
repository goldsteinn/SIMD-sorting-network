...
#define TYPE uint8_t
#define N 25
#define SORT_NAME batcher_25_uint8_t

#ifndef _SIMD_SORT_batcher_25_uint8_t_H_
#define _SIMD_SORT_batcher_25_uint8_t_H_
...
batcher_25_uint8_t_vec(__m256i v) {
      ...
      __m256i v0 = _mm256_mask_mov_epi8(max0, 0x1ff, min0);
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0x100ff, min1);
      ...
      __m256i v6 = _mm256_mask_mov_epi8(max6, 0x133330, min6);
      ...
      __m256i v9 = _mm256_mask_mov_epi8(max9, 0x4ccccc, min9);
      ...
      __m256i v10 = _mm256_mask_mov_epi8(max10, 0x555554, min10);
