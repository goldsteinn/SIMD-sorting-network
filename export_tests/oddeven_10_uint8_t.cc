...
#define TYPE uint8_t
#define N 10
#define SORT_NAME oddeven_10_uint8_t

#ifndef _SIMD_SORT_oddeven_10_uint8_t_H_
#define _SIMD_SORT_oddeven_10_uint8_t_H_
...
oddeven_10_uint8_t_vec(__m128i v) {
      ...
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  8,  5,  4,  7,  6,  1,  0,  3,  
                 2) */
      __m128i perm1 = _mm_shufflelo_epi16(v0, 0xb1);
      __m128i min1 = _mm_min_epu8(v0, perm1);
      __m128i max1 = _mm_max_epu8(v0, perm1);
      __m128i v1 = _mm_blend_epi16(max1, min1, 0x5);
      ...
      __m128i v9 = _mm_mask_mov_epi8(max9, 0xa8, min9);
...
oddeven_10_uint8_t(uint8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_10_uint8_t_vec(v);
