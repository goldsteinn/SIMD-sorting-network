...
bitonic_14_uint16_t_vec(__m256i v) {
      ...
      /* Pairs: ([15, 15], [14, 14], [10, 13], [11, 12], [12, 11], [13, 10], 
                 [9, 9], [7, 8], [8, 7], [3, 6], [4, 5], [5, 4], [6, 3], [0, 
                 2], [1, 1], [2, 0]) */
      ...
      __m256i _tmp2 = _mm256_shuffle_epi8(v0, _mm256_set_epi8(15, 14, 13, 12, 
                                          5, 4, 7, 6, 9, 8, 11, 10, 3, 2, 
                                          128, 128, 128, 128, 7, 6, 9, 8, 11, 
      ...
      /* Pairs: ([15, 15], [14, 14], [7, 13], [8, 12], [9, 11], [10, 10], 
                 [11, 9], [12, 8], [13, 7], [6, 6], [0, 5], [1, 4], [2, 3], 
                 [3, 2], [4, 1], [5, 0]) */
      ...
      /* Pairs: ([15, 15], [14, 14], [11, 13], [12, 12], [13, 11], [8, 10], 
                 [7, 9], [10, 8], [9, 7], [4, 6], [3, 5], [6, 4], [5, 3], [0, 
                 2], [1, 1], [2, 0]) */
      ...
      __m256i _tmp8 = _mm256_shuffle_epi8(v3, _mm256_set_epi8(15, 14, 13, 12, 
                                          7, 6, 9, 8, 11, 10, 1, 0, 128, 128, 
                                          5, 4, 128, 128, 9, 8, 7, 6, 13, 12, 
                                          11, 10, 1, 0, 3, 2, 5, 4));
      __m256i _tmp9 = _mm256_shuffle_epi8(_tmp7, _mm256_set_epi8(128, 128, 
                                          128, 128, 128, 128, 128, 128, 128, 
                                          128, 128, 128, 15, 14, 128, 128, 3, 
      ...
      /* Pairs: ([15, 15], [14, 14], [1, 13], [2, 12], [3, 11], [4, 10], [5, 
                 9], [6, 8], [7, 7], [8, 6], [9, 5], [10, 4], [11, 3], [12, 
                 2], [13, 1], [0, 0]) */
      ...
      __m256i _tmp15 = _mm256_shuffle_epi8(_tmp13, _mm256_set_epi8(128, 128, 
                                           128, 128, 3, 2, 5, 4, 7, 6, 9, 8, 
                                           11, 10, 13, 12, 128, 128, 1, 0, 3, 
                                           2, 5, 4, 7, 6, 9, 8, 11, 10, 128, 
                                           128));
      ...
      /* Pairs: ([15, 15], [14, 14], [9, 13], [8, 12], [11, 11], [10, 10], 
                 [13, 9], [12, 8], [3, 7], [2, 6], [1, 5], [0, 4], [7, 3], 
                 [6, 2], [5, 1], [4, 0]) */
      ...
      /* Pairs: ([15, 15], [14, 14], [12, 13], [13, 12], [9, 11], [8, 10], 
                 [11, 9], [10, 8], [5, 7], [4, 6], [7, 5], [6, 4], [1, 3], 
                 [0, 2], [3, 1], [2, 0]) */
