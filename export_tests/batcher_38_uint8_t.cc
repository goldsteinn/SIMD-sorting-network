...
#define TYPE uint8_t
#define N 38
#define SORT_NAME batcher_38_uint8_t

#ifndef _SIMD_SORT_batcher_38_uint8_t_H_
#define _SIMD_SORT_batcher_38_uint8_t_H_
...
batcher_38_uint8_t_vec(__m512i v) {
      ...
      __m512i v8 = _mm512_mask_mov_epi8(max8, 0x30303030, min8);
      ...
      __m512i v9 = _mm512_mask_mov_epi8(max9, 0x333333330, min9);
      ...
      __m512i perm11 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               18, 31, 30, 29, 28, 27, 26, 
                                               25, 24, 37, 36, 7, 6, 33, 32, 
      ...
      __m512i v11 = _mm512_mask_mov_epi8(max11, 0xcc00cc, min11);
      
      __m512i perm12 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               60, 59, 58, 57, 56, 55, 54, 
                                               53, 52, 51, 50, 49, 48, 47, 
                                               46, 45, 44, 43, 42, 41, 40, 
                                               39, 38, 31, 30, 35, 34, 27, 
      ...
      __m512i v14 = _mm512_mask_mov_epi8(max14, 0x1555555554, min14);
...
batcher_38_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_38_uint8_t_vec(v);
