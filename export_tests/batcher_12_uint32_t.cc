...
#define N 12
#define SORT_NAME batcher_12_uint32_t

#ifndef _SIMD_SORT_batcher_12_uint32_t_H_
#define _SIMD_SORT_batcher_12_uint32_t_H_
...
batcher_12_uint32_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0xf, min1);
      ...
      __m512i v4 = _mm512_mask_mov_epi32(max4, 0x40c, min4);
      ...
      __m512i v5 = _mm512_mask_mov_epi32(max5, 0xcc, min5);
...
batcher_12_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_12_uint32_t_vec(v);
