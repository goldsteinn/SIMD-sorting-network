...
#define N 14
#define SORT_NAME batcher_14_uint32_t

#ifndef _SIMD_SORT_batcher_14_uint32_t_H_
#define _SIMD_SORT_batcher_14_uint32_t_H_
...
batcher_14_uint32_t_vec(__m512i v) {
      
      __m512i perm0 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 14, 5, 4, 
      ...
      __m512i perm1 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 14, 9, 8, 
                                               11, 10, 13, 12, 3, 2, 1, 0, 7, 
                                               6, 5, 4), v0);
      __m512i min1 = _mm512_min_epu32(v0, perm1);
      __m512i max1 = _mm512_max_epu32(v0, perm1);
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x30f, min1);
...
batcher_14_uint32_t(uint32_t * const 
                                 arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_14_uint32_t_vec(v);
