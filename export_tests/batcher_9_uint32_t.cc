...
#define N 9
#define SORT_NAME batcher_9_uint32_t

#ifndef _SIMD_SORT_batcher_9_uint32_t_H_
#define _SIMD_SORT_batcher_9_uint32_t_H_
...
batcher_9_uint32_t_vec(__m512i v) {
...
batcher_9_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_9_uint32_t_vec(v);
