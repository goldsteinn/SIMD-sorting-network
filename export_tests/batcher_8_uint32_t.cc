...
#define N 8
#define SORT_NAME batcher_8_uint32_t

#ifndef _SIMD_SORT_batcher_8_uint32_t_H_
#define _SIMD_SORT_batcher_8_uint32_t_H_
...
batcher_8_uint32_t_vec(__m256i v) {
      ...
      __m256i perm2 = _mm256_permutevar8x32_epi32(v1, _mm256_set_epi32(6, 7, 
                                                  3, 2, 5, 4, 0, 1));
...
batcher_8_uint32_t(uint32_t * const 
                             arr) {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = batcher_8_uint32_t_vec(v);
