...
minimum_29_uint8_t_vec(__m256i v) {
      ...
      /* Perm:  (31, 30, 29, 20, 19, 18, 17, 16, 23, 22, 21, 28, 27, 26, 25, 
                 ...
                 9,  8) */
      __m256i perm3 = _mm256_shuffle_epi8(v2, _mm256_set_epi8(31, 30, 29, 20, 
      ...
      /* Perm:  (31, 30, 29, 19, 23, 21, 22, 17, 27, 25, 26, 18, 28, 20, 24,  
                 ...
                 8, 16) */
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 19, 
                                              23, 21, 22, 17, 27, 25, 26, 18, 
      ...
      /* Perm:  (31, 30, 29, 12, 11, 21, 13,  8,  7, 22, 26,  4,  3,  2,  1, 
                 ...
                 17,  0) */
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 12, 
                                              11, 21, 13, 8, 7, 22, 26, 4, 3, 
                                              2, 1, 16, 15, 14, 25, 28, 27, 
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 14, 
                                              15, 10, 25, 22, 11, 24, 5, 8, 
                                              19, 6, 3, 4, 27, 28, 13, 12, 
...
minimum_29_uint8_t(uint8_t * const arr) 
                             {
