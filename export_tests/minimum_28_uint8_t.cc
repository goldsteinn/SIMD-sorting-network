...
minimum_28_uint8_t_vec(__m256i v) {
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              21, 7, 23, 22, 25, 24, 27, 1, 
                                              19, 18, 15, 13, 17, 11, 16, 10, 
                                              14, 12, 9, 8, 26, 0, 3, 2, 5, 
                                              4, 20, 6), v1);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 9, 17, 24, 5, 4, 19, 20, 
                                              21, 1, 25, 16, 14, 15, 12, 13, 
                                              11, 2, 26, 6, 7, 8, 23, 22, 3, 
                                              10, 18, 0), v2);
      ...
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              21, 26, 25, 5, 15, 3, 27, 18, 
                                              19, 20, 17, 14, 23, 16, 11, 4, 
                                              13, 10, 7, 8, 9, 0, 24, 12, 22, 
                                              2, 1, 6), v3);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              25, 23, 27, 16, 26, 14, 17, 19, 
                                              20, 18, 21, 24, 15, 22, 5, 12, 
                                              3, 6, 9, 7, 8, 10, 13, 1, 11, 
                                              0, 4, 2), v4);
      ...
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 21, 25, 20, 16, 17, 26, 24, 
                                              12, 13, 22, 23, 8, 9, 18, 19, 
                                              4, 5, 14, 15, 3, 1, 10, 11, 7, 
                                              2, 6, 0), v5);
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 18, 24, 19, 14, 21, 10, 
                                              23, 25, 7, 12, 11, 22, 5, 16, 
                                              15, 20, 2, 4, 17, 6, 13, 8, 3, 
                                              9, 1, 0), v6);
      ...
      __m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 24, 25, 22, 23, 21, 15, 
                                              16, 18, 14, 19, 20, 17, 10, 7, 
                                              8, 13, 9, 11, 12, 6, 4, 5, 2, 
                                              3, 1, 0), v7);
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 25, 26, 24, 23, 21, 22, 20, 
                                              17, 15, 19, 13, 18, 11, 16, 9, 
                                              14, 8, 12, 10, 7, 5, 6, 4, 3, 
                                              1, 2, 0), v8);
      ...
      __m256i perm11 = _mm256_shuffle_epi8(v10, _mm256_set_epi8(31, 30, 29, 
                                           28, 27, 26, 24, 25, 20, 21, 22, 
                                           23, 18, 19, 16, 17, 14, 15, 12, 
                                           13, 10, 11, 8, 9, 4, 5, 6, 7, 2, 
                                           3, 1, 0));
      ...
      __m256i perm12 = _mm256_shuffle_epi8(v11, _mm256_set_epi8(31, 30, 29, 
                                           ...
                                           21, 17, 16, 19, 18, 13, 12, 15, 
                                           14, 9, 8, 11, 10, 6, 7, 4, 5, 3, 
                                           2, 1, 0));
...
minimum_28_uint8_t(uint8_t * const arr) 
                             {
