...
#define N 6
#define SORT_NAME oddeven_6_uint32_t

#ifndef _SIMD_SORT_oddeven_6_uint32_t_H_
#define _SIMD_SORT_oddeven_6_uint32_t_H_
...
oddeven_6_uint32_t_vec(__m256i v) {
      ...
      __m256i v5 = _mm256_blend_epi32(max5, min5, 0x8);
...
oddeven_6_uint32_t(uint32_t * const 
                             arr) {
