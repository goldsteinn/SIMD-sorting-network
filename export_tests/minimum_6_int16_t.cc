...
#define TYPE int16_t
#define N 6
#define SORT_NAME minimum_6_int16_t

#ifndef _SIMD_SORT_minimum_6_int16_t_H_
#define _SIMD_SORT_minimum_6_int16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_6_int16_t_vec(__m128i v) {
