...
#define N 15
#define SORT_NAME oddeven_15_uint16_t

#ifndef _SIMD_SORT_oddeven_15_uint16_t_H_
#define _SIMD_SORT_oddeven_15_uint16_t_H_
...
oddeven_15_uint16_t_vec(__m256i v) {
      ...
      /* Perm:  (15, 12, 13, 14,  9,  8, 11, 10,  5,  4,  7,  6,  1,  0,  3,  
                 2) */
      __m256i perm1 = _mm256_shuffle_epi8(v0, _mm256_set_epi8(31, 30, 25, 24, 
      ...
      __m256i v1 = _mm256_mask_mov_epi16(max1, 0x1333, min1);
      
      /* Pairs: ([15,15], [13,14], [8,12], [11,11], [9,10], [3,7], [5,6], 
                 [0,4], [1,2]) */
      /* Perm:  (15, 13, 14,  8, 11,  9, 10, 12,  3,  5,  6,  0,  7,  1,  2,  
                 4) */
      __m256i perm2 = _mm256_shuffle_epi8(v1, _mm256_set_epi8(31, 30, 27, 26, 
                                          29, 28, 17, 16, 23, 22, 19, 18, 21, 
      ...
      __m256i v2 = _mm256_mask_mov_epi16(max2, 0x232b, min2);
      
      /* Pairs: ([15,15], [10,14], [9,13], [12,12], [11,11], [0,8], [7,7], 
                 [2,6], [1,5], [4,4], [3,3]) */
      /* Perm:  (15, 10,  9, 12, 11, 14, 13,  0,  7,  2,  1,  4,  3,  6,  5,  
                 8) */
      __m256i perm3 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 10, 9, 
      ...
      /* Perm:  (15, 14, 11, 10, 13, 12,  9,  8,  7,  6,  3,  2,  5,  4,  1,  
                 0) */
      __m256i perm4 = _mm256_shuffle_epi32(v3, uint8_t(0xd8));
      __m256i min4 = _mm256_min_epu16(v3, perm4);
      __m256i max4 = _mm256_max_epu16(v3, perm4);
      __m256i v4 = _mm256_blend_epi32(max4, min4, 0x22);
      
      /* Pairs: ([15,15], [13,14], [11,12], [9,10], [8,8], [7,7], [5,6], 
                 [3,4], [1,2], [0,0]) */
      /* Perm:  (15, 13, 14, 11, 12,  9, 10,  8,  7,  5,  6,  3,  4,  1,  2,  
                 0) */
      __m256i perm5 = _mm256_shuffle_epi8(v4, _mm256_set_epi8(31, 30, 27, 26, 
      ...
      __m256i v5 = _mm256_blend_epi16(max5, min5, 0x2a);
      
      /* Pairs: ([15,15], [6,14], [5,13], [4,12], [3,11], [2,10], [1,9], 
                 [8,8], [7,7], [0,0]) */
      /* Perm:  (15,  6,  5,  4,  3,  2,  1,  8,  7, 14, 13, 12, 11, 10,  9,  
                 0) */
      __m256i perm6 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 6, 5, 4, 
