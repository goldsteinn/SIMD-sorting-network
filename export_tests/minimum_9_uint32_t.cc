...
#define N 9
#define SORT_NAME minimum_9_uint32_t

#ifndef _SIMD_SORT_minimum_9_uint32_t_H_
#define _SIMD_SORT_minimum_9_uint32_t_H_
...
minimum_9_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x17, min0);
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x2d, min1);
      ...
      __m512i v2 = _mm512_mask_mov_epi32(max2, 0x93, min2);
      ...
      __m512i v4 = _mm512_mask_mov_epi32(max4, 0x4d, min4);
      ...
      __m512i v5 = _mm512_mask_mov_epi32(max5, 0x54, min5);
...
minimum_9_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_9_uint32_t_vec(v);
