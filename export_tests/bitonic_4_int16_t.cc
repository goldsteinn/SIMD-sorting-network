...
#ifndef _SIMD_SORT_bitonic_4_int16_t_H_
#define _SIMD_SORT_bitonic_4_int16_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) bitonic_4_int16_t_vec(__m64 v) {
...
#define TYPE int16_t
#define N 4
#define SORT_NAME bitonic_4_int16_t
