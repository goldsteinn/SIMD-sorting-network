...
#define TYPE uint8_t
#define N 7
#define SORT_NAME minimum_8_uint8_t

#ifndef _SIMD_SORT_minimum_8_uint8_t_H_
#define _SIMD_SORT_minimum_8_uint8_t_H_
...
minimum_8_uint8_t(uint8_t * const arr) 
                             {
