...
#define N 24
#define SORT_NAME batcher_24_uint16_t

#ifndef _SIMD_SORT_batcher_24_uint16_t_H_
#define _SIMD_SORT_batcher_24_uint16_t_H_
...
batcher_24_uint16_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi16(max1, 0xff, min1);
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x40f0f0, min5);
...
batcher_24_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_24_uint16_t_vec(v);
