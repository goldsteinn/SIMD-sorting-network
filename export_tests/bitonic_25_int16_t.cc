...
#ifndef _SIMD_SORT_bitonic_25_int16_t_H_
#define _SIMD_SORT_bitonic_25_int16_t_H_
...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_25_int16_t_vec(__m512i v) {

__m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 23, 24, 21, 22, 19, 20, 18, 16, 17, 15, 13, 14, 12, 10, 11, 9, 7, 8, 6, 4, 5, 3, 1, 2, 0), v);
...
__m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 21, 22, 23, 24, 20, 18, 19, 17, 15, 16, 12, 13, 14, 11, 9, 10, 6, 7, 8, 3, 4, 5, 2, 0, 1), v0);
...
__m512i perm2 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 23, 24, 21, 22, 19, 20, 18, 16, 17, 15, 14, 12, 13, 10, 11, 9, 8, 6, 7, 5, 3, 4, 1, 2, 0), v1);
...
__m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 18, 19, 20, 21, 22, 23, 24, 17, 12, 13, 14, 15, 16, 11, 6, 7, 8, 9, 10, 1, 2, 3, 4, 5, 0), v2);
...
__m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 22, 23, 24, 19, 18, 21, 20, 15, 14, 17, 16, 12, 13, 9, 8, 11, 10, 6, 7, 4, 5, 1, 0, 3, 2), v3);
...
__m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 13, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 24, 12, 10, 11, 8, 9, 7, 6, 5, 4, 2, 3, 0, 1), v4);
...
__m512i perm7 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 20, 21, 22, 23, 24, 14, 15, 13, 12, 18, 19, 17, 16, 7, 6, 4, 5, 11, 10, 8, 9, 1, 0, 3, 2), v6);
...
__m512i perm8 = _mm512_shuffle_epi8(v7, _mm512_set_epi8(63, 62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 52, 51, 50, 49, 48, 47, 46, 41, 40, 43, 42, 45, 44, 33, 32, 35, 34, 37, 36, 39, 38, 27, 26, 25, 24, 31, 30, 29, 28, 19, 18, 17, 16, 23, 22, 21, 20, 9, 8, 11, 10, 13, 12, 15, 14, 5, 4, 7, 6, 1, 0, 3, 2));
...
__m512i perm9 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 3, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 12, 13, 10, 11, 8, 9, 6, 7, 4, 5, 24, 2, 1, 0), v8);
...
__m512i perm11 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 28, 27, 26, 25, 16, 19, 18, 17, 20, 23, 22, 21, 24, 4, 5, 6, 7, 3, 2, 1, 0, 12, 13, 14, 15, 11, 10, 9, 8), v10);
...
__m512i perm12 = _mm512_shuffle_epi8(v11, _mm512_set_epi8(63, 62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 52, 51, 50, 49, 48, 43, 42, 45, 44, 47, 46, 33, 32, 35, 34, 37, 36, 39, 38, 41, 40, 17, 16, 19, 18, 21, 20, 23, 22, 25, 24, 27, 26, 29, 28, 31, 30, 7, 6, 5, 4, 3, 2, 1, 0, 15, 14, 13, 12, 11, 10, 9, 8));
...
__m512i perm13 = _mm512_shuffle_epi8(v12, _mm512_set_epi8(63, 62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 52, 51, 50, 49, 48, 47, 46, 41, 40, 43, 42, 45, 44, 39, 38, 33, 32, 35, 34, 37, 36, 27, 26, 25, 24, 31, 30, 29, 28, 19, 18, 17, 16, 23, 22, 21, 20, 11, 10, 9, 8, 15, 14, 13, 12, 3, 2, 1, 0, 7, 6, 5, 4));
...
void inline __attribute__((always_inline)) bitonic_25_int16_t(int16_t * const arr) {

__m512i v = _mm512_mask_loadu_epi16(_mm512_set1_epi16(int16_t(0x7fff)), 0x1ffffff, arr);
v = bitonic_25_int16_t_vec(v);
...
#define TYPE int16_t
#define N 25
#define SORT_NAME bitonic_25_int16_t
