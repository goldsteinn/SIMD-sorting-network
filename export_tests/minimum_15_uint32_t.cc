...
#define N 15
#define SORT_NAME minimum_15_uint32_t

#ifndef _SIMD_SORT_minimum_15_uint32_t_H_
#define _SIMD_SORT_minimum_15_uint32_t_H_
...
minimum_15_uint32_t_vec(__m512i v) {
...
minimum_15_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_15_uint32_t_vec(v);
