...
#define TYPE uint8_t
#define N 34
#define SORT_NAME batcher_34_uint8_t

#ifndef _SIMD_SORT_batcher_34_uint8_t_H_
#define _SIMD_SORT_batcher_34_uint8_t_H_
...
batcher_34_uint8_t_vec(__m512i v) {
      ...
      __m512i v7 = _mm512_mask_mov_epi8(max7, 0x30303030, min7);
      
      __m512i perm8 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              59, 58, 57, 56, 55, 54, 53, 52, 
                                              51, 50, 49, 48, 47, 46, 45, 44, 
                                              43, 42, 41, 40, 39, 38, 37, 36, 
                                              35, 34, 3, 2, 29, 28, 31, 30, 
      ...
      __m512i v10 = _mm512_mask_mov_epi8(max10, 0xccccccc, min10);
      ...
      __m512i perm14 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               17, 31, 23, 29, 21, 27, 19, 
                                               25, 24, 30, 15, 28, 13, 26, 
                                               11, 32, 1, 22, 7, 20, 5, 18, 
                                               3, 9, 8, 14, 6, 12, 4, 10, 2, 
                                               16, 0), v13);
      __m512i min14 = _mm512_min_epu8(v13, perm14);
      __m512i max14 = _mm512_max_epu8(v13, perm14);
      __m512i v14 = _mm512_mask_mov_epi8(max14, 0xaaa8aa, min14);
      ...
      __m512i perm15 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               46, 45, 44, 43, 42, 41, 40, 
                                               39, 38, 37, 36, 35, 34, 33, 
                                               25, 31, 27, 29, 28, 30, 23, 
                                               32, 17, 26, 19, 21, 20, 22, 
                                               15, 24, 9, 18, 11, 13, 12, 14, 
                                               7, 16, 1, 10, 3, 5, 4, 6, 2, 
                                               8, 0), v14);
      __m512i min15 = _mm512_min_epu8(v14, perm15);
      __m512i max15 = _mm512_max_epu8(v14, perm15);
      __m512i v15 = _mm512_mask_mov_epi8(max15, 0xa8a8a8a, min15);
      ...
      __m512i perm16 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               46, 45, 44, 43, 42, 41, 40, 
                                               39, 38, 37, 36, 35, 34, 33, 
                                               29, 31, 30, 32, 25, 27, 26, 
                                               28, 21, 23, 22, 24, 17, 19, 
                                               18, 20, 13, 15, 14, 16, 9, 11, 
                                               10, 12, 5, 7, 6, 8, 1, 3, 2, 
                                               4, 0), v15);
      __m512i min16 = _mm512_min_epu8(v15, perm16);
      __m512i max16 = _mm512_max_epu8(v15, perm16);
      __m512i v16 = _mm512_mask_mov_epi8(max16, 0x22222222, min16);
...
batcher_34_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_34_uint8_t_vec(v);
