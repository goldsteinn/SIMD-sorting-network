...
#define N 31
#define SORT_NAME minimum_31_uint16_t

#ifndef _SIMD_SORT_minimum_31_uint16_t_H_
#define _SIMD_SORT_minimum_31_uint16_t_H_
...
minimum_31_uint16_t_vec(__m512i v) {
      ...
      /* Perm:  (31, 26, 25, 24, 27, 30, 29, 28, 19, 18, 17, 16, 23, 22, 21, 
                 ...
                 5,  4) */
      __m512i perm2 = _mm512_shuffle_epi8(v1, _mm512_set_epi8(63, 62, 53, 52, 
                                          51, 50, 49, 48, 55, 54, 61, 60, 59, 
      ...
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0x70f0f0f, min2);
      ...
      /* Perm:  (31, 22, 21, 20, 19, 18, 17, 16, 23, 30, 29, 28, 27, 26, 25, 
                 ...
                 9,  8) */
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 22, 21, 
      ...
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x7f00ff, min3);
      
      /* Pairs: ([31,31], [23,30], [27,29], [19,28], [21,26], [22,25], 
                 [17,24], [18,20], [0,16], [15,15], [7,14], [11,13], [3,12], 
                 [5,10], [6,9], [1,8], [2,4]) */
      /* Perm:  (31, 23, 27, 19, 29, 21, 22, 17, 30, 25, 26, 18, 28, 20, 24,  
                 0, 15,  7, 11,  3, 13,  5,  6,  1, 14,  9, 10,  2, 12,  4,  
                 8, 16) */
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 23, 27, 
                                               19, 29, 21, 22, 17, 30, 25, 
                                               26, 18, 28, 20, 24, 0, 15, 7, 
                                               11, 3, 13, 5, 6, 1, 14, 9, 10, 
                                               2, 12, 4, 8, 16), v3);
      __m512i min4 = _mm512_min_epu16(v3, perm4);
      __m512i max4 = _mm512_max_epu16(v3, perm4);
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0x8ee08ef, min4);
      
      /* Pairs: ([31,31], [29,30], [26,28], [23,27], [9,25], [20,24], [6,22], 
                 [19,21], [17,18], [16,16], [15,15], [13,14], [10,12], 
                 [7,11], [4,8], [3,5], [1,2], [0,0]) */
      /* Perm:  (31, 29, 30, 26, 23, 28,  9, 20, 27,  6, 19, 24, 21, 17, 18, 
                 16, 15, 13, 14, 10,  7, 12, 25,  4, 11, 22,  3,  8,  5,  1,  
                 2,  0) */
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 29, 30, 
                                               26, 23, 28, 9, 20, 27, 6, 19, 
                                               24, 21, 17, 18, 16, 15, 13, 
                                               14, 10, 7, 12, 25, 4, 11, 22, 
                                               3, 8, 5, 1, 2, 0), v4);
      __m512i min5 = _mm512_min_epu16(v4, perm5);
      __m512i max5 = _mm512_max_epu16(v4, perm5);
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x249a26da, min5);
      
      /* Pairs: ([31,31], [14,30], [13,29], [12,28], [11,27], [21,26], 
                 [25,25], [8,24], [7,23], [22,22], [4,20], [3,19], [2,18], 
                 [1,17], [16,16], [15,15], [5,10], [9,9], [6,6], [0,0]) */
      /* Perm:  (31, 14, 13, 12, 11, 21, 25,  8,  7, 22, 26,  4,  3,  2,  1, 
                 16, 15, 30, 29, 28, 27,  5,  9, 24, 23,  6, 10, 20, 19, 18, 
                 17,  0) */
      __m512i perm6 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 14, 13, 
                                               12, 11, 21, 25, 8, 7, 22, 26, 
                                               4, 3, 2, 1, 16, 15, 30, 29, 
                                               28, 27, 5, 9, 24, 23, 6, 10, 
                                               20, 19, 18, 17, 0), v5);
      __m512i min6 = _mm512_min_epu16(v5, perm6);
      __m512i max6 = _mm512_max_epu16(v5, perm6);
      __m512i v6 = _mm512_mask_mov_epi16(max6, 0x2079be, min6);
      
      /* Pairs: ([31,31], [30,30], [29,29], [14,28], [15,27], [10,26], 
                 [13,25], [22,24], [11,23], [5,21], [8,20], [19,19], [6,18], 
                 [3,17], [4,16], [12,12], [7,9], [2,2], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 14, 15, 10, 13, 22, 11, 24,  5,  8, 19,  6,  3,  
                 4, 27, 28, 25, 12, 23, 26,  7, 20,  9, 18, 21, 16, 17,  2,  
                 1,  0) */
      __m512i perm7 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               14, 15, 10, 13, 22, 11, 24, 5, 
                                               8, 19, 6, 3, 4, 27, 28, 25, 
                                               12, 23, 26, 7, 20, 9, 18, 21, 
                                               16, 17, 2, 1, 0), v6);
      __m512i min7 = _mm512_min_epu16(v6, perm7);
      __m512i max7 = _mm512_max_epu16(v6, perm7);
      __m512i v7 = _mm512_mask_mov_epi16(max7, 0x40edf8, min7);
      
      /* Pairs: ([31,31], [27,30], [29,29], [23,28], [15,26], [25,25], 
                 [14,24], [10,22], [9,21], [12,20], [11,19], [18,18], [7,17], 
                 [5,16], [13,13], [3,8], [6,6], [1,4], [2,2], [0,0]) */
      /* Perm:  (31, 27, 29, 23, 30, 15, 25, 14, 28, 10,  9, 12, 11, 18,  7,  
                 5, 26, 24, 13, 20, 19, 22, 21,  3, 17,  6, 16,  1,  8,  2,  
                 4,  0) */
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 27, 29, 
                                               23, 30, 15, 25, 14, 28, 10, 9, 
                                               12, 11, 18, 7, 5, 26, 24, 13, 
                                               20, 19, 22, 21, 3, 17, 6, 16, 
                                               1, 8, 2, 4, 0), v7);
      __m512i min8 = _mm512_min_epu16(v7, perm8);
      __m512i max8 = _mm512_max_epu16(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x880deaa, min8);
      
      /* Pairs: ([31,31], [30,30], [26,29], [28,28], [27,27], [25,25], 
                 [23,24], [13,22], [21,21], [14,20], [15,19], [9,18], 
                 [11,17], [12,16], [10,10], [7,8], [6,6], [2,5], [4,4], 
                 [3,3], [1,1], [0,0]) */
      /* Perm:  (31, 30, 26, 28, 27, 29, 25, 23, 24, 13, 21, 14, 15,  9, 11, 
                 12, 19, 20, 22, 16, 17, 10, 18,  7,  8,  6,  2,  4,  3,  5,  
                 1,  0) */
      __m512i perm9 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 26, 
                                               28, 27, 29, 25, 23, 24, 13, 
                                               21, 14, 15, 9, 11, 12, 19, 20, 
                                               22, 16, 17, 10, 18, 7, 8, 6, 
                                               2, 4, 3, 5, 1, 0), v8);
      __m512i min9 = _mm512_min_epu16(v8, perm9);
      __m512i max9 = _mm512_max_epu16(v8, perm9);
      __m512i v9 = _mm512_mask_mov_epi16(max9, 0x480fa84, min9);
      
      /* Pairs: ([31,31], [30,30], [27,29], [28,28], [26,26], [19,25], 
                 [24,24], [23,23], [15,22], [20,21], [14,18], [13,17], 
                 [9,16], [6,12], [10,11], [8,8], [7,7], [5,5], [2,4], [3,3], 
                 [1,1], [0,0]) */
      /* Perm:  (31, 30, 27, 28, 29, 26, 19, 24, 23, 15, 20, 21, 25, 14, 13,  
                 9, 22, 18, 17,  6, 10, 11, 16,  8,  7, 12,  5,  2,  3,  4,  
                 1,  0) */
      __m512i perm10 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 27, 
                                                28, 29, 26, 19, 24, 23, 15, 
                                                20, 21, 25, 14, 13, 9, 22, 
                                                18, 17, 6, 10, 11, 16, 8, 7, 
                                                12, 5, 2, 3, 4, 1, 0), v9);
      __m512i min10 = _mm512_min_epu16(v9, perm10);
      __m512i max10 = _mm512_max_epu16(v9, perm10);
      __m512i v10 = _mm512_mask_mov_epi16(max10, 0x818e644, min10);
...
minimum_31_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_31_uint16_t_vec(v);
