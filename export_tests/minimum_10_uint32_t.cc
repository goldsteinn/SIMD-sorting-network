...
#define N 10
#define SORT_NAME minimum_10_uint32_t

#ifndef _SIMD_SORT_minimum_10_uint32_t_H_
#define _SIMD_SORT_minimum_10_uint32_t_H_
...
minimum_10_uint32_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x2f, min1);
      ...
      __m512i v2 = _mm512_mask_mov_epi32(max2, 0xd3, min2);
      ...
      __m512i v5 = _mm512_mask_mov_epi32(max5, 0x66, min5);
      ...
      __m512i v6 = _mm512_mask_mov_epi32(max6, 0x54, min6);
...
minimum_10_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_10_uint32_t_vec(v);
