...
#define TYPE int8_t
#define N 6
#define SORT_NAME minimum_6_int8_t

#ifndef _SIMD_SORT_minimum_6_int8_t_H_
#define _SIMD_SORT_minimum_6_int8_t_H_
...
minimum_6_int8_t_vec(__m64 v) {
      ...
      __m64 _tmp11 = (__m64)(0xff00ff00ffUL);
...
minimum_6_int8_t(int8_t * const arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = minimum_6_int8_t_vec(v);
