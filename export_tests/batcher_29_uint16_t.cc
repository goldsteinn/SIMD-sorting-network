...
#define N 29
#define SORT_NAME batcher_29_uint16_t

#ifndef _SIMD_SORT_batcher_29_uint16_t_H_
#define _SIMD_SORT_batcher_29_uint16_t_H_
...
batcher_29_uint16_t_vec(__m512i v) {
...
batcher_29_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_29_uint16_t_vec(v);
