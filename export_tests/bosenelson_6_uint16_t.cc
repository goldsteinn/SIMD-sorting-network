...
#define N 6
#define SORT_NAME bosenelson_6_uint16_t

#ifndef _SIMD_SORT_bosenelson_6_uint16_t_H_
#define _SIMD_SORT_bosenelson_6_uint16_t_H_
...
Sorting Network Information:
	...
	SIMD Type                        : __m128i
	SIMD Instruction Set(s) Used     : SSE2, SSE4.1, SSSE3, AVX2
...
bosenelson_6_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7,7], [6,6], [4,5], [3,3], [1,2], [0,0]) */
      /* Perm:  ( 7,  6,  4,  5,  3,  1,  2,  0) */
      __m128i perm0 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v, 0xd8), 
                                          0xe1);
      ...
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 7, 6, 
                                       9, 8, 11, 10, 1, 0, 3, 2, 5, 4));
      ...
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 5, 4, 
...
bosenelson_6_uint16_t(uint16_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_6_uint16_t_vec(v);
