...
#define TYPE int16_t
#define N 13
#define SORT_NAME minimum_13_int16_t

#ifndef _SIMD_SORT_minimum_13_int16_t_H_
#define _SIMD_SORT_minimum_13_int16_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_13_int16_t_vec(__m256i v) {
...
void inline __attribute__((always_inline)) minimum_13_int16_t(int16_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi16(int16_t(0x7fff));
__m256i v = _mm256_mask_loadu_epi16(_tmp0, 0x1fff, arr);
fill_works(v);
v = minimum_13_int16_t_vec(v);
