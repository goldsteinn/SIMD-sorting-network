...
#define TYPE int16_t
#define N 14
#define SORT_NAME minimum_14_int16_t

#ifndef _SIMD_SORT_minimum_14_int16_t_H_
#define _SIMD_SORT_minimum_14_int16_t_H_
...
minimum_14_int16_t_vec(__m256i v) {
      
      /* Pairs: ([15,15], [14,14], [8,13], [4,12], [7,11], [5,10], [1,9], 
                 [2,6], [0,3]) */
      /* Perm:  (15, 14,  8,  4,  7,  5,  1, 13, 11,  2, 10, 12,  0,  6,  9,  
                 3) */
      __m256i perm0 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 14, 8, 4, 
      ...
      /* Perm:  (15, 14,  6, 12,  9, 10, 11,  3,  1, 13,  2,  0,  8,  5,  7,  
                 4) */
      __m256i perm3 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 14, 6, 
      ...
      __m256i perm6 = _mm256_shuffle_epi8(v5, _mm256_set_epi8(31, 30, 29, 28, 
                                          25, 24, 27, 26, 17, 16, 19, 18, 21, 
                                          20, 23, 22, 13, 12, 15, 14, 9, 8, 
...
minimum_14_int16_t(int16_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = minimum_14_int16_t_vec(v);
