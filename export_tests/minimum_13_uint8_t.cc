...
#define TYPE uint8_t
#define N 13
#define SORT_NAME minimum_13_uint8_t

#ifndef _SIMD_SORT_minimum_13_uint8_t_H_
#define _SIMD_SORT_minimum_13_uint8_t_H_
...
Sorting Network Information:
	...
	SIMD Type                        : __m128i
	SIMD Instruction Set(s) Used     : SSE2, SSSE3, AVX512vl, AVX512bw
...
minimum_13_uint8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [10,12], [0,11], [8,9], [1,7], 
                 [6,6], [3,5], [2,4]) */
      /* Perm:  (15, 14, 13, 10,  0, 12,  8,  9,  1,  6,  3,  2,  5,  4,  7, 
                 11) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 10, 0, 12, 
                                       8, 9, 1, 6, 3, 2, 5, 4, 7, 11));
      ...
      /* Perm:  (15, 14, 13,  4, 11,  8,  9, 10,  5,  3,  7, 12,  6,  0,  1,  
                 2) */
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 4, 11, 8, 
                                       9, 10, 5, 3, 7, 12, 6, 0, 1, 2));
      ...
      /* Perm:  (15, 14, 13,  7,  6, 10,  4,  0, 12, 11,  2,  9,  1,  5,  3,  
                 8) */
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 7, 6, 10, 
                                       4, 0, 12, 11, 2, 9, 1, 5, 3, 8));
      ...
      /* Perm:  (15, 14, 13, 12,  9,  2, 11,  3,  7,  4,  5,  6,  8, 10,  0,  
                 1) */
      __m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 9, 2, 
                                       11, 3, 7, 4, 5, 6, 8, 10, 0, 1));
      ...
      /* Perm:  (15, 14, 13, 11, 12,  5,  7,  6,  9,  8, 10,  2,  1,  4,  3,  
                 0) */
      __m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 11, 12, 
                                       5, 7, 6, 9, 8, 10, 2, 1, 4, 3, 0));
      ...
      /* Perm:  (15, 14, 13, 12,  8,  9, 10, 11,  4,  5,  6,  7,  2,  3,  1,  
                 0) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 8, 9, 
                                       10, 11, 4, 5, 6, 7, 2, 3, 1, 0));
...
minimum_13_uint8_t(uint8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = minimum_13_uint8_t_vec(v);
