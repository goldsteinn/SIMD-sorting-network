...
#define TYPE int32_t
#define N 7
#define SORT_NAME oddeven_7_int32_t

#ifndef _SIMD_SORT_oddeven_7_int32_t_H_
#define _SIMD_SORT_oddeven_7_int32_t_H_
...
oddeven_7_int32_t_vec(__m256i v) {
...
oddeven_7_int32_t(int32_t * const arr) 
                             {
