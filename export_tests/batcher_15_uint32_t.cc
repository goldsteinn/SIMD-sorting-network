...
#define N 15
#define SORT_NAME batcher_15_uint32_t

#ifndef _SIMD_SORT_batcher_15_uint32_t_H_
#define _SIMD_SORT_batcher_15_uint32_t_H_
...
batcher_15_uint32_t_vec(__m512i v) {
      
      /* Pairs: ([15,15], [6,14], [5,13], [4,12], [3,11], [2,10], [1,9], 
                 [0,8], [7,7]) */
      /* Perm:  (15,  6,  5,  4,  3,  2,  1,  0,  7, 14, 13, 12, 11, 10,  9,  
                 8) */
      __m512i perm0 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 6, 5, 4, 
                                               3, 2, 1, 0, 7, 14, 13, 12, 11, 
                                               10, 9, 8), v);
      __m512i min0 = _mm512_min_epu32(v, perm0);
      __m512i max0 = _mm512_max_epu32(v, perm0);
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x7f, min0);
      
      /* Pairs: ([15,15], [10,14], [9,13], [8,12], [11,11], [3,7], [2,6], 
                 [1,5], [0,4]) */
      /* Perm:  (15, 10,  9,  8, 11, 14, 13, 12,  3,  2,  1,  0,  7,  6,  5,  
                 4) */
      __m512i perm1 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 10, 9, 8, 
                                               11, 14, 13, 12, 3, 2, 1, 0, 7, 
                                               6, 5, 4), v0);
      __m512i min1 = _mm512_min_epu32(v0, perm1);
      __m512i max1 = _mm512_max_epu32(v0, perm1);
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x70f, min1);
      
      /* Pairs: ([15,15], [12,14], [13,13], [7,11], [6,10], [5,9], [4,8], 
                 [1,3], [0,2]) */
      /* Perm:  (15, 12, 13, 14,  7,  6,  5,  4, 11, 10,  9,  8,  1,  0,  3,  
                 2) */
      __m512i perm2 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 12, 13, 
                                               14, 7, 6, 5, 4, 11, 10, 9, 8, 
                                               1, 0, 3, 2), v1);
      __m512i min2 = _mm512_min_epu32(v1, perm2);
      __m512i max2 = _mm512_max_epu32(v1, perm2);
      __m512i v2 = _mm512_mask_mov_epi32(max2, 0x10f3, min2);
      ...
      __m512i v5 = _mm512_mask_mov_epi32(max5, 0xccc, min5);
      ...
      /* Perm:  (15,  7, 13,  5, 11,  3,  9,  1, 14,  6, 12,  4, 10,  2,  8,  
                 0) */
      __m512i perm7 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 7, 13, 5, 
      ...
      /* Perm:  (15, 11, 13,  9, 14,  7, 12,  5, 10,  3,  8,  1,  6,  2,  4,  
                 0) */
      __m512i perm8 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 11, 13, 
                                               9, 14, 7, 12, 5, 10, 3, 8, 1, 
                                               6, 2, 4, 0), v7);
      __m512i min8 = _mm512_min_epu32(v7, perm8);
      __m512i max8 = _mm512_max_epu32(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi32(max8, 0xaaa, min8);
...
batcher_15_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_15_uint32_t_vec(v);
