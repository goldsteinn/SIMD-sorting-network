...
#define TYPE uint8_t
#define N 39
#define SORT_NAME batcher_39_uint8_t

#ifndef _SIMD_SORT_batcher_39_uint8_t_H_
#define _SIMD_SORT_batcher_39_uint8_t_H_
...
batcher_39_uint8_t_vec(__m512i v) {
      ...
      __m512i v8 = _mm512_mask_mov_epi8(max8, 0x70707070, min8);
...
batcher_39_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_39_uint8_t_vec(v);
