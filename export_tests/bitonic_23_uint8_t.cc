...
/* SIMD Sort */
__m256i __attribute__((const)) bitonic_23_uint8_t_vec(__m256i v) {

__m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 21, 22, 20, 18, 19, 17, 15, 16, 14, 12, 13, 11, 9, 10, 8, 6, 7, 5, 3, 4, 2, 0, 1), v);
...
__m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 20, 21, 18, 19, 17, 15, 16, 14, 13, 11, 12, 9, 10, 8, 7, 5, 6, 1, 2, 3, 4, 0), v1);
...
__m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 21, 22, 18, 17, 20, 19, 14, 13, 16, 15, 11, 12, 8, 7, 10, 9, 5, 6, 4, 2, 3, 0, 1), v3);
...
__m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 19, 20, 17, 18, 15, 16, 13, 14, 12, 11, 9, 10, 7, 8, 1, 2, 4, 3, 5, 6, 0), v4);
...
__m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 13, 14, 15, 16, 18, 17, 19, 20, 21, 22, 12, 11, 6, 5, 3, 0, 10, 9, 4, 8, 2, 1, 7), v5);
...
__m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 20, 19, 22, 21, 13, 14, 12, 11, 17, 18, 16, 15, 8, 9, 10, 4, 3, 5, 7, 6, 0, 1, 2), v6);
...
__m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 21, 22, 19, 20, 15, 16, 17, 18, 12, 11, 14, 13, 10, 7, 8, 9, 6, 4, 5, 3, 1, 2, 0), v7);
...
__m256i perm10 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 23, 4, 5, 6, 7, 8, 9, 10, 3, 14, 13, 12, 11, 16, 17, 18, 19, 20, 21, 22, 15, 2, 1, 0), v9);
...
void inline __attribute__((always_inline)) bitonic_23_uint8_t(uint8_t * const arr) {

__m256i v = _mm256_mask_loadu_epi8(_mm256_set1_epi8(uint8_t(0xff)), 0x7fffff, arr);
v = bitonic_23_uint8_t_vec(v);
_mm256_mask_storeu_epi8((void *)arr, 0x7fffff, v);
