...
#define N 8
#define SORT_NAME oddeven_8_uint16_t

#ifndef _SIMD_SORT_oddeven_8_uint16_t_H_
#define _SIMD_SORT_oddeven_8_uint16_t_H_
...
oddeven_8_uint16_t_vec(__m128i v) {
...
oddeven_8_uint16_t(uint16_t * const 
                             arr) {
