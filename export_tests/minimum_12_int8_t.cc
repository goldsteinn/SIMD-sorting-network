...
minimum_12_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [3,11], [4,10], [5,9], 
                 [0,8], [1,7], [2,6]) */
      /* Perm:  (15, 14, 13, 12,  3,  4,  5,  0,  1,  2,  9, 10, 11,  6,  7,  
                 8) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 3, 4, 
                                       5, 0, 1, 2, 9, 10, 11, 6, 7, 8));
      ...
      /* Perm:  (15, 14, 13, 12,  9,  7, 11,  6, 10,  8,  3,  1,  5,  0,  4,  
                 2) */
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 9, 7, 
      ...
      /* Perm:  (15, 14, 13, 12, 10, 11,  2,  8,  4,  5,  6,  7,  3,  9,  0,  
                 1) */
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 10, 
...
minimum_12_int8_t(int8_t * const arr) 
                             {
