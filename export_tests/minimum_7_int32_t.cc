...
#define TYPE int32_t
#define N 7
#define SORT_NAME minimum_7_int32_t

#ifndef _SIMD_SORT_minimum_7_int32_t_H_
#define _SIMD_SORT_minimum_7_int32_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_7_int32_t_vec(__m256i v) {
