...
#define TYPE int8_t
#define N 13
#define SORT_NAME batcher_13_int8_t

#ifndef _SIMD_SORT_batcher_13_int8_t_H_
#define _SIMD_SORT_batcher_13_int8_t_H_
...
batcher_13_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [4,12], [2,10], [1,9], [0,8], 
                 [7,7], [6,6], [5,5], [12,4], [10,2], [9,1], [8,0]) */
      /* Perm:  (15, 14, 13,  4,  2,  1,  0,  7,  6,  5, 12, 10,  9,  8) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 4, 3, 2, 
                                       1, 0, 7, 6, 5, 12, 11, 10, 9, 8));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [8,12], [11,11], [10,10], [9,9], 
                 [12,8], [2,6], [1,5], [0,4], [6,2], [5,1], [4,0]) */
      /* Perm:  (15, 14, 13,  8, 11, 10,  9, 12,  2,  1,  0,  6,  5,  4) */
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 8, 11, 
                                       10, 9, 12, 3, 2, 1, 0, 7, 6, 5, 4));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [6,12], [11,11], [10,10], [2,8], 
                 [7,7], [12,6], [8,2]) */
      /* Perm:  (15, 14, 13,  6, 11, 10,  2,  7, 12,  8) */
      __m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 6, 11, 
                                       10, 3, 2, 7, 12, 5, 4, 9, 8, 1, 0));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [10,12], [11,11], [12,10], [7,9], 
                 [9,7], [2,4], [4,2]) */
      /* Perm:  (15, 14, 13, 10, 11, 12,  7,  9,  2,  4) */
      __m128i perm5 = _mm_shuffle_epi8(v4, _mm_set_epi8(15, 14, 13, 10, 11, 
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [10,11], [11,10], [8,9], 
                 [9,8], [2,3], [3,2]) */
      /* Perm:  (15, 14, 13, 12, 10, 11,  8,  9,  2,  3) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 10, 
                                       11, 8, 9, 6, 7, 4, 5, 2, 3, 1, 0));
      __m128i min6 = _mm_min_epi8(v5, perm6);
      __m128i max6 = _mm_max_epi8(v5, perm6);
      __m128i v6 = _mm_blendv_epi8(max6, min6, _mm_set_epi8(0, 0, 0, 0, 0, 
...
batcher_13_int8_t(int8_t * const arr) 
                             {
