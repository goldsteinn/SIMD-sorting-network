...
minimum_7_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7,7], [0,6], [4,5], [2,3], [1,1]) */
      /* Perm:  ( 7,  0,  4,  5,  2,  3,  1,  6) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 1, 0, 9, 8, 
                                       11, 10, 5, 4, 7, 6, 3, 2, 13, 12));
      ...
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 7, 6, 11, 10, 
                                       3, 2, 13, 12, 1, 0, 9, 8, 5, 4));
      ...
      __m128i perm3 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v2, 0xd8), 
                                          0xc6);
      ...
      __m128i perm4 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v3, 0xb4), 
                                          0xe1);
...
minimum_7_uint16_t(uint16_t * const 
                             arr) {
