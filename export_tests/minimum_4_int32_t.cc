...
#define TYPE int32_t
#define N 4
#define SORT_NAME minimum_4_int32_t

#ifndef _SIMD_SORT_minimum_4_int32_t_H_
#define _SIMD_SORT_minimum_4_int32_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_4_int32_t_vec(__m128i v) {

/* Pairs: ([1,3], [0,2]) */
/* Perm:  ( 1,  0,  3,  2) */
__m128i perm0 = _mm_shuffle_epi32(v, uint8_t(0x4e));
__m128i min0 = _mm_min_epi32(v, perm0);
__m128i max0 = _mm_max_epi32(v, perm0);
__m128i v0 = _mm_blend_epi32(max0, min0, 0x3);

/* Pairs: ([2,3], [0,1]) */
/* Perm:  ( 2,  3,  0,  1) */
__m128i perm1 = _mm_shuffle_epi32(v0, uint8_t(0xb1));
__m128i min1 = _mm_min_epi32(v0, perm1);
__m128i max1 = _mm_max_epi32(v0, perm1);
__m128i v1 = _mm_blend_epi32(max1, min1, 0x5);

/* Pairs: ([3,3], [1,2], [0,0]) */
/* Perm:  ( 3,  1,  2,  0) */
__m128i perm2 = _mm_shuffle_epi32(v1, uint8_t(0xd8));
__m128i min2 = _mm_min_epi32(v1, perm2);
__m128i max2 = _mm_max_epi32(v1, perm2);
...
void inline __attribute__((always_inline)) minimum_4_int32_t(int32_t * const arr) {

__m128i _tmp0 = _mm_set1_epi32(int32_t(0x7fffffff));
__m128i v = _mm_mask_loadu_epi32(_tmp0, 0xf, (int32_t * const)arr);
fill_works(v);
v = minimum_4_int32_t_vec(v);

fill_works(v);_mm_mask_storeu_epi32((void *)arr, 0xf, v);
