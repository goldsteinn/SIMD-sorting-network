...
#ifndef _SIMD_SORT_bitonic_8_uint32_t_H_
#define _SIMD_SORT_bitonic_8_uint32_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) bitonic_8_uint32_t_vec(__m256i v) {
...
__m256i perm3 = _mm256_shuffle_epi32(_tmp2, uint8_t(0x1b));
...
void inline __attribute__((always_inline)) bitonic_8_uint32_t(uint32_t * const arr) {
...
#define N 8
#define SORT_NAME bitonic_8_uint32_t
