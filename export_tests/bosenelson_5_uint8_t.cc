...
#define TYPE uint8_t
#define N 5
#define SORT_NAME bosenelson_5_uint8_t

#ifndef _SIMD_SORT_bosenelson_5_uint8_t_H_
#define _SIMD_SORT_bosenelson_5_uint8_t_H_
...
bosenelson_5_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp0 = (__m64)(0xff0000ffUL);
...
bosenelson_5_uint8_t(uint8_t * const 
                             arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = bosenelson_5_uint8_t_vec(v);
