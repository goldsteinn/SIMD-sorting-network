...
#define TYPE int8_t
#define N 5
#define SORT_NAME batcher_5_int8_t

#ifndef _SIMD_SORT_batcher_5_int8_t_H_
#define _SIMD_SORT_batcher_5_int8_t_H_
...
batcher_5_int8_t_vec(__m64 v) {
      
      /* Pairs: ([7, 7], [6, 6], [5, 5], [0, 4], [1, 3], [3, 1], [4, 0]) */
      /* Perm:  ( 7,  6,  5,  0,  1,  3,  4) */
      __m64 perm0 = _mm_shuffle_pi8(v, _mm_set_pi8(7, 6, 5, 0, 1, 2, 3, 4));
      ...
      /* Pairs: ([7, 7], [6, 6], [5, 5], [4, 4], [0, 2], [2, 0]) */
      /* Perm:  ( 7,  6,  5,  4,  0,  2) */
      __m64 perm1 = _mm_shuffle_pi8(v0, _mm_set_pi8(7, 6, 5, 4, 3, 0, 1, 
                                                    2));
      ...
      __m64 _tmp9 = (__m64)(0xff00ffUL);
      __m64 v2 = _mm_or_si64(_mm_and_si64(_tmp9, min2), 
                                          _mm_andnot_si64(_tmp9, max2));
      
      /* Pairs: ([7, 7], [6, 6], [5, 5], [1, 4], [2, 3], [3, 2], [4, 1]) */
      /* Perm:  ( 7,  6,  5,  1,  2,  3,  4) */
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 5, 1, 2, 3, 4, 
                                                    0));
