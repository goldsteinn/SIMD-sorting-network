...
#define TYPE uint8_t
#define N 10
#define SORT_NAME minimum_10_uint8_t

#ifndef _SIMD_SORT_minimum_10_uint8_t_H_
#define _SIMD_SORT_minimum_10_uint8_t_H_
...
minimum_10_uint8_t_vec(__m128i v) {
...
minimum_10_uint8_t(uint8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = minimum_10_uint8_t_vec(v);
