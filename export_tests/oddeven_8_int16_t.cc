...
#define TYPE int16_t
#define N 8
#define SORT_NAME oddeven_8_int16_t

#ifndef _SIMD_SORT_oddeven_8_int16_t_H_
#define _SIMD_SORT_oddeven_8_int16_t_H_
...
oddeven_8_int16_t_vec(__m128i v) {
...
oddeven_8_int16_t(int16_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_8_int16_t_vec(v);
