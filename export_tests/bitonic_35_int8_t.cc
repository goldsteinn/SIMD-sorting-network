...
#define TYPE int8_t
#define N 35
#define SORT_NAME bitonic_35_int8_t

#ifndef _SIMD_SORT_bitonic_35_int8_t_H_
#define _SIMD_SORT_bitonic_35_int8_t_H_
...
bitonic_35_int8_t_vec(__m512i v) {
...
bitonic_35_int8_t(int8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_35_int8_t_vec(v);
