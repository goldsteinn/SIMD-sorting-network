...
#define TYPE uint8_t
#define N 15
#define SORT_NAME batcher_15_uint8_t

#ifndef _SIMD_SORT_batcher_15_uint8_t_H_
#define _SIMD_SORT_batcher_15_uint8_t_H_
...
batcher_15_uint8_t_vec(__m128i v) {
      ...
      __m128i v0 = _mm_mask_mov_epi8(max0, 0x7f, min0);
      ...
      __m128i v1 = _mm_mask_mov_epi8(max1, 0x70f, min1);
      ...
      __m128i v2 = _mm_mask_mov_epi8(max2, 0x10f3, min2);
