...
bitonic_48_uint8_t_vec(__m512i v) {
      ...
      __m512i perm3 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              59, 58, 57, 56, 55, 54, 53, 52, 
                                              51, 50, 49, 48, 43, 44, 45, 46, 
                                              47, 42, 41, 36, 37, 38, 39, 40, 
      ...
      __m512i perm4 = _mm512_shuffle_epi8(v3, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          50, 49, 48, 46, 47, 43, 42, 45, 44, 
                                          39, 38, 41, 40, 36, 37, 33, 32, 35, 
                                          34, 30, 31, 28, 29, 25, 24, 27, 26, 
                                          21, 20, 23, 22, 18, 19, 16, 17, 13, 
                                          12, 15, 14, 10, 11, 7, 6, 9, 8, 3, 
                                          2, 5, 4, 0, 1));
      ...
      __m512i perm5 = _mm512_shuffle_epi8(v4, _mm512_set_epi8(63, 62, 61, 60, 
                                          59, 58, 57, 56, 55, 54, 53, 52, 51, 
                                          50, 49, 48, 47, 46, 44, 45, 42, 43, 
                                          40, 41, 38, 39, 37, 36, 34, 35, 32, 
                                          33, 31, 30, 29, 28, 26, 27, 24, 25, 
                                          22, 23, 20, 21, 19, 18, 17, 16, 14, 
                                          15, 12, 13, 11, 10, 8, 9, 6, 7, 4, 
                                          5, 2, 3, 1, 0));
      ...
      __m512i perm9 = _mm512_shuffle_epi8(v8, _mm512_set_epi8(63, 62, 61, 60, 
                                          59, 58, 57, 56, 55, 54, 53, 52, 51, 
                                          50, 49, 48, 47, 46, 45, 44, 42, 43, 
                                          40, 41, 38, 39, 36, 37, 34, 35, 32, 
                                          33, 30, 31, 28, 29, 27, 26, 25, 24, 
                                          22, 23, 20, 21, 18, 19, 16, 17, 15, 
                                          14, 13, 12, 11, 10, 9, 8, 6, 7, 4, 
                                          5, 2, 3, 0, 1));
      ...
      __m512i perm11 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               60, 59, 58, 57, 56, 55, 54, 
                                               53, 52, 51, 50, 49, 48, 43, 
                                               42, 41, 40, 47, 46, 45, 44, 
...
bitonic_48_uint8_t(uint8_t * const arr) 
                                 {
