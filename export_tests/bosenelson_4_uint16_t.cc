...
#define N 4
#define SORT_NAME bosenelson_4_uint16_t

#ifndef _SIMD_SORT_bosenelson_4_uint16_t_H_
#define _SIMD_SORT_bosenelson_4_uint16_t_H_
...
bosenelson_4_uint16_t_vec(__m64 v) {
...
bosenelson_4_uint16_t(uint16_t * const 
                             arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = bosenelson_4_uint16_t_vec(v);
