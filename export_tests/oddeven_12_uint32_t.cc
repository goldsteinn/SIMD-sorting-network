...
#define N 12
#define SORT_NAME oddeven_12_uint32_t

#ifndef _SIMD_SORT_oddeven_12_uint32_t_H_
#define _SIMD_SORT_oddeven_12_uint32_t_H_
...
oddeven_12_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x555, min0);
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x333, min1);
