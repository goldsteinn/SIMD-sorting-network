...
minimum_27_uint8_t_vec(__m256i v) {
      ...
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 21, 22, 14, 13, 25, 26, 19, 
                                              20, 17, 18, 11, 12, 24, 23, 15, 
                                              16, 10, 0, 5, 3, 1, 8, 2, 7, 4, 
                                              6, 9), v);
      ...
      __m256i perm1 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 24, 16, 26, 20, 19, 12, 23, 
                                              22, 15, 14, 25, 18, 17, 11, 21, 
                                              13, 4, 6, 7, 8, 9, 3, 10, 5, 2, 
                                              0, 1), v0);
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 18, 23, 15, 25, 13, 17, 16, 
                                              11, 26, 21, 20, 24, 12, 22, 14, 
                                              19, 8, 9, 10, 4, 6, 2, 7, 1, 5, 
                                              3, 0), v1);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 25, 26, 22, 18, 24, 20, 21, 
                                              14, 23, 16, 17, 13, 19, 15, 11, 
                                              12, 10, 5, 6, 3, 8, 9, 0, 7, 1, 
                                              2, 4), v2);
      ...
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 23, 21, 25, 18, 24, 17, 
                                              15, 22, 20, 13, 19, 12, 16, 14, 
                                              11, 9, 10, 7, 8, 2, 4, 5, 3, 6, 
                                              0, 1), v3);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 24, 25, 21, 15, 23, 18, 
                                              17, 20, 19, 14, 22, 16, 12, 13, 
                                              0, 10, 8, 9, 5, 3, 7, 2, 6, 4, 
                                              1, 11), v4);
      ...
      __m256i perm8 = _mm256_shuffle_epi8(v7, _mm256_set_epi8(31, 30, 29, 28, 
                                          ...
                                          19, 16, 17, 14, 15, 2, 12, 11, 10, 
                                          9, 8, 7, 6, 5, 4, 3, 13, 1, 0));
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 10, 9, 
                                              8, 7, 6, 5, 4, 3, 13, 12, 11, 
      ...
      __m256i perm11 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 
                                               ...
                                               25, 24, 23, 22, 13, 12, 11, 7, 
                                               17, 16, 15, 6, 5, 4, 14, 10, 
                                               9, 8, 3, 2, 1, 0), v10);
      ...
      __m256i perm12 = _mm256_shuffle_epi8(v11, _mm256_set_epi8(31, 30, 29, 
                                           28, 27, 24, 25, 26, 21, 20, 23, 
                                           22, 17, 16, 19, 18, 13, 12, 15, 
                                           14, 10, 11, 7, 6, 9, 8, 3, 2, 5, 
                                           4, 1, 0));
...
minimum_27_uint8_t(uint8_t * const arr) 
                             {
