...
#define TYPE int32_t
#define N 8
#define SORT_NAME bosenelson_8_int32_t

#ifndef _SIMD_SORT_bosenelson_8_int32_t_H_
#define _SIMD_SORT_bosenelson_8_int32_t_H_
...
bosenelson_8_int32_t_vec(__m256i v) {
      ...
      __m256i perm6 = _mm256_permutevar8x32_epi32(v5, _mm256_set_epi32(7, 6, 
                                                  5, 3, 4, 2, 1, 0));
      __m256i min6 = _mm256_min_epi32(v5, perm6);
      __m256i max6 = _mm256_max_epi32(v5, perm6);
...
bosenelson_8_int32_t(int32_t * const 
                             arr) {
