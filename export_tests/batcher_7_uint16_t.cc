...
#define N 7
#define SORT_NAME batcher_7_uint16_t

#ifndef _SIMD_SORT_batcher_7_uint16_t_H_
#define _SIMD_SORT_batcher_7_uint16_t_H_
...
batcher_7_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7, 7], [2, 6], [1, 5], [0, 4], [3, 3], [6, 2], [5, 1], [4, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [4, 6], [5, 5], [6, 4], [1, 3], [0, 2], [3, 1], [2, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [3, 6], [5, 5], [1, 4], [6, 3], [2, 2], [4, 1], [0, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [5, 6], [6, 5], [3, 4], [4, 3], [1, 2], [2, 1], [0, 
                 0]) */
...
batcher_7_uint16_t(uint16_t * const 
                             arr) {
