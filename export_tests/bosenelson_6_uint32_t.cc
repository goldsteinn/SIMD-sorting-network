...
#define N 6
#define SORT_NAME bosenelson_6_uint32_t

#ifndef _SIMD_SORT_bosenelson_6_uint32_t_H_
#define _SIMD_SORT_bosenelson_6_uint32_t_H_
...
bosenelson_6_uint32_t_vec(__m256i v) {
      ...
      __m256i perm3 = _mm256_permutevar8x32_epi32(v2, _mm256_set_epi32(7, 6, 
                                                  5, 1, 0, 2, 4, 3));
      ...
      __m256i v4 = _mm256_blend_epi32(max4, min4, 0x6);
      ...
      __m256i v5 = _mm256_blend_epi32(max5, min5, 0x4);
...
bosenelson_6_uint32_t(uint32_t * const 
                             arr) {
