...
#define TYPE uint8_t
#define N 8
#define SORT_NAME bosenelson_8_uint8_t

#ifndef _SIMD_SORT_bosenelson_8_uint8_t_H_
#define _SIMD_SORT_bosenelson_8_uint8_t_H_
...
bosenelson_8_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp1 = (__m64)(0xff00ff00ff00ffUL);
      ...
      __m64 _tmp3 = (__m64)(0xff00ff00ffffUL);
      ...
      __m64 _tmp6 = (__m64)(0xffff0000UL);
      ...
      __m64 _tmp7 = (__m64)(0xff000000UL);
...
bosenelson_8_uint8_t(uint8_t * const 
                             arr) {
