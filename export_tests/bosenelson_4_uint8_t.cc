...
#define TYPE uint8_t
#define N 4
#define SORT_NAME bosenelson_4_uint8_t

#ifndef _SIMD_SORT_bosenelson_4_uint8_t_H_
#define _SIMD_SORT_bosenelson_4_uint8_t_H_
...
bosenelson_4_uint8_t_vec(__m64 v) {
...
bosenelson_4_uint8_t(uint8_t * const 
                             arr) {
