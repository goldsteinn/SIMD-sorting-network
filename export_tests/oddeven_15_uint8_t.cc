...
#define TYPE uint8_t
#define N 15
#define SORT_NAME oddeven_15_uint8_t

#ifndef _SIMD_SORT_oddeven_15_uint8_t_H_
#define _SIMD_SORT_oddeven_15_uint8_t_H_
...
oddeven_15_uint8_t_vec(__m128i v) {
...
oddeven_15_uint8_t(uint8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_15_uint8_t_vec(v);
