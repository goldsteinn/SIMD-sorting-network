...
#define TYPE uint8_t
#define N 9
#define SORT_NAME oddeven_9_uint8_t

#ifndef _SIMD_SORT_oddeven_9_uint8_t_H_
#define _SIMD_SORT_oddeven_9_uint8_t_H_
...
oddeven_9_uint8_t_vec(__m128i v) {
      ...
      __m128i v0 = _mm_mask_mov_epi8(max0, 0x55, min0);
      ...
      __m128i v7 = _mm_mask_mov_epi8(max7, 0x44, min7);
