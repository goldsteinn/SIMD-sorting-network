...
minimum_6_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7,7], [6,6], [0,5], [2,4], [1,3]) */
      /* Perm:  ( 7,  6,  0,  2,  1,  4,  3,  5) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 1, 0, 
                                       5, 4, 3, 2, 9, 8, 7, 6, 11, 10));
      ...
      __m128i perm3 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v2, 0xb1), 
                                          0xe1);
...
minimum_6_uint16_t(uint16_t * const 
                             arr) {
