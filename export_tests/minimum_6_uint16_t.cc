...
#define N 6
#define SORT_NAME minimum_6_uint16_t

#ifndef _SIMD_SORT_minimum_6_uint16_t_H_
#define _SIMD_SORT_minimum_6_uint16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_6_uint16_t_vec(__m128i v) {

/* Pairs: ([7,7], [6,6], [0,5], [2,4], [1,3]) */
/* Perm:  ( 7,  6,  0,  2,  1,  4,  3,  5) */
__m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 1, 0, 5, 4, 3, 2, 9, 8, 7, 6, 11, 10));
...
__m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 11, 10, 7, 6, 9, 8, 3, 2, 5, 4, 1, 0));
__m128i min1 = _mm_min_epu16(v0, perm1);
__m128i max1 = _mm_max_epu16(v0, perm1);
__m128i v1 = _mm_blend_epi16(max1, min1, 0xa);

/* Pairs: ([7,7], [6,6], [2,5], [4,4], [0,3], [1,1]) */
/* Perm:  ( 7,  6,  2,  4,  0,  5,  1,  3) */
__m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 5, 4, 9, 8, 1, 0, 11, 10, 3, 2, 7, 6));
...
__m128i perm3 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v2, 0xb1), 0xe1);
__m128i min3 = _mm_min_epu16(v2, perm3);
__m128i max3 = _mm_max_epu16(v2, perm3);
__m128i v3 = _mm_blend_epi16(max3, min3, 0x15);

/* Pairs: ([7,7], [6,6], [5,5], [3,4], [1,2], [0,0]) */
/* Perm:  ( 7,  6,  5,  3,  4,  1,  2,  0) */
__m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 12, 11, 10, 7, 6, 9, 8, 3, 2, 5, 4, 1, 0));
...
void inline __attribute__((always_inline)) minimum_6_uint16_t(uint16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(uint16_t(0xffff));
__m128i v = _mm_mask_loadu_epi32(_tmp0, 0x7, (int32_t * const)arr);
fill_works(v);
v = minimum_6_uint16_t_vec(v);
