...
#define N 11
#define SORT_NAME minimum_11_uint32_t

#ifndef _SIMD_SORT_minimum_11_uint32_t_H_
#define _SIMD_SORT_minimum_11_uint32_t_H_
...
minimum_11_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x2f, min0);
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0xd9, min1);
      ...
      __m512i v3 = _mm512_mask_mov_epi32(max3, 0x6b, min3);
      ...
      __m512i v4 = _mm512_mask_mov_epi32(max4, 0x295, min4);
      ...
      __m512i v6 = _mm512_mask_mov_epi32(max6, 0xaa, min6);
      ...
      __m512i v7 = _mm512_mask_mov_epi32(max7, 0x54, min7);
...
minimum_11_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_11_uint32_t_vec(v);
