...
#define TYPE uint8_t
#define N 26
#define SORT_NAME minimum_26_uint8_t

#ifndef _SIMD_SORT_minimum_26_uint8_t_H_
#define _SIMD_SORT_minimum_26_uint8_t_H_
...
minimum_26_uint8_t_vec(__m256i v) {
      ...
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 12, 19, 17, 5, 18, 3, 
                                              24, 21, 23, 9, 10, 11, 0, 25, 
                                              14, 15, 16, 2, 4, 1, 22, 7, 20, 
                                              8, 6, 13), v);
      ...
      __m256i perm1 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 22, 6, 23, 25, 7, 13, 
                                              1, 4, 9, 8, 14, 15, 20, 5, 10, 
                                              11, 17, 16, 21, 24, 12, 18, 0, 
                                              2, 19, 3), v0);
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 15, 20, 8, 13, 21, 24, 
                                              14, 9, 2, 7, 25, 19, 22, 3, 6, 
                                              0, 18, 23, 16, 11, 1, 4, 12, 
                                              17, 5, 10), v1);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 24, 25, 16, 11, 17, 15, 
                                              12, 7, 21, 23, 20, 3, 6, 19, 
                                              22, 5, 2, 4, 18, 13, 10, 8, 14, 
                                              9, 0, 1), v2);
      ...
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 20, 21, 19, 23, 24, 
                                              22, 16, 8, 18, 10, 11, 12, 13, 
                                              14, 15, 7, 17, 9, 3, 1, 2, 6, 
                                              4, 5, 0), v3);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 23, 22, 25, 24, 18, 19, 
                                              20, 21, 15, 9, 17, 13, 14, 11, 
                                              12, 8, 16, 10, 4, 5, 6, 7, 1, 
                                              0, 3, 2), v4);
      ...
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 23, 24, 21, 22, 20, 
                                              7, 6, 14, 13, 10, 17, 16, 9, 8, 
                                              15, 12, 11, 19, 18, 5, 3, 4, 1, 
                                              2, 0), v5);
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 16, 14, 22, 19, 18, 
                                              21, 20, 17, 24, 13, 23, 15, 10, 
                                              2, 12, 1, 8, 5, 4, 7, 6, 3, 11, 
                                              9, 0), v6);
      ...
      __m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 22, 17, 24, 21, 20, 
                                              11, 12, 23, 15, 16, 6, 7, 18, 
                                              19, 9, 10, 2, 13, 14, 5, 4, 1, 
                                              8, 3, 0), v7);
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 20, 22, 16, 23, 
                                              15, 17, 18, 21, 19, 12, 11, 14, 
                                              13, 6, 4, 7, 8, 10, 2, 9, 3, 5, 
                                              1, 0), v8);
...
minimum_26_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = minimum_26_uint8_t_vec(v);
