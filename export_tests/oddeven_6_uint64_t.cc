...
#define N 6
#define SORT_NAME oddeven_6_uint64_t

#ifndef _SIMD_SORT_oddeven_6_uint64_t_H_
#define _SIMD_SORT_oddeven_6_uint64_t_H_
...
oddeven_6_uint64_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi64(max1, 0x3, min1);
      
      /* Pairs: ([7,7], [6,6], [5,5], [0,4], [3,3], [1,2]) */
      /* Perm:  ( 7,  6,  5,  0,  3,  1,  2,  4) */
      __m512i perm2 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 0, 
                                               3, 1, 2, 4), v1);
      __m512i min2 = _mm512_min_epu64(v1, perm2);
      __m512i max2 = _mm512_max_epu64(v1, perm2);
      __m512i v2 = _mm512_mask_mov_epi64(max2, 0x3, min2);
      ...
      __m512i perm4 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 3, 4, 
                                               5, 1, 2, 0), v3);
      ...
      __m512i perm5 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 3, 
                                               4, 2, 1, 0), v4);
      __m512i min5 = _mm512_min_epu64(v4, perm5);
      __m512i max5 = _mm512_max_epu64(v4, perm5);
      __m512i v5 = _mm512_mask_mov_epi64(max5, 0x8, min5);
