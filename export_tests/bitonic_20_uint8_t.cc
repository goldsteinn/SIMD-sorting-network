...
bitonic_20_uint8_t_vec(__m256i v) {
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 15, 16, 17, 18, 12, 11, 14, 
                                              13, 10, 7, 6, 9, 8, 5, 4, 0, 1, 
                                              2, 3), v2);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              13, 14, 11, 12, 15, 18, 19, 16, 
                                              17, 10, 9, 2, 3, 0, 1, 4, 7, 8, 
                                              5, 6), v4);
...
bitonic_20_uint8_t(uint8_t * const arr) 
                             {
