...
#define N 8
#define SORT_NAME oddeven_8_uint32_t

#ifndef _SIMD_SORT_oddeven_8_uint32_t_H_
#define _SIMD_SORT_oddeven_8_uint32_t_H_
...
oddeven_8_uint32_t_vec(__m256i v) {
...
oddeven_8_uint32_t(uint32_t * const 
                             arr) {
