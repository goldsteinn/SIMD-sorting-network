...
#define N 10
#define SORT_NAME batcher_10_uint32_t

#ifndef _SIMD_SORT_batcher_10_uint32_t_H_
#define _SIMD_SORT_batcher_10_uint32_t_H_
...
batcher_10_uint32_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi32(max1, 0x3, min1);
...
batcher_10_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_10_uint32_t_vec(v);
