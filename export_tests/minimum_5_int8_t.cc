...
#define TYPE int8_t
#define N 5
#define SORT_NAME minimum_5_int8_t

#ifndef _SIMD_SORT_minimum_5_int8_t_H_
#define _SIMD_SORT_minimum_5_int8_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) minimum_5_int8_t_vec(__m64 v) {
...
__m64 _tmp12 = (__m64)(0xff00ff00UL);
...
void inline __attribute__((always_inline)) minimum_5_int8_t(int8_t * const arr) {

__m64 _tmp0 = _mm_set1_pi8(int8_t(0x7f));
__builtin_memcpy(&_tmp0, arr, 5);
__m64 v = _tmp0;
fill_works(v);
v = minimum_5_int8_t_vec(v);
