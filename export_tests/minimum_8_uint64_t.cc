...
#define N 8
#define SORT_NAME minimum_8_uint64_t

#ifndef _SIMD_SORT_minimum_8_uint64_t_H_
#define _SIMD_SORT_minimum_8_uint64_t_H_
...
minimum_8_uint64_t_vec(__m512i v) {
      ...
      __m512i perm3 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 3, 2, 
                                               5, 4, 1, 0), v2);
      __m512i min3 = _mm512_min_epu64(v2, perm3);
      __m512i max3 = _mm512_max_epu64(v2, perm3);
      __m512i v3 = _mm512_mask_mov_epi64(max3, 0xc, min3);
...
minimum_8_uint64_t(uint64_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_8_uint64_t_vec(v);
