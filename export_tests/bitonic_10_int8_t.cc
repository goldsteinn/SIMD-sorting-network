...
bitonic_10_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], 
                 [9,8], [7,7], [5,6], [6,5], [3,4], [4,3], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  7,  5,  6,  3,  4,  0,  1) 
                 */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [6,9], 
                 [7,8], [8,7], [9,6], [3,4], [4,3], [0,2], [2,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  6,  7,  8,  9,  3,  4,  0,  2) */
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       10, 6, 7, 8, 9, 5, 3, 4, 0, 1, 2));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [7,8], [8,7], [5,6], [6,5], [3,4], [4,3], [1,2], [2,1]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [3,9], 
                 [4,8], [1,7], [2,6], [8,4], [9,3], [6,2], [7,1]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  3,  4,  1,  2,  8,  9,  6,  7) */
      __m128i perm5 = _mm_shuffle_epi8(v4, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       10, 3, 4, 1, 2, 5, 8, 9, 6, 7, 0));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], 
                 [9,8], [7,7], [6,6], [3,5], [0,4], [5,3], [4,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  7,  6,  3,  0,  5,  4) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       10, 8, 9, 7, 6, 3, 0, 5, 2, 1, 4));
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [5,7], [4,6], [7,5], [6,4], [1,3], [0,2], [3,1], 
                 [2,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  8,  5,  4,  7,  6,  1,  0,  3,  
                 2) */
      __m128i perm7 = _mm_shufflelo_epi16(v6, 0xb1);
...
bitonic_10_int8_t(int8_t * const arr) 
                             {
      ...
      __builtin_memcpy(arr + 8, &_tmp2, 2);;
