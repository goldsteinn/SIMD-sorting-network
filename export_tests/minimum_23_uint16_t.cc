...
#define N 23
#define SORT_NAME minimum_23_uint16_t

#ifndef _SIMD_SORT_minimum_23_uint16_t_H_
#define _SIMD_SORT_minimum_23_uint16_t_H_
...
minimum_23_uint16_t_vec(__m512i v) {
      ...
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x133333, min3);
...
minimum_23_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_23_uint16_t_vec(v);
