...
#define N 26
#define SORT_NAME bitonic_26_uint16_t

#ifndef _SIMD_SORT_bitonic_26_uint16_t_H_
#define _SIMD_SORT_bitonic_26_uint16_t_H_
...
bitonic_26_uint16_t_vec(__m512i v) {
      ...
      __m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 22, 23, 24, 25, 
                                               21, 19, 20, 18, 16, 17, 13, 
      ...
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 19, 20, 21, 22, 
                                               23, 24, 25, 18, 13, 14, 15, 
                                               16, 17, 12, 6, 7, 8, 9, 10, 
                                               11, 1, 2, 3, 4, 5, 0), v2);
      ...
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 23, 24, 25, 20, 
                                               19, 22, 21, 16, 15, 18, 17, 
                                               13, 14, 10, 9, 12, 11, 6, 7, 
                                               8, 4, 5, 1, 0, 3, 2), v3);
      ...
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 14, 23, 24, 21, 
                                               22, 19, 20, 17, 18, 15, 16, 
                                               25, 13, 11, 12, 9, 10, 7, 8, 
                                               4, 5, 6, 2, 3, 0, 1), v4);
      ...
      __m512i perm6 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 15, 16, 17, 
                                               18, 20, 19, 21, 22, 23, 24, 
                                               14, 13, 12, 11, 0, 1, 2, 3, 6, 
                                               5, 4, 7, 8, 9, 10), v5);
      ...
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 21, 22, 
                                               23, 17, 18, 19, 20, 14, 13, 
      ...
      __m512i perm11 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                                28, 27, 26, 17, 16, 19, 18, 
                                                21, 20, 23, 22, 25, 24, 5, 6, 
...
bitonic_26_uint16_t(uint16_t * const 
                                 arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_26_uint16_t_vec(v);
