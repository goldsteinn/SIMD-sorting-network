...
#define TYPE uint8_t
#define N 23
#define SORT_NAME minimum_23_uint8_t

#ifndef _SIMD_SORT_minimum_23_uint8_t_H_
#define _SIMD_SORT_minimum_23_uint8_t_H_
...
minimum_23_uint8_t_vec(__m256i v) {
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [18,22], [15,21], [14,20], 
                 [19,19], [13,17], [12,16], [7,11], [6,10], [3,9], [2,8], 
                 [1,5], [0,4]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 18, 15, 14, 19, 22, 13, 
                 12, 21, 20, 17, 16,  7,  6,  3,  2, 11, 10,  1,  0,  9,  8,  
                 5,  4) */
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 18, 15, 14, 
                                              19, 22, 13, 12, 21, 20, 17, 16, 
                                              7, 6, 3, 2, 11, 10, 1, 0, 9, 8, 
                                              5, 4), v1);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [24,24], [23,23], [10,22], [19,21], [18,20], 
                 [15,17], [14,16], [1,13], [0,12], [11,11], [7,9], [6,8], 
                 [3,5], [2,4]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 24, 23, 10, 19, 18, 21, 20, 15, 
                 14, 17, 16,  1,  0, 11, 22,  7,  6,  9,  8,  3,  2,  5,  4, 
                 13, 12) */
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 10, 19, 18, 
                                              21, 20, 15, 14, 17, 16, 1, 0, 
                                              11, 22, 7, 6, 9, 8, 3, 2, 5, 4, 
                                              13, 12), v3);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 11, 9, 8, 
                                              7, 6, 5, 4, 3, 2, 13, 1, 22, 
                                              10, 21, 20, 19, 18, 17, 16, 15, 
                                              14, 12, 0), v4);
      ...
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 21, 22, 9, 
                                              17, 16, 19, 18, 10, 3, 8, 12, 
                                              11, 15, 20, 13, 5, 4, 7, 6, 14, 
                                              1, 2, 0), v5);
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              19, 7, 20, 5, 11, 10, 9, 8, 15, 
                                              14, 13, 12, 18, 3, 16, 4, 6, 2, 
                                              1, 0), v6);
      ...
      __m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              15, 11, 13, 9, 19, 7, 17, 5, 
                                              18, 6, 16, 4, 14, 10, 12, 8, 2, 
                                              3, 1, 0), v7);
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              21, 15, 17, 14, 18, 16, 11, 10, 
                                              13, 12, 7, 5, 9, 6, 8, 2, 3, 4, 
                                              1, 0), v8);
...
minimum_23_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = minimum_23_uint8_t_vec(v);
