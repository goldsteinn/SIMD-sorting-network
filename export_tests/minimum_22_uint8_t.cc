...
#define TYPE uint8_t
#define N 22
#define SORT_NAME minimum_22_uint8_t

#ifndef _SIMD_SORT_minimum_22_uint8_t_H_
#define _SIMD_SORT_minimum_22_uint8_t_H_
...
minimum_22_uint8_t_vec(__m256i v) {
      ...
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 7, 13, 
                                              17, 16, 19, 18, 10, 0, 20, 9, 
                                              6, 15, 12, 1, 21, 11, 3, 2, 5, 
                                              4, 8, 14), v);
      ...
      __m256i perm1 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 14, 8, 
                                              4, 5, 2, 3, 11, 21, 1, 12, 15, 
                                              6, 9, 20, 0, 10, 18, 19, 16, 
                                              17, 13, 7), v0);
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              19, 15, 12, 11, 18, 8, 7, 17, 
                                              16, 5, 4, 14, 13, 3, 10, 9, 6, 
                                              2, 0, 1), v1);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 18, 13, 
                                              17, 21, 19, 16, 15, 10, 20, 9, 
                                              7, 14, 12, 1, 11, 6, 5, 2, 0, 
                                              4, 8, 3), v2);
      ...
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              14, 4, 3, 10, 20, 19, 12, 13, 
                                              5, 16, 8, 9, 2, 1, 11, 18, 17, 
                                              7, 6, 0), v3);
      ...
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              21, 14, 15, 13, 17, 18, 16, 10, 
                                              9, 12, 11, 5, 3, 4, 8, 6, 7, 0, 
                                              1, 2), v4);
      ...
      __m256i perm6 = _mm256_shuffle_epi8(v5, _mm256_set_epi8(31, 30, 29, 28, 
                                          27, 26, 25, 24, 23, 22, 21, 17, 19, 
                                          16, 20, 18, 8, 12, 6, 14, 11, 10, 
                                          7, 15, 9, 13, 3, 1, 5, 2, 4, 0));
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              20, 18, 11, 16, 9, 13, 14, 6, 
                                              17, 4, 15, 7, 8, 12, 5, 10, 3, 
                                              1, 2, 0), v6);
      ...
      __m256i perm8 = _mm256_shuffle_epi8(v7, _mm256_set_epi8(31, 30, 29, 28, 
                                          27, 26, 25, 24, 23, 22, 21, 18, 16, 
                                          20, 17, 19, 11, 14, 12, 13, 15, 6, 
                                          8, 9, 7, 10, 2, 4, 1, 5, 3, 0));
      ...
      __m256i perm9 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              18, 19, 13, 14, 12, 16, 17, 15, 
                                              10, 11, 6, 4, 5, 9, 7, 8, 2, 3, 
                                              1, 0), v8);
      ...
      __m256i perm10 = _mm256_shuffle_epi8(v9, _mm256_set_epi8(31, 30, 29, 
                                           ...
                                           20, 19, 18, 16, 17, 14, 15, 11, 9, 
                                           13, 8, 12, 10, 6, 7, 4, 5, 3, 2, 
                                           1, 0));
...
minimum_22_uint8_t(uint8_t * const arr) 
                             {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = minimum_22_uint8_t_vec(v);
