...
/* SIMD Sort */
__m128i __attribute__((const)) bitonic_15_int8_t_vec(__m128i v) {
...
__m128i v0 = _mm_blendv_epi8(max0, min0, _mm_set_epi8(0, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0));
...
__m128i v1 = _mm_blendv_epi8(max1, min1, _mm_set_epi8(0, 0, 0, 128, 128, 0, 0, 128, 128, 0, 0, 128, 128, 0, 0, 128));
...
__m128i v2 = _mm_blendv_epi8(max2, min2, _mm_set_epi8(0, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 0, 128));
...
__m128i v3 = _mm_blendv_epi8(max3, min3, _mm_set_epi8(0, 0, 0, 0, 0, 128, 128, 128, 128, 0, 0, 0, 0, 128, 128, 128));
...
__m128i v4 = _mm_blendv_epi8(max4, min4, _mm_set_epi8(0, 0, 0, 128, 128, 0, 0, 128, 128, 0, 0, 128, 128, 0, 0, 128));
...
__m128i v5 = _mm_blendv_epi8(max5, min5, _mm_set_epi8(0, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0));
...
__m128i v6 = _mm_blendv_epi8(max6, min6, _mm_set_epi8(0, 0, 0, 0, 0, 0, 0, 0, 0, 128, 128, 128, 128, 128, 128, 128));
...
__m128i v7 = _mm_blendv_epi8(max7, min7, _mm_set_epi8(0, 0, 0, 0, 0, 128, 128, 128, 0, 0, 0, 0, 128, 128, 128, 128));
...
__m128i v9 = _mm_blendv_epi8(max9, min9, _mm_set_epi8(0, 0, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128));
...
void inline __attribute__((always_inline)) bitonic_15_int8_t(int8_t * const arr) {
...
const uint32_t _tmp2 = (((uint32_t)((_aliasing_int16_t_ *)arr)[6]) & 0xffff) | ((((uint32_t)arr[14]) & 0xff) << 16);
