...
#define N 13
#define SORT_NAME batcher_13_uint32_t

#ifndef _SIMD_SORT_batcher_13_uint32_t_H_
#define _SIMD_SORT_batcher_13_uint32_t_H_
...
batcher_13_uint32_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi32(max0, 0x1f, min0);
      ...
      __m512i v2 = _mm512_mask_mov_epi32(max2, 0xf3, min2);
      ...
      __m512i v6 = _mm512_mask_mov_epi32(max6, 0x554, min6);
      ...
      __m512i v7 = _mm512_mask_mov_epi32(max7, 0x2a, min7);
      ...
      __m512i v9 = _mm512_mask_mov_epi32(max9, 0xaaa, min9);
...
batcher_13_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_13_uint32_t_vec(v);
