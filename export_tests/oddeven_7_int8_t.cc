...
#define TYPE int8_t
#define N 7
#define SORT_NAME oddeven_7_int8_t

#ifndef _SIMD_SORT_oddeven_7_int8_t_H_
#define _SIMD_SORT_oddeven_7_int8_t_H_
...
oddeven_7_int8_t_vec(__m64 v) {
      ...
      __m64 _tmp8 = (__m64)(0xff000000ffffUL);
...
oddeven_7_int8_t(int8_t * const arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = oddeven_7_int8_t_vec(v);
