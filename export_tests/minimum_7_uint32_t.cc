...
minimum_7_uint32_t_vec(__m256i v) {
      
      /* Pairs: ([7,7], [0,6], [4,5], [2,3], [1,1]) */
      /* Perm:  ( 7,  0,  4,  5,  2,  3,  1,  6) */
      __m256i perm0 = _mm256_permutevar8x32_epi32(v, _mm256_set_epi32(7, 0, 
                                                  4, 5, 2, 3, 1, 6));
...
minimum_7_uint32_t(uint32_t * const 
                             arr) {
