...
#ifndef _SIMD_SORT_bitonic_5_uint16_t_H_
#define _SIMD_SORT_bitonic_5_uint16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) bitonic_5_uint16_t_vec(__m128i v) {

__m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 11, 10, 7, 6, 9, 8, 5, 4, 1, 0, 3, 2));
__m128i min0 = _mm_min_epu16(v, perm0);
__m128i max0 = _mm_max_epu16(v, perm0);
__m128i v0 = _mm_blend_epi16(max0, min0, 0x9);

__m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 11, 10, 5, 4, 7, 6, 9, 8, 3, 2, 1, 0));
__m128i min1 = _mm_min_epu16(v0, perm1);
__m128i max1 = _mm_max_epu16(v0, perm1);
__m128i v1 = _mm_blend_epi16(max1, min1, 0x4);

__m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 11, 10, 3, 2, 5, 4, 7, 6, 9, 8, 1, 0));
__m128i min2 = _mm_min_epu16(v1, perm2);
__m128i max2 = _mm_max_epu16(v1, perm2);
__m128i v2 = _mm_blend_epi16(max2, min2, 0x6);

__m128i perm3 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v2, 0x1b), 0xe4);
__m128i min3 = _mm_min_epu16(v2, perm3);
__m128i max3 = _mm_max_epu16(v2, perm3);
__m128i v3 = _mm_blend_epi32(max3, min3, 0x1);

__m128i perm4 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v3, 0xb1), 0xe4);
...
void inline __attribute__((always_inline)) bitonic_5_uint16_t(uint16_t * const arr) {

__m128i _tmp0 = _mm_maskload_epi32((int32_t * const)arr, _mm_set_epi32(0x0, 0x0, 0x80000000, 0x80000000));
__m128i _tmp1 = _mm_set1_epi16(uint16_t(0xffff));
...
#define N 5
#define SORT_NAME bitonic_5_uint16_t
