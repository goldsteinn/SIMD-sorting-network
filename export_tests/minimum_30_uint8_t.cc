...
#define TYPE uint8_t
#define N 30
#define SORT_NAME minimum_30_uint8_t

#ifndef _SIMD_SORT_minimum_30_uint8_t_H_
#define _SIMD_SORT_minimum_30_uint8_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_30_uint8_t_vec(__m256i v) {
...
/* Pairs: ([31,31], [30,30], [25,29], [24,28], [27,27], [26,26], [19,23], [18,22], [17,21], [16,20], [11,15], [10,14], [9,13], [8,12], [3,7], [2,6], [1,5], [0,4]) */
/* Perm:  (31, 30, 25, 24, 27, 26, 29, 28, 19, 18, 17, 16, 23, 22, 21, 20, 11, 10,  9,  8, 15, 14, 13, 12,  3,  2,  1,  0,  7,  6,  5,  4) */
__m256i perm2 = _mm256_shuffle_epi8(v1, _mm256_set_epi8(31, 30, 25, 24, 27, 26, 29, 28, 19, 18, 17, 16, 23, 22, 21, 20, 11, 10, 9, 8, 15, 14, 13, 12, 3, 2, 1, 0, 7, 6, 5, 4));
__m256i min2 = _mm256_min_epu8(v1, perm2);
__m256i max2 = _mm256_max_epu8(v1, perm2);
__m256i v2 = _mm256_mask_mov_epi8(max2, 0x30f0f0f, min2);

/* Pairs: ([31,31], [30,30], [21,29], [20,28], [19,27], [18,26], [17,25], [16,24], [23,23], [22,22], [7,15], [6,14], [5,13], [4,12], [3,11], [2,10], [1,9], [0,8]) */
/* Perm:  (31, 30, 21, 20, 19, 18, 17, 16, 23, 22, 29, 28, 27, 26, 25, 24,  7,  6,  5,  4,  3,  2,  1,  0, 15, 14, 13, 12, 11, 10,  9,  8) */
__m256i perm3 = _mm256_shuffle_epi8(v2, _mm256_set_epi8(31, 30, 21, 20, 19, 18, 17, 16, 23, 22, 29, 28, 27, 26, 25, 24, 7, 6, 5, 4, 3, 2, 1, 0, 15, 14, 13, 12, 11, 10, 9, 8));
__m256i min3 = _mm256_min_epu8(v2, perm3);
__m256i max3 = _mm256_max_epu8(v2, perm3);
__m256i v3 = _mm256_mask_mov_epi8(max3, 0x3f00ff, min3);

/* Pairs: ([31,31], [30,30], [27,29], [19,28], [21,26], [22,25], [17,24], [23,23], [18,20], [0,16], [15,15], [7,14], [11,13], [3,12], [5,10], [6,9], [1,8], [2,4]) */
/* Perm:  (31, 30, 27, 19, 29, 21, 22, 17, 23, 25, 26, 18, 28, 20, 24,  0, 15,  7, 11,  3, 13,  5,  6,  1, 14,  9, 10,  2, 12,  4,  8, 16) */
__m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 27, 19, 29, 21, 22, 17, 23, 25, 26, 18, 28, 20, 24, 0, 15, 7, 11, 3, 13, 5, 6, 1, 14, 9, 10, 2, 12, 4, 8, 16), v3);
__m256i min4 = _mm256_min_epu8(v3, perm4);
__m256i max4 = _mm256_max_epu8(v3, perm4);
__m256i v4 = _mm256_mask_mov_epi8(max4, 0x86e08ef, min4);

/* Pairs: ([31,31], [30,30], [29,29], [26,28], [23,27], [9,25], [20,24], [6,22], [19,21], [17,18], [16,16], [15,15], [13,14], [10,12], [7,11], [4,8], [3,5], [1,2], [0,0]) */
/* Perm:  (31, 30, 29, 26, 23, 28,  9, 20, 27,  6, 19, 24, 21, 17, 18, 16, 15, 13, 14, 10,  7, 12, 25,  4, 11, 22,  3,  8,  5,  1,  2,  0) */
__m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 26, 23, 28, 9, 20, 27, 6, 19, 24, 21, 17, 18, 16, 15, 13, 14, 10, 7, 12, 25, 4, 11, 22, 3, 8, 5, 1, 2, 0), v4);
__m256i min5 = _mm256_min_epu8(v4, perm5);
__m256i max5 = _mm256_max_epu8(v4, perm5);
__m256i v5 = _mm256_mask_mov_epi8(max5, 0x49a26da, min5);

/* Pairs: ([31,31], [30,30], [13,29], [12,28], [11,27], [21,26], [25,25], [8,24], [7,23], [22,22], [4,20], [3,19], [2,18], [1,17], [16,16], [15,15], [14,14], [5,10], [9,9], [6,6], [0,0]) */
/* Perm:  (31, 30, 13, 12, 11, 21, 25,  8,  7, 22, 26,  4,  3,  2,  1, 16, 15, 14, 29, 28, 27,  5,  9, 24, 23,  6, 10, 20, 19, 18, 17,  0) */
__m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 13, 12, 11, 21, 25, 8, 7, 22, 26, 4, 3, 2, 1, 16, 15, 14, 29, 28, 27, 5, 9, 24, 23, 6, 10, 20, 19, 18, 17, 0), v5);
...
void inline __attribute__((always_inline)) minimum_30_uint8_t(uint8_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi8(uint8_t(0xff));
__m256i v = _mm256_mask_loadu_epi8(_tmp0, 0x3fffffff, arr);
fill_works(v);
v = minimum_30_uint8_t_vec(v);
