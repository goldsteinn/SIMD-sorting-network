...
minimum_30_uint8_t_vec(__m256i v) {
      ...
      /* Perm:  (31, 30, 25, 24, 27, 26, 29, 28, 19, 18, 17, 16, 23, 22, 21, 
                 ...
                 5,  4) */
      __m256i perm2 = _mm256_shuffle_epi8(v1, _mm256_set_epi8(31, 30, 25, 24, 
      ...
      /* Perm:  (31, 30, 21, 20, 19, 18, 17, 16, 23, 22, 29, 28, 27, 26, 25, 
                 ...
                 9,  8) */
      __m256i perm3 = _mm256_shuffle_epi8(v2, _mm256_set_epi8(31, 30, 21, 20, 
      ...
      /* Pairs: ([31,31], [30,30], [27,29], [19,28], [21,26], [22,25], 
                 [17,24], [23,23], [18,20], [0,16], [15,15], [7,14], [11,13], 
                 [3,12], [5,10], [6,9], [1,8], [2,4]) */
      /* Perm:  (31, 30, 27, 19, 29, 21, 22, 17, 23, 25, 26, 18, 28, 20, 24,  
                 0, 15,  7, 11,  3, 13,  5,  6,  1, 14,  9, 10,  2, 12,  4,  
                 8, 16) */
      __m256i perm4 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 27, 19, 
                                              29, 21, 22, 17, 23, 25, 26, 18, 
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [26,28], [23,27], [9,25], 
                 [20,24], [6,22], [19,21], [17,18], [16,16], [15,15], 
                 [13,14], [10,12], [7,11], [4,8], [3,5], [1,2], [0,0]) */
      /* Perm:  (31, 30, 29, 26, 23, 28,  9, 20, 27,  6, 19, 24, 21, 17, 18, 
                 16, 15, 13, 14, 10,  7, 12, 25,  4, 11, 22,  3,  8,  5,  1,  
                 2,  0) */
      __m256i perm5 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 26, 
      ...
      /* Pairs: ([31,31], [30,30], [13,29], [12,28], [11,27], [21,26], 
                 [25,25], [8,24], [7,23], [22,22], [4,20], [3,19], [2,18], 
                 [1,17], [16,16], [15,15], [14,14], [5,10], [9,9], [6,6], 
                 [0,0]) */
      /* Perm:  (31, 30, 13, 12, 11, 21, 25,  8,  7, 22, 26,  4,  3,  2,  1, 
                 16, 15, 14, 29, 28, 27,  5,  9, 24, 23,  6, 10, 20, 19, 18, 
                 17,  0) */
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 13, 12, 
                                              11, 21, 25, 8, 7, 22, 26, 4, 3, 
                                              2, 1, 16, 15, 14, 29, 28, 27, 
      ...
      /* Perm:  (31, 30, 29, 23, 27, 15, 25, 14, 28, 10,  9, 12, 11, 18,  7,  
                 ...
                 4,  0) */
      __m256i perm8 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 23, 
                                              27, 15, 25, 14, 28, 10, 9, 12, 
...
minimum_30_uint8_t(uint8_t * const arr) 
                             {
