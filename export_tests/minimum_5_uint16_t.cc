...
#define N 5
#define SORT_NAME minimum_5_uint16_t

#ifndef _SIMD_SORT_minimum_5_uint16_t_H_
#define _SIMD_SORT_minimum_5_uint16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_5_uint16_t_vec(__m128i v) {
...
void inline __attribute__((always_inline)) minimum_5_uint16_t(uint16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(uint16_t(0xffff));
__m128i v = _mm_mask_loadu_epi16(_tmp0, 0x1f, arr);
fill_works(v);
v = minimum_5_uint16_t_vec(v);
