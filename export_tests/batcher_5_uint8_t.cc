...
#define TYPE uint8_t
#define N 5
#define SORT_NAME batcher_5_uint8_t

#ifndef _SIMD_SORT_batcher_5_uint8_t_H_
#define _SIMD_SORT_batcher_5_uint8_t_H_
...
batcher_5_uint8_t(uint8_t * const arr) 
                             {
