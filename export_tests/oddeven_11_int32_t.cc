...
#define TYPE int32_t
#define N 11
#define SORT_NAME oddeven_11_int32_t

#ifndef _SIMD_SORT_oddeven_11_int32_t_H_
#define _SIMD_SORT_oddeven_11_int32_t_H_
...
oddeven_11_int32_t_vec(__m512i v) {
...
oddeven_11_int32_t(int32_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = oddeven_11_int32_t_vec(v);
