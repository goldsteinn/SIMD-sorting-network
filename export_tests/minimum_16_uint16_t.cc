...
#define N 16
#define SORT_NAME minimum_16_uint16_t

#ifndef _SIMD_SORT_minimum_16_uint16_t_H_
#define _SIMD_SORT_minimum_16_uint16_t_H_
...
__m256i perm7 = _mm256_shuffle_epi8(v6, _mm256_set_epi8(31, 30, 29, 28, 27, 26, 25, 24, 19, 18, 17, 16, 23, 22, 21, 20, 11, 10, 9, 8, 15, 14, 13, 12, 7, 6, 5, 4, 3, 2, 1, 0));
__m256i min7 = _mm256_min_epu16(v6, perm7);
__m256i max7 = _mm256_max_epu16(v6, perm7);
__m256i v7 = _mm256_blend_epi32(max7, min7, 0x14);
