...
#define TYPE int16_t
#define N 4
#define SORT_NAME bosenelson_4_int16_t

#ifndef _SIMD_SORT_bosenelson_4_int16_t_H_
#define _SIMD_SORT_bosenelson_4_int16_t_H_
...
bosenelson_4_int16_t_vec(__m64 v) {
...
bosenelson_4_int16_t(int16_t * const 
                             arr) {
