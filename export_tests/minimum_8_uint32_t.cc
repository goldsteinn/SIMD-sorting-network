...
#define N 8
#define SORT_NAME minimum_8_uint32_t

#ifndef _SIMD_SORT_minimum_8_uint32_t_H_
#define _SIMD_SORT_minimum_8_uint32_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_8_uint32_t_vec(__m256i v) {
...
__m256i perm3 = _mm256_permute4x64_epi64(v2, 0xd8);
__m256i min3 = _mm256_min_epu32(v2, perm3);
__m256i max3 = _mm256_max_epu32(v2, perm3);
__m256i v3 = _mm256_blend_epi32(max3, min3, 0xc);

/* Pairs: ([7,7], [3,6], [5,5], [1,4], [2,2], [0,0]) */
/* Perm:  ( 7,  3,  5,  1,  6,  2,  4,  0) */
__m256i perm4 = _mm256_permutevar8x32_epi32(v3, _mm256_set_epi32(7, 3, 5, 1, 6, 2, 4, 0));
...
void inline __attribute__((always_inline)) minimum_8_uint32_t(uint32_t * const arr) {

__m256i _tmp0 = _mm256_set1_epi32(uint32_t(0xffffffff));
__m256i v = _mm256_mask_loadu_epi32(_tmp0, 0xff, (int32_t * const)arr);
fill_works(v);
v = minimum_8_uint32_t_vec(v);

fill_works(v);_mm256_mask_storeu_epi32((void *)arr, 0xff, v);
