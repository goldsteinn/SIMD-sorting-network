...
#define TYPE int8_t
#define N 13
#define SORT_NAME oddeven_13_int8_t

#ifndef _SIMD_SORT_oddeven_13_int8_t_H_
#define _SIMD_SORT_oddeven_13_int8_t_H_
...
oddeven_13_int8_t_vec(__m128i v) {
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [10,12], [11,11], [9,9], [0,8], 
                 [7,7], [2,6], [1,5], [4,4], [3,3]) */
      /* Perm:  (15, 14, 13, 10, 11, 12,  9,  0,  7,  2,  1,  4,  3,  6,  5,  
                 8) */
      __m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 10, 11, 
                                       12, 9, 0, 7, 2, 1, 4, 3, 6, 5, 8));
      __m128i min3 = _mm_min_epi8(v2, perm3);
      __m128i max3 = _mm_max_epi8(v2, perm3);
      __m128i v3 = _mm_mask_mov_epi8(max3, 0x407, min3);
      
      /* Pairs: ([15,15], [14,14], [13,13], [11,12], [9,10], [8,8], [7,7], 
                 [6,6], [3,5], [2,4], [1,1], [0,0]) */
      /* Perm:  (15, 14, 13, 11, 12,  9, 10,  8,  7,  6,  3,  2,  5,  4,  1,  
                 0) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [4,12], [3,11], [2,10], [1,9], 
                 [8,8], [7,7], [6,6], [5,5], [0,0]) */
      /* Perm:  (15, 14, 13,  4,  3,  2,  1,  8,  7,  6,  5, 12, 11, 10,  9,  
                 0) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 4, 3, 2, 
                                       1, 8, 7, 6, 5, 12, 11, 10, 9, 0));
      ...
      /* Perm:  (15, 14, 13, 10, 11, 12,  7,  6,  9,  8,  3,  2,  5,  4,  1,  
                 0) */
      __m128i perm8 = _mm_shuffle_epi8(v7, _mm_set_epi8(15, 14, 13, 10, 11, 
                                       12, 7, 6, 9, 8, 3, 2, 5, 4, 1, 0));
      __m128i min8 = _mm_min_epi8(v7, perm8);
      __m128i max8 = _mm_max_epi8(v7, perm8);
      __m128i v8 = _mm_mask_mov_epi8(max8, 0x4cc, min8);
...
oddeven_13_int8_t(int8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_13_int8_t_vec(v);
