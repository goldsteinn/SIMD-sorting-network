...
#define N 26
#define SORT_NAME oddeven_26_uint16_t

#ifndef _SIMD_SORT_oddeven_26_uint16_t_H_
#define _SIMD_SORT_oddeven_26_uint16_t_H_
...
oddeven_26_uint16_t_vec(__m512i v) {
      ...
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0x2b2b2b, min2);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [16,24], [23,23], [18,22], [17,21], [20,20], 
                 [19,19], [7,15], [10,14], [9,13], [12,12], [11,11], [0,8], 
                 [2,6], [1,5], [4,4], [3,3]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 16, 23, 18, 17, 20, 19, 22, 21, 
                 24,  7, 10,  9, 12, 11, 14, 13,  0, 15,  2,  1,  4,  3,  6,  
                 5,  8) */
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 16, 23, 18, 
                                               17, 20, 19, 22, 21, 24, 7, 10, 
                                               9, 12, 11, 14, 13, 0, 15, 2, 
                                               1, 4, 3, 6, 5, 8), v2);
      __m512i min3 = _mm512_min_epu16(v2, perm3);
      __m512i max3 = _mm512_max_epu16(v2, perm3);
      __m512i v3 = _mm512_mask_mov_epi16(max3, 0x70687, min3);
      ...
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [23,25], [24,24], [22,22], [19,21], [20,20], [17,18], 
                 [16,16], [15,15], [14,14], [11,13], [10,12], [7,9], [6,8], 
                 [3,5], [2,4], [1,1], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 23, 24, 25, 22, 19, 20, 21, 17, 18, 
                 16, 15, 14, 11, 10, 13, 12,  7,  6,  9,  8,  3,  2,  5,  4,  
                 1,  0) */
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 23, 24, 25, 22, 
                                               19, 20, 21, 17, 18, 16, 15, 
                                               14, 11, 10, 13, 12, 7, 6, 9, 
                                               8, 3, 2, 5, 4, 1, 0), v7);
      __m512i min8 = _mm512_min_epu16(v7, perm8);
      __m512i max8 = _mm512_max_epu16(v7, perm8);
      __m512i v8 = _mm512_mask_mov_epi16(max8, 0x8a0ccc, min8);
      
      /* Pairs: ([31,31], [30,30], [29,29], [28,28], [27,27], [26,26], 
                 [25,25], [23,24], [21,22], [19,20], [18,18], [17,17], 
                 [16,16], [15,15], [13,14], [11,12], [9,10], [7,8], [5,6], 
                 [3,4], [1,2], [0,0]) */
      /* Perm:  (31, 30, 29, 28, 27, 26, 25, 23, 24, 21, 22, 19, 20, 18, 17, 
      ...
      __m512i v9 = _mm512_mask_mov_epi16(max9, 0xa82aaa, min9);
      ...
      __m512i v14 = _mm512_mask_mov_epi16(max14, 0xaaaaaa, min14);
