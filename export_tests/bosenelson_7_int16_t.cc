...
#define TYPE int16_t
#define N 7
#define SORT_NAME bosenelson_7_int16_t

#ifndef _SIMD_SORT_bosenelson_7_int16_t_H_
#define _SIMD_SORT_bosenelson_7_int16_t_H_
...
bosenelson_7_int16_t_vec(__m128i v) {
      ...
      __m128i min6 = _mm_min_epi16(v5, perm6);
      __m128i max6 = _mm_max_epi16(v5, perm6);
...
bosenelson_7_int16_t(int16_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_7_int16_t_vec(v);
