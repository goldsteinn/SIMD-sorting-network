...
#define TYPE uint8_t
#define N 10
#define SORT_NAME bosenelson_10_uint8_t

#ifndef _SIMD_SORT_bosenelson_10_uint8_t_H_
#define _SIMD_SORT_bosenelson_10_uint8_t_H_
...
bosenelson_10_uint8_t_vec(__m128i v) {
...
bosenelson_10_uint8_t(uint8_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_10_uint8_t_vec(v);
