...
#define N 15
#define SORT_NAME bosenelson_15_uint16_t

#ifndef _SIMD_SORT_bosenelson_15_uint16_t_H_
#define _SIMD_SORT_bosenelson_15_uint16_t_H_
...
bosenelson_15_uint16_t_vec(__m256i v) {
      
      /* Pairs: ([15,15], [13,14], [11,12], [9,10], [7,8], [5,6], [3,4], 
                 [1,2], [0,0]) */
      /* Perm:  (15, 13, 14, 11, 12,  9, 10,  7,  8,  5,  6,  3,  4,  1,  2,  
                 0) */
      __m256i perm0 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 13, 14, 
      ...
      /* Perm:  (15, 12, 11, 14, 13,  8,  7, 10,  9,  4,  3,  6,  5,  0,  1,  
                 2) */
      __m256i perm1 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 12, 11, 
                                               14, 13, 8, 7, 10, 9, 4, 3, 6, 
                                               5, 0, 1, 2), v0);
      ...
      /* Perm:  (15, 10, 12, 13,  7, 14,  8,  9, 11,  2,  4,  5,  3,  6,  0,  
                 1) */
      __m256i perm2 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 10, 12, 
                                               13, 7, 14, 8, 9, 11, 2, 4, 5, 
                                               3, 6, 0, 1), v1);
      __m256i min2 = _mm256_min_epu16(v1, perm2);
      __m256i max2 = _mm256_max_epu16(v1, perm2);
      __m256i v2 = _mm256_mask_mov_epi16(max2, 0x1595, min2);
      
      /* Pairs: ([15,15], [6,14], [9,13], [8,12], [11,11], [10,10], [7,7], 
                 [1,5], [0,4], [3,3], [2,2]) */
      /* Perm:  (15,  6,  9,  8, 11, 10, 13, 12,  7, 14,  1,  0,  3,  2,  5,  
                 4) */
      __m256i perm3 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 6, 9, 8, 
                                               11, 10, 13, 12, 7, 14, 1, 0, 
                                               3, 2, 5, 4), v2);
      __m256i min3 = _mm256_min_epu16(v2, perm3);
      __m256i max3 = _mm256_max_epu16(v2, perm3);
      __m256i v3 = _mm256_mask_mov_epi16(max3, 0x343, min3);
      ...
      __m256i v7 = _mm256_mask_mov_epi16(max7, 0x4e, min7);
      ...
      __m256i perm12 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 14, 13, 
                                                ...
                                                3, 2, 1, 0), v11);
      __m256i min12 = _mm256_min_epu16(v11, perm12);
      __m256i max12 = _mm256_max_epu16(v11, perm12);
      __m256i v12 = _mm256_mask_mov_epi16(max12, 0x50, min12);
      ...
      __m256i perm13 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 14, 13, 
                                                ...
                                                3, 2, 1, 0), v12);
      __m256i min13 = _mm256_min_epu16(v12, perm13);
      __m256i max13 = _mm256_max_epu16(v12, perm13);
      __m256i v13 = _mm256_mask_mov_epi16(max13, 0x60, min13);
      ...
      __m256i perm14 = _mm256_shuffle_epi8(v13, _mm256_set_epi8(31, 30, 29, 
                                           ...
                                           2, 1, 0));
      __m256i min14 = _mm256_min_epu16(v13, perm14);
      __m256i max14 = _mm256_max_epu16(v13, perm14);
      __m256i v14 = _mm256_mask_mov_epi16(max14, 0x40, min14);
...
bosenelson_15_uint16_t(uint16_t * const 
                             arr) {
      
      __m256i _tmp0 = _mm256_set1_epi16(uint16_t(0xffff));
      __m256i v = _mm256_mask_loadu_epi16(_tmp0, 0x7fff, arr);
      fill_works(v);
      v = bosenelson_15_uint16_t_vec(v);
      
      fill_works(v);_mm256_mask_storeu_epi16((void *)arr, 0x7fff, v);
