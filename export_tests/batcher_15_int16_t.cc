...
batcher_15_int16_t_vec(__m256i v) {
      ...
      /* Perm:  (15,  6,  5,  4,  3,  2,  1,  0,  7, 14, 13, 12, 11, 10,  9,  
                 8) */
      __m256i perm0 = _mm256_permutexvar_epi16(_mm256_set_epi16(15, 6, 5, 4, 
                                               3, 2, 1, 0, 7, 14, 13, 12, 11, 
                                               10, 9, 8), v);
      __m256i min0 = _mm256_min_epi16(v, perm0);
      __m256i max0 = _mm256_max_epi16(v, perm0);
      __m256i v0 = _mm256_mask_mov_epi16(max0, 0x7f, min0);
