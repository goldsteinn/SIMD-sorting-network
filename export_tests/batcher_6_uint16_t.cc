...
#define N 6
#define SORT_NAME batcher_6_uint16_t

#ifndef _SIMD_SORT_batcher_6_uint16_t_H_
#define _SIMD_SORT_batcher_6_uint16_t_H_
...
batcher_6_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7, 7], [6, 6], [1, 5], [0, 4], [3, 3], [2, 2], [5, 1], [4, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [5, 5], [4, 4], [1, 3], [0, 2], [3, 1], [2, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [3, 5], [2, 4], [5, 3], [4, 2], [0, 1], [1, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [4, 5], [5, 4], [2, 3], [3, 2], [1, 1], [0, 
                 0]) */
      /* Perm:  ( 7,  6,  4,  5,  2,  3,  1,  0) */
      __m128i perm3 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v2, 0xb4), 
                                          0xe1);
      __m128i min3 = _mm_min_epu16(v2, perm3);
      __m128i max3 = _mm_max_epu16(v2, perm3);
      __m128i v3 = _mm_blend_epi16(max3, min3, 0x14);
      
      /* Pairs: ([7, 7], [6, 6], [5, 5], [1, 4], [3, 3], [2, 2], [4, 1], [0, 
                 0]) */
      /* Perm:  ( 7,  6,  5,  1,  3,  2,  4,  0) */
      __m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       10, 3, 2, 7, 6, 5, 4, 9, 8, 1, 0));
...
batcher_6_uint16_t(uint16_t * const 
                             arr) {
