...
#define TYPE uint8_t
#define N 16
#define SORT_NAME bosenelson_16_uint8_t

#ifndef _SIMD_SORT_bosenelson_16_uint8_t_H_
#define _SIMD_SORT_bosenelson_16_uint8_t_H_
...
bosenelson_16_uint8_t_vec(__m128i v) {
...
bosenelson_16_uint8_t(uint8_t * const 
                             arr) {
