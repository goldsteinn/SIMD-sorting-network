...
#define TYPE uint8_t
#define N 19
#define SORT_NAME batcher_19_uint8_t

#ifndef _SIMD_SORT_batcher_19_uint8_t_H_
#define _SIMD_SORT_batcher_19_uint8_t_H_
...
batcher_19_uint8_t_vec(__m256i v) {
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0x80f, min1);
      ...
      __m256i perm2 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 10, 9, 8, 15, 14, 13, 12, 
                                              7, 18, 17, 16, 11, 2, 1, 0, 3, 
                                              6, 5, 4), v1);
      __m256i min2 = _mm256_min_epu8(v1, perm2);
      __m256i max2 = _mm256_max_epu8(v1, perm2);
      __m256i v2 = _mm256_mask_mov_epi8(max2, 0x787, min2);
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 6, 5, 4, 15, 10, 9, 8, 11, 
                                              14, 13, 12, 7, 18, 17, 16, 1, 
                                              0, 3, 2), v2);
      __m256i min3 = _mm256_min_epu8(v2, perm3);
      __m256i max3 = _mm256_max_epu8(v2, perm3);
      __m256i v3 = _mm256_mask_mov_epi8(max3, 0x773, min3);
      ...
      __m256i v4 = _mm256_mask_mov_epi8(max4, 0x7071, min4);
      ...
      __m256i perm6 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 11, 2, 15, 14, 7, 6, 
                                              17, 10, 3, 8, 13, 12, 5, 4, 9, 
                                              16, 1, 0), v5);
      __m256i min6 = _mm256_min_epu8(v5, perm6);
      __m256i max6 = _mm256_max_epu8(v5, perm6);
      __m256i v6 = _mm256_mask_mov_epi8(max6, 0x8cc, min6);
      ...
      __m256i perm7 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 23, 22, 21, 20, 
                                              19, 18, 15, 10, 17, 14, 11, 12, 
                                              13, 16, 7, 2, 9, 6, 3, 4, 5, 8, 
                                              1, 0), v6);
      __m256i min7 = _mm256_min_epu8(v6, perm7);
      __m256i max7 = _mm256_max_epu8(v6, perm7);
      __m256i v7 = _mm256_mask_mov_epi8(max7, 0x8c8c, min7);
      ...
      __m256i v8 = _mm256_mask_mov_epi8(max8, 0x4444, min8);
