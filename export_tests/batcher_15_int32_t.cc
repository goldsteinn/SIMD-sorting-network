...
#define TYPE int32_t
#define N 15
#define SORT_NAME batcher_15_int32_t

#ifndef _SIMD_SORT_batcher_15_int32_t_H_
#define _SIMD_SORT_batcher_15_int32_t_H_
...
batcher_15_int32_t_vec(__m512i v) {
...
batcher_15_int32_t(int32_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_15_int32_t_vec(v);
