...
#ifndef _SIMD_SORT_bitonic_8_uint16_t_H_
#define _SIMD_SORT_bitonic_8_uint16_t_H_
...
Sorting Network Information:
	...
	Network Depth                    : 6
	SIMD Instructions                : 3 / 29
	SIMD Type                        : __m128i
	SIMD Instruction Set(s) Used     : AVX512vl, AVX512f, SSE2, SSE4.1, AVX2, SSSE3, AVX512bw
...
/* SIMD Sort */
__m128i __attribute__((const)) bitonic_8_uint16_t_vec(__m128i v) {

__m128i perm0 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v, 0xb1), 0xb1);
__m128i min0 = _mm_min_epu16(v, perm0);
__m128i max0 = _mm_max_epu16(v, perm0);
__m128i v0 = _mm_blend_epi16(max0, min0, 0x55);

__m128i perm1 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v0, 0x1b), 0x1b);
...
__m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14));
...
__m128i perm5 = _mm_shufflehi_epi16(_mm_shufflelo_epi16(v4, 0xb1), 0xb1);
...
void inline __attribute__((always_inline)) bitonic_8_uint16_t(uint16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(uint16_t(0xffff));
__m128i v = _mm_mask_load_epi32(_tmp0, 0x1f, (int32_t * const)arr);

v = bitonic_8_uint16_t_vec(v);

_mm_mask_storeu_epi16((void *)arr, 0xff, v);
...
#define N 8
#define SORT_NAME bitonic_8_uint16_t
