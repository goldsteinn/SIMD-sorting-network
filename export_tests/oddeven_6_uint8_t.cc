...
#define TYPE uint8_t
#define N 6
#define SORT_NAME oddeven_6_uint8_t

#ifndef _SIMD_SORT_oddeven_6_uint8_t_H_
#define _SIMD_SORT_oddeven_6_uint8_t_H_
...
oddeven_6_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp6 = (__m64)(0xff000000UL);
...
oddeven_6_uint8_t(uint8_t * const arr) 
                             {
