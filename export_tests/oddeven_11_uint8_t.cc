...
#define TYPE uint8_t
#define N 11
#define SORT_NAME oddeven_11_uint8_t

#ifndef _SIMD_SORT_oddeven_11_uint8_t_H_
#define _SIMD_SORT_oddeven_11_uint8_t_H_
...
oddeven_11_uint8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [8,9], 
                 [6,7], [4,5], [2,3], [0,1]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  8,  9,  6,  7,  4,  5,  2,  3,  0,  
                 1) */
      ...
      __m128i v5 = _mm_mask_mov_epi8(max5, 0x2a, min5);
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [2,10], [1,9], 
                 [4,8], [7,7], [6,6], [5,5], [3,3], [0,0]) */
      /* Perm:  (15, 14, 13, 12, 11,  2,  1,  4,  7,  6,  5,  8,  3, 10,  9,  
                 0) */
      __m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       2, 1, 4, 7, 6, 5, 8, 3, 10, 9, 0));
      ...
      __m128i v9 = _mm_mask_mov_epi8(max9, 0x2a8, min9);
