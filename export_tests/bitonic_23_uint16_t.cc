...
bitonic_23_uint16_t_vec(__m512i v) {
      ...
      __m512i perm0 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               22, 20, 18, 19, 17, 15, 16, 
                                               14, 12, 13, 11, 9, 10, 8, 6, 
                                               7, 5, 3, 4, 2, 0, 1), v);
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          45, 44, 39, 38, 35, 34, 37, 36, 33, 
                                          32, 29, 28, 31, 30, 23, 22, 25, 24, 
                                          27, 26, 21, 20, 17, 16, 19, 18, 11, 
      ...
      __m512i perm2 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               20, 21, 18, 19, 17, 15, 16, 
                                               14, 13, 11, 12, 9, 10, 8, 7, 
                                               5, 6, 1, 2, 3, 4, 0), v1);
      ...
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               19, 20, 21, 22, 17, 16, 11, 
                                               12, 13, 14, 15, 10, 5, 6, 7, 
                                               8, 9, 4, 0, 1, 2, 3), v2);
      ...
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 21, 
                                               22, 18, 17, 20, 19, 14, 13, 
                                               16, 15, 11, 12, 8, 7, 10, 9, 
                                               5, 6, 4, 2, 3, 0, 1), v3);
      ...
      __m512i perm7 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               19, 22, 21, 13, 14, 12, 11, 
                                               17, 18, 16, 15, 8, 9, 10, 4, 
                                               3, 5, 7, 6, 0, 1, 2), v6);
      ...
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 21, 
                                               22, 19, 20, 15, 16, 17, 18, 
                                               12, 11, 14, 13, 10, 7, 8, 9, 
                                               6, 4, 5, 3, 1, 2, 0), v7);
      ...
      __m512i perm12 = _mm512_shuffle_epi8(v11, _mm512_set_epi8(63, 62, 61, 
                                           ...
                                           40, 43, 42, 45, 44, 35, 34, 33, 
                                           32, 39, 38, 37, 36, 23, 22, 17, 
                                           16, 19, 18, 21, 20, 31, 30, 25, 
                                           24, 27, 26, 29, 28, 7, 6, 5, 4, 3, 
...
bitonic_23_uint16_t(uint16_t * const 
                             arr) {
