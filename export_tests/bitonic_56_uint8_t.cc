...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_56_uint8_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_56_uint8_t(uint8_t * const arr) {

__m512i v = _mm512_mask_loadu_epi8(_mm512_set1_epi8(uint8_t(0xff)), 0xffffffffffffff, arr);
