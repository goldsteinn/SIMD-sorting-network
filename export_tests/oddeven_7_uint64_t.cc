...
#define N 7
#define SORT_NAME oddeven_7_uint64_t

#ifndef _SIMD_SORT_oddeven_7_uint64_t_H_
#define _SIMD_SORT_oddeven_7_uint64_t_H_
...
oddeven_7_uint64_t_vec(__m512i v) {
      ...
      __m512i perm2 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 5, 6, 0, 
                                               3, 1, 2, 4), v1);
      __m512i min2 = _mm512_min_epu64(v1, perm2);
      __m512i max2 = _mm512_max_epu64(v1, perm2);
      __m512i v2 = _mm512_mask_mov_epi64(max2, 0x23, min2);
      ...
      __m512i perm4 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 3, 2, 
                                               5, 4, 1, 0), v3);
      __m512i min4 = _mm512_min_epu64(v3, perm4);
      __m512i max4 = _mm512_max_epu64(v3, perm4);
      __m512i v4 = _mm512_mask_mov_epi64(max4, 0xc, min4);
...
oddeven_7_uint64_t(uint64_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = oddeven_7_uint64_t_vec(v);
