...
#define N 13
#define SORT_NAME oddeven_13_uint32_t

#ifndef _SIMD_SORT_oddeven_13_uint32_t_H_
#define _SIMD_SORT_oddeven_13_uint32_t_H_
...
oddeven_13_uint32_t_vec(__m512i v) {
      ...
      __m512i v2 = _mm512_mask_mov_epi32(max2, 0x32b, min2);
      ...
      __m512i v8 = _mm512_mask_mov_epi32(max8, 0x4cc, min8);
...
oddeven_13_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i _tmp0 = _mm512_set1_epi32(uint32_t(0xffffffff));
      __m512i v = _mm512_mask_load_epi32(_tmp0, 0x1fff, arr);
      fill_works(v);
      v = oddeven_13_uint32_t_vec(v);
      
      fill_works(v);_mm512_mask_store_epi32((void *)arr, 0x1fff, v);
