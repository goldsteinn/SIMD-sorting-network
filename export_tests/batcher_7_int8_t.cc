...
#define TYPE int8_t
#define N 7
#define SORT_NAME batcher_7_int8_t

#ifndef _SIMD_SORT_batcher_7_int8_t_H_
#define _SIMD_SORT_batcher_7_int8_t_H_
...
batcher_7_int8_t_vec(__m64 v) {
      
      /* Pairs: ([7,7], [2,6], [0,4], [3,3], [6,2], [4,0]) */
      /* Perm:  ( 7,  2,  0,  3,  6,  4) */
      __m64 perm0 = _mm_shuffle_pi8(v, _mm_set_pi8(7, 2, 1, 0, 3, 6, 5, 4));
