...
#define TYPE int8_t
#define N 6
#define SORT_NAME bosenelson_6_int8_t

#ifndef _SIMD_SORT_bosenelson_6_int8_t_H_
#define _SIMD_SORT_bosenelson_6_int8_t_H_
...
bosenelson_6_int8_t_vec(__m64 v) {
      ...
      /* Pairs: ([7,7], [6,6], [3,5], [4,4], [0,2], [1,1]) */
      /* Perm:  ( 7,  6,  3,  4,  5,  0,  1,  2) */
      __m64 perm1 = _mm_shuffle_pi8(v0, _mm_set_pi8(7, 6, 3, 4, 5, 0, 1, 
                                                    2));
      ...
      __m64 perm2 = _mm_shuffle_pi8(v1, _mm_set_pi8(7, 6, 2, 3, 4, 5, 0, 
                                                    1));
      ...
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 5, 1, 0, 2, 4, 
                                                    3));
      ...
      __m64 perm4 = _mm_shuffle_pi8(v3, _mm_set_pi8(7, 6, 5, 2, 1, 4, 3, 
                                                    0));
      ...
      __m64 perm5 = _mm_shuffle_pi8(v4, _mm_set_pi8(7, 6, 5, 4, 2, 3, 1, 
                                                    0));
...
bosenelson_6_int8_t(int8_t * const arr) 
                             {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = bosenelson_6_int8_t_vec(v);
