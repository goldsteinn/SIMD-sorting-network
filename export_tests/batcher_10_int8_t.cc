...
batcher_10_int8_t_vec(__m128i v) {
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [1,9], 
                 [0,8], [3,7], [2,6], [7,3], [6,2], [9,1], [8,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  1,  0,  3,  2,  7,  6,  9,  8) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [1,5], [0,4], [5,1], [4,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  8,  1,  0,  5,  4) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [5,9], 
                 [4,8], [7,7], [6,6], [9,5], [8,4], [1,3], [0,2], [3,1], 
                 [2,0]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [3,9], 
                 [2,8], [5,7], [4,6], [7,5], [6,4], [9,3], [8,2], [0,1], 
                 [1,0]) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [1,8], [7,7], [3,6], [6,3], [8,1]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  1,  7,  3,  6,  8) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [5,8], [7,7], [8,5], [1,4], [4,1]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  5,  7,  8,  1,  4) */
