...
#define N 26
#define SORT_NAME batcher_26_uint16_t

#ifndef _SIMD_SORT_batcher_26_uint16_t_H_
#define _SIMD_SORT_batcher_26_uint16_t_H_
...
batcher_26_uint16_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi16(max0, 0x3ff, min0);
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x30f0f0, min5);
      ...
      __m512i v6 = _mm512_mask_mov_epi16(max6, 0x333330, min6);
...
batcher_26_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_26_uint16_t_vec(v);
