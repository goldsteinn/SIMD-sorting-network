...
#define N 7
#define SORT_NAME bosenelson_7_uint16_t

#ifndef _SIMD_SORT_bosenelson_7_uint16_t_H_
#define _SIMD_SORT_bosenelson_7_uint16_t_H_
...
bosenelson_7_uint16_t_vec(__m128i v) {
      ...
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 9, 8, 7, 6, 
                                       13, 12, 11, 10, 1, 0, 3, 2, 5, 4));
      ...
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 5, 4, 9, 8, 
                                       11, 10, 7, 6, 13, 12, 1, 0, 3, 2));
      __m128i min2 = _mm_min_epu16(v1, perm2);
      __m128i max2 = _mm_max_epu16(v1, perm2);
      __m128i v2 = _mm_blend_epi16(max2, min2, 0x15);
      
      /* Pairs: ([7,7], [6,6], [1,5], [0,4], [3,3], [2,2]) */
      /* Perm:  ( 7,  6,  1,  0,  3,  2,  5,  4) */
      __m128i perm3 = _mm_shuffle_epi32(v2, uint8_t(0xc6));
      ...
      __m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 12, 5, 4, 
      ...
      __m128i perm5 = _mm_shuffle_epi8(v4, _mm_set_epi8(15, 14, 13, 12, 11, 
                                       10, 5, 4, 3, 2, 9, 8, 7, 6, 1, 0));
      __m128i min5 = _mm_min_epu16(v4, perm5);
      __m128i max5 = _mm_max_epu16(v4, perm5);
      __m128i v5 = _mm_blend_epi16(max5, min5, 0x6);
      
      /* Pairs: ([7,7], [6,6], [5,5], [4,4], [2,3], [1,1], [0,0]) */
      /* Perm:  ( 7,  6,  5,  4,  2,  3,  1,  0) */
      __m128i perm6 = _mm_shufflelo_epi16(v5, 0xb4);
      __m128i min6 = _mm_min_epu16(v5, perm6);
      __m128i max6 = _mm_max_epu16(v5, perm6);
      __m128i v6 = _mm_blend_epi16(max6, min6, 0x4);
...
bosenelson_7_uint16_t(uint16_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_7_uint16_t_vec(v);
