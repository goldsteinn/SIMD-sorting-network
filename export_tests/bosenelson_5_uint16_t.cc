...
#define N 5
#define SORT_NAME bosenelson_5_uint16_t

#ifndef _SIMD_SORT_bosenelson_5_uint16_t_H_
#define _SIMD_SORT_bosenelson_5_uint16_t_H_
...
bosenelson_5_uint16_t_vec(__m128i v) {
...
bosenelson_5_uint16_t(uint16_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_5_uint16_t_vec(v);
