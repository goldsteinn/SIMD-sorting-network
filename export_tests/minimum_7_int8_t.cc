...
#define TYPE int8_t
#define N 7
#define SORT_NAME minimum_7_int8_t

#ifndef _SIMD_SORT_minimum_7_int8_t_H_
#define _SIMD_SORT_minimum_7_int8_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) minimum_7_int8_t_vec(__m64 v) {
...
__m64 _tmp6 = (__m64)(0xff00ffffUL);
...
__m64 _tmp12 = (__m64)(0xff0000ff00UL);
...
__m64 _tmp15 = (__m64)(0xff00ff0000UL);
...
void inline __attribute__((always_inline)) minimum_7_int8_t(int8_t * const arr) {

__m64 _tmp0 = _mm_set1_pi8(int8_t(0x7f));
__builtin_memcpy(&_tmp0, arr, 7);
__m64 v = _tmp0;
fill_works(v);
v = minimum_7_int8_t_vec(v);
