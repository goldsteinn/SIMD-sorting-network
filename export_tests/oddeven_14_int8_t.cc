...
#define TYPE int8_t
#define N 14
#define SORT_NAME oddeven_14_int8_t

#ifndef _SIMD_SORT_oddeven_14_int8_t_H_
#define _SIMD_SORT_oddeven_14_int8_t_H_
...
oddeven_14_int8_t_vec(__m128i v) {
...
oddeven_14_int8_t(int8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = oddeven_14_int8_t_vec(v);
