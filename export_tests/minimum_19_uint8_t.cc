...
minimum_19_uint8_t_vec(__m256i v) {
      ...
      __m256i perm0 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              ...
                                              19, 6, 5, 4, 3, 2, 1, 0, 9, 8, 
                                              11, 10, 7, 18, 17, 16, 15, 14, 
                                              13, 12), v);
...
minimum_19_uint8_t(uint8_t * const arr) 
                             {
