...
#define TYPE uint8_t
#define N 44
#define SORT_NAME batcher_44_uint8_t

#ifndef _SIMD_SORT_batcher_44_uint8_t_H_
#define _SIMD_SORT_batcher_44_uint8_t_H_
...
batcher_44_uint8_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi8(max1, 0xfff, min1);
      ...
      __m512i v2 = _mm512_mask_mov_epi8(max2, 0xfff00ff, min2);
      ...
      __m512i v3 = _mm512_mask_mov_epi8(max3, 0xf00fff00f, min3);
      ...
      __m512i v4 = _mm512_mask_mov_epi8(max4, 0xf000ff03, min4);
      ...
      __m512i v5 = _mm512_mask_mov_epi8(max5, 0xf000f01, min5);
      ...
      __m512i v11 = _mm512_mask_mov_epi8(max11, 0x4000000cccc, min11);
...
batcher_44_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_44_uint8_t_vec(v);
