...
#define TYPE int64_t
#define N 4
#define SORT_NAME minimum_4_int64_t

#ifndef _SIMD_SORT_minimum_4_int64_t_H_
#define _SIMD_SORT_minimum_4_int64_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_4_int64_t_vec(__m256i v) {
...
void inline __attribute__((always_inline)) minimum_4_int64_t(int64_t * const arr) {
