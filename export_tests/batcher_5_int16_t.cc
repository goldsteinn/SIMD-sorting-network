...
#define TYPE int16_t
#define N 5
#define SORT_NAME batcher_5_int16_t

#ifndef _SIMD_SORT_batcher_5_int16_t_H_
#define _SIMD_SORT_batcher_5_int16_t_H_
...
batcher_5_int16_t_vec(__m128i v) {
...
batcher_5_int16_t(int16_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = batcher_5_int16_t_vec(v);
