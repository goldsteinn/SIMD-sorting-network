...
bitonic_28_uint16_t_vec(__m512i v) {
      ...
      __m512i perm1 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 24, 25, 26, 27, 23, 21, 
                                               22, 17, 18, 19, 20, 14, 15, 
...
bitonic_28_uint16_t(uint16_t * const 
                                 arr) {
