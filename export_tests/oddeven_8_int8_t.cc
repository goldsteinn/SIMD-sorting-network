...
#define TYPE int8_t
#define N 8
#define SORT_NAME oddeven_8_int8_t

#ifndef _SIMD_SORT_oddeven_8_int8_t_H_
#define _SIMD_SORT_oddeven_8_int8_t_H_
...
oddeven_8_int8_t(int8_t * const arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = oddeven_8_int8_t_vec(v);
