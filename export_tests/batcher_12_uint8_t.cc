...
#define TYPE uint8_t
#define N 12
#define SORT_NAME batcher_12_uint8_t

#ifndef _SIMD_SORT_batcher_12_uint8_t_H_
#define _SIMD_SORT_batcher_12_uint8_t_H_
...
batcher_12_uint8_t_vec(__m128i v) {
...
batcher_12_uint8_t(uint8_t * const arr) 
                             {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = batcher_12_uint8_t_vec(v);
