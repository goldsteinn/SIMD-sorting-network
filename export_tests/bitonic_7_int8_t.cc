...
bitonic_7_int8_t_vec(__m64 v) {
      ...
      /* Pairs: ([7,7], [3,6], [4,5], [5,4], [6,3], [2,2], [0,1], [1,0]) */
      /* Perm:  ( 7,  3,  4,  5,  6,  2,  0,  1) */
      __m64 perm1 = _mm_shuffle_pi8(v0, _mm_set_pi8(7, 3, 4, 5, 6, 2, 0, 
                                                    1));
      ...
      /* Pairs: ([7,7], [5,6], [6,5], [3,4], [4,3]) */
      /* Perm:  ( 7,  5,  6,  3,  4) */
      __m64 perm2 = _mm_shuffle_pi8(v1, _mm_set_pi8(7, 5, 6, 3, 4, 1, 2, 
                                                    0));
      ...
      /* Pairs: ([7,7], [0,6], [1,5], [2,4], [3,3], [4,2], [5,1], [6,0]) */
      /* Perm:  ( 7,  0,  1,  2,  3,  4,  5,  6) */
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 0, 1, 2, 3, 4, 5, 
                                                    6));
      ...
      /* Pairs: ([7,7], [4,6], [5,5], [6,4], [0,2], [2,0]) */
      /* Perm:  ( 7,  4,  5,  6,  0,  2) */
      __m64 perm4 = _mm_shuffle_pi8(v3, _mm_set_pi8(7, 4, 5, 6, 1, 0, 3, 
                                                    2));
      ...
      /* Pairs: ([7,7], [6,6], [4,5], [5,4], [0,1], [1,0]) */
      /* Perm:  ( 7,  6,  4,  5,  0,  1) */
      __m64 perm5 = _mm_shuffle_pi8(v4, _mm_set_pi8(7, 6, 4, 5, 2, 3, 0, 
                                                    1));
...
bitonic_7_int8_t(int8_t * const arr) {
