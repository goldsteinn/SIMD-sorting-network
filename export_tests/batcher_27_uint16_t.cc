...
#define N 27
#define SORT_NAME batcher_27_uint16_t

#ifndef _SIMD_SORT_batcher_27_uint16_t_H_
#define _SIMD_SORT_batcher_27_uint16_t_H_
...
batcher_27_uint16_t_vec(__m512i v) {
      ...
      __m512i v5 = _mm512_mask_mov_epi16(max5, 0x70f0f0, min5);
...
batcher_27_uint16_t(uint16_t * const 
                                 arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_27_uint16_t_vec(v);
