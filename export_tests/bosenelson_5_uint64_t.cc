...
#define N 5
#define SORT_NAME bosenelson_5_uint64_t

#ifndef _SIMD_SORT_bosenelson_5_uint64_t_H_
#define _SIMD_SORT_bosenelson_5_uint64_t_H_
...
bosenelson_5_uint64_t_vec(__m512i v) {
      ...
      __m512i v3 = _mm512_mask_mov_epi64(max3, 0x1, min3);
      
      /* Pairs: ([7,7], [6,6], [5,5], [4,4], [1,3], [0,2]) */
      /* Perm:  ( 7,  6,  5,  4,  1,  0,  3,  2) */
      __m512i perm4 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 4, 
                                               1, 0, 3, 2), v3);
      __m512i min4 = _mm512_min_epu64(v3, perm4);
      __m512i max4 = _mm512_max_epu64(v3, perm4);
      __m512i v4 = _mm512_mask_mov_epi64(max4, 0x3, min4);
      
      /* Pairs: ([7,7], [6,6], [5,5], [4,4], [3,3], [1,2], [0,0]) */
      /* Perm:  ( 7,  6,  5,  4,  3,  1,  2,  0) */
      __m512i perm5 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 4, 
                                               3, 1, 2, 0), v4);
      __m512i min5 = _mm512_min_epu64(v4, perm5);
      __m512i max5 = _mm512_max_epu64(v4, perm5);
      __m512i v5 = _mm512_mask_mov_epi64(max5, 0x2, min5);
