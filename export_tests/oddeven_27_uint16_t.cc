...
#define N 27
#define SORT_NAME oddeven_27_uint16_t

#ifndef _SIMD_SORT_oddeven_27_uint16_t_H_
#define _SIMD_SORT_oddeven_27_uint16_t_H_
...
oddeven_27_uint16_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi16(max0, 0x1555555, min0);
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          59, 58, 57, 56, 55, 54, 49, 48, 51, 
                                          50, 53, 52, 43, 42, 41, 40, 47, 46, 
      ...
      __m512i v4 = _mm512_mask_mov_epi16(max4, 0xc0c0d, min4);
      ...
      __m512i v13 = _mm512_mask_mov_epi16(max13, 0xcccccc, min13);
      ...
      __m512i v14 = _mm512_mask_mov_epi16(max14, 0x2aaaaaa, min14);
...
oddeven_27_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i _tmp0 = _mm512_set1_epi16(uint16_t(0xffff));
      __m512i v = _mm512_mask_loadu_epi16(_tmp0, 0x7ffffff, arr);
      fill_works(v);
      v = oddeven_27_uint16_t_vec(v);
      
      fill_works(v);_mm512_mask_storeu_epi16((void *)arr, 0x7ffffff, v);
