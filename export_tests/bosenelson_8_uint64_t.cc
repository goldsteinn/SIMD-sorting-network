...
#define N 8
#define SORT_NAME bosenelson_8_uint64_t

#ifndef _SIMD_SORT_bosenelson_8_uint64_t_H_
#define _SIMD_SORT_bosenelson_8_uint64_t_H_
...
bosenelson_8_uint64_t_vec(__m512i v) {
      ...
      __m512i perm6 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 3, 
                                               4, 2, 1, 0), v5);
      __m512i min6 = _mm512_min_epu64(v5, perm6);
      __m512i max6 = _mm512_max_epu64(v5, perm6);
...
bosenelson_8_uint64_t(uint64_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bosenelson_8_uint64_t_vec(v);
