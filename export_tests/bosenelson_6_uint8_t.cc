...
#define TYPE uint8_t
#define N 6
#define SORT_NAME bosenelson_6_uint8_t

#ifndef _SIMD_SORT_bosenelson_6_uint8_t_H_
#define _SIMD_SORT_bosenelson_6_uint8_t_H_
...
bosenelson_6_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp2 = (__m64)(0xffff00ffUL);
...
bosenelson_6_uint8_t(uint8_t * const 
                             arr) {
      
      __m64 v = (*((_aliasing_m64_ *)arr));
      
      v = bosenelson_6_uint8_t_vec(v);
