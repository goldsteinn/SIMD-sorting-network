...
batcher_9_uint16_t_vec(__m256i v) {
      ...
      __m256i v1 = _mm256_mask_mov_epi16(max1, 0x23, min1);
      ...
      __m256i v2 = _mm256_mask_mov_epi16(max2, 0x19, min2);
      ...
      __m256i v3 = _mm256_mask_mov_epi16(max3, 0x15, min3);
      ...
      __m256i v4 = _mm256_mask_mov_epi16(max4, 0x44, min4);
      ...
      __m256i v5 = _mm256_mask_mov_epi16(max5, 0x56, min5);
