...
#ifndef _SIMD_SORT_bitonic_5_int64_t_H_
#define _SIMD_SORT_bitonic_5_int64_t_H_
...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_5_int64_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_5_int64_t(int64_t * const arr) {

__m512i v = _mm512_mask_loadu_epi64(_mm512_set1_epi64(int64_t(0x7fffffffffffffff)), 0x1f, arr);
v = bitonic_5_int64_t_vec(v);
...
#define TYPE int64_t
#define N 5
#define SORT_NAME bitonic_5_int64_t
