...
#define TYPE int8_t
#define N 15
#define SORT_NAME batcher_15_int8_t

#ifndef _SIMD_SORT_batcher_15_int8_t_H_
#define _SIMD_SORT_batcher_15_int8_t_H_
...
batcher_15_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [6,14], [5,13], [4,12], [0,8], [7,7], [14,6], 
                 [13,5], [12,4], [8,0]) */
      /* Perm:  (15,  6,  5,  4,  0,  7, 14, 13, 12,  8) */
      __m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 6, 5, 4, 3, 2, 1, 
      ...
      __m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 10, 9, 8, 11, 14, 
      ...
      /* Pairs: ([15,15], [12,14], [13,13], [14,12], [7,11], [6,10], [11,7], 
                 [10,6], [0,2], [2,0]) */
      /* Perm:  (15, 12, 13, 14,  7,  6, 11, 10,  0,  2) */
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 12, 13, 14, 7, 6, 
...
batcher_15_int8_t(int8_t * const arr) 
                             {
