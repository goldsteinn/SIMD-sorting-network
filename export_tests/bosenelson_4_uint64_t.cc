...
#define N 4
#define SORT_NAME bosenelson_4_uint64_t

#ifndef _SIMD_SORT_bosenelson_4_uint64_t_H_
#define _SIMD_SORT_bosenelson_4_uint64_t_H_
...
bosenelson_4_uint64_t_vec(__m256i v) {
...
bosenelson_4_uint64_t(uint64_t * const 
                             arr) {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = bosenelson_4_uint64_t_vec(v);
