...
#define TYPE int16_t
#define N 7
#define SORT_NAME minimum_7_int16_t

#ifndef _SIMD_SORT_minimum_7_int16_t_H_
#define _SIMD_SORT_minimum_7_int16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_7_int16_t_vec(__m128i v) {
...
void inline __attribute__((always_inline)) minimum_7_int16_t(int16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(int16_t(0x7fff));
__m128i v = _mm_mask_loadu_epi16(_tmp0, 0x7f, arr);
fill_works(v);
v = minimum_7_int16_t_vec(v);
