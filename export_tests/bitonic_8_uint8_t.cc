...
#define TYPE uint8_t
#define N 8
#define SORT_NAME bitonic_8_uint8_t

#ifndef _SIMD_SORT_bitonic_8_uint8_t_H_
#define _SIMD_SORT_bitonic_8_uint8_t_H_
...
bitonic_8_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp6 = (__m64)(0xff00ff00ff00ffUL);
...
bitonic_8_uint8_t(uint8_t * const arr) 
                             {
