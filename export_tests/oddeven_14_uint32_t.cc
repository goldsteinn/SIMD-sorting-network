...
#define N 14
#define SORT_NAME oddeven_14_uint32_t

#ifndef _SIMD_SORT_oddeven_14_uint32_t_H_
#define _SIMD_SORT_oddeven_14_uint32_t_H_
...
oddeven_14_uint32_t_vec(__m512i v) {
      ...
      /* Perm:  (15, 14,  9, 10, 11, 12, 13,  0,  7,  2,  1,  4,  3,  6,  5,  
                 8) */
      __m512i perm3 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 14, 9, 
      ...
      /* Perm:  (15, 14, 11, 12, 13,  9, 10,  8,  7,  6,  3,  2,  5,  4,  1,  
                 0) */
      __m512i perm4 = _mm512_permutexvar_epi32(_mm512_set_epi32(15, 14, 11, 
                                               12, 13, 9, 10, 8, 7, 6, 3, 2, 
                                               5, 4, 1, 0), v3);
...
oddeven_14_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i _tmp0 = _mm512_set1_epi32(uint32_t(0xffffffff));
      __m512i v = _mm512_mask_load_epi32(_tmp0, 0x3fff, arr);
      fill_works(v);
      v = oddeven_14_uint32_t_vec(v);
      
      fill_works(v);_mm512_mask_store_epi32((void *)arr, 0x3fff, v);
