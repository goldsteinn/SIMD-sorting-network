...
#define TYPE uint8_t
#define N 13
#define SORT_NAME batcher_13_uint8_t

#ifndef _SIMD_SORT_batcher_13_uint8_t_H_
#define _SIMD_SORT_batcher_13_uint8_t_H_
...
batcher_13_uint8_t_vec(__m128i v) {
      ...
      __m128i v0 = _mm_mask_mov_epi8(max0, 0x1f, min0);
      ...
      __m128i v1 = _mm_mask_mov_epi8(max1, 0x10f, min1);
      ...
      __m128i v4 = _mm_mask_mov_epi8(max4, 0x4c, min4);
      ...
      __m128i v5 = _mm_mask_mov_epi8(max5, 0x4cc, min5);
      ...
      __m128i v6 = _mm_mask_mov_epi8(max6, 0x554, min6);
