...
#define TYPE uint8_t
#define N 11
#define SORT_NAME minimum_11_uint8_t

#ifndef _SIMD_SORT_minimum_11_uint8_t_H_
#define _SIMD_SORT_minimum_11_uint8_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_11_uint8_t_vec(__m128i v) {

/* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [0,9], [5,8], [3,7], [1,6], [2,4]) */
/* Perm:  (15, 14, 13, 12, 11, 10,  0,  5,  3,  1,  8,  2,  7,  4,  6,  9) */
__m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 11, 10, 0, 5, 3, 1, 8, 2, 7, 4, 6, 9));
...
__m128i perm1 = _mm_shuffle_epi8(v0, _mm_set_epi8(15, 14, 13, 12, 11, 4, 6, 7, 8, 9, 3, 10, 5, 2, 0, 1));
...
__m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 11, 8, 9, 10, 4, 6, 2, 7, 1, 5, 3, 0));
...
__m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 11, 10, 5, 6, 3, 8, 9, 0, 7, 1, 2, 4));
...
__m128i perm4 = _mm_shuffle_epi8(v3, _mm_set_epi8(15, 14, 13, 12, 11, 9, 10, 7, 8, 2, 4, 5, 3, 6, 0, 1));
...
__m128i perm5 = _mm_shuffle_epi8(v4, _mm_set_epi8(15, 14, 13, 12, 11, 10, 8, 9, 5, 3, 7, 2, 6, 4, 1, 0));
...
__m128i perm6 = _mm_shuffle_epi8(v5, _mm_set_epi8(15, 14, 13, 12, 11, 10, 9, 7, 8, 5, 6, 3, 4, 1, 2, 0));
...
__m128i perm7 = _mm_shuffle_epi8(v6, _mm_set_epi8(15, 14, 13, 12, 11, 10, 9, 8, 6, 7, 4, 5, 2, 3, 1, 0));
...
void inline __attribute__((always_inline)) minimum_11_uint8_t(uint8_t * const arr) {

__m128i _tmp0 = _mm_set1_epi8(uint8_t(0xff));
__m128i v = _mm_mask_loadu_epi8(_tmp0, 0x7ff, arr);
fill_works(v);
v = minimum_11_uint8_t_vec(v);
