...
#define TYPE uint8_t
#define N 42
#define SORT_NAME batcher_42_uint8_t

#ifndef _SIMD_SORT_batcher_42_uint8_t_H_
#define _SIMD_SORT_batcher_42_uint8_t_H_
...
batcher_42_uint8_t_vec(__m512i v) {
      ...
      __m512i v9 = _mm512_mask_mov_epi8(max9, 0x3030303030, min9);
      ...
      __m512i v10 = _mm512_mask_mov_epi8(max10, 0x3333333330, min10);
...
batcher_42_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_42_uint8_t_vec(v);
