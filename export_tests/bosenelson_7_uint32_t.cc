...
#define N 7
#define SORT_NAME bosenelson_7_uint32_t

#ifndef _SIMD_SORT_bosenelson_7_uint32_t_H_
#define _SIMD_SORT_bosenelson_7_uint32_t_H_
...
bosenelson_7_uint32_t_vec(__m256i v) {
      ...
      __m256i perm1 = _mm256_permutevar8x32_epi32(v0, _mm256_set_epi32(7, 4, 
                                                  3, 6, 5, 0, 1, 2));
      ...
      __m256i perm2 = _mm256_permutevar8x32_epi32(v1, _mm256_set_epi32(7, 2, 
                                                  4, 5, 3, 6, 0, 1));
      __m256i min2 = _mm256_min_epu32(v1, perm2);
      __m256i max2 = _mm256_max_epu32(v1, perm2);
      __m256i v2 = _mm256_blend_epi32(max2, min2, 0x15);
      
      /* Pairs: ([7,7], [6,6], [1,5], [0,4], [3,3], [2,2]) */
      /* Perm:  ( 7,  6,  1,  0,  3,  2,  5,  4) */
      __m256i perm3 = _mm256_permute4x64_epi64(v2, 0xc6);
      ...
      __m256i v5 = _mm256_blend_epi32(max5, min5, 0x6);
      ...
      __m256i v6 = _mm256_blend_epi32(max6, min6, 0x4);
...
bosenelson_7_uint32_t(uint32_t * const 
                             arr) {
