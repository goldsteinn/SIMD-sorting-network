...
#define TYPE int8_t
#define N 6
#define SORT_NAME oddeven_6_int8_t

#ifndef _SIMD_SORT_oddeven_6_int8_t_H_
#define _SIMD_SORT_oddeven_6_int8_t_H_
...
oddeven_6_int8_t_vec(__m64 v) {
      
      /* Pairs: ([7,7], [6,6], [4,5], [2,3], [0,1]) */
      /* Perm:  ( 7,  6,  4,  5,  2,  3,  0,  1) */
      __m64 perm0 = _mm_shuffle_pi8(v, _mm_set_pi8(7, 6, 4, 5, 2, 3, 0, 1));
      ...
      __m64 perm4 = _mm_shuffle_pi8(v3, _mm_set_pi8(7, 6, 3, 4, 5, 1, 2, 
                                                    0));
      ...
      __m64 perm5 = _mm_shuffle_pi8(v4, _mm_set_pi8(7, 6, 5, 3, 4, 2, 1, 
                                                    0));
      ...
      __m64 _tmp18 = (__m64)(0xff000000UL);
