...
#define TYPE int16_t
#define N 30
#define SORT_NAME minimum_30_int16_t

#ifndef _SIMD_SORT_minimum_30_int16_t_H_
#define _SIMD_SORT_minimum_30_int16_t_H_
...
minimum_30_int16_t_vec(__m512i v) {
...
minimum_30_int16_t(int16_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_30_int16_t_vec(v);
