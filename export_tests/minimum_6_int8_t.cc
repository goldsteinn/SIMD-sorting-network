...
/* SIMD Sort */
__m64 __attribute__((const)) minimum_6_int8_t_vec(__m64 v) {
...
__m64 _tmp12 = (__m64)(0xff00ff00ffUL);
...
void inline __attribute__((always_inline)) minimum_6_int8_t(int8_t * const arr) {
