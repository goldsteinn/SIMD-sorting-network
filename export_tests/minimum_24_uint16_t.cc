...
#define N 24
#define SORT_NAME minimum_24_uint16_t

#ifndef _SIMD_SORT_minimum_24_uint16_t_H_
#define _SIMD_SORT_minimum_24_uint16_t_H_
...
minimum_24_uint16_t_vec(__m512i v) {
...
minimum_24_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_24_uint16_t_vec(v);
