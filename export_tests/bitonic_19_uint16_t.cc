...
#define N 19
#define SORT_NAME bitonic_19_uint16_t

#ifndef _SIMD_SORT_bitonic_19_uint16_t_H_
#define _SIMD_SORT_bitonic_19_uint16_t_H_
...
bitonic_19_uint16_t_vec(__m512i v) {
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          36, 31, 30, 29, 28, 27, 26, 23, 22, 
                                          25, 24, 21, 20, 19, 18, 17, 16, 13, 
                                          12, 15, 14, 11, 10, 9, 8, 1, 0, 3, 
                                          2, 5, 4, 7, 6));
      ...
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 19, 12, 13, 10, 11, 
                                               14, 17, 18, 15, 16, 9, 4, 1, 
                                               2, 3, 8, 5, 6, 7, 0), v4);
      ...
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 19, 6, 7, 15, 16, 13, 
                                               14, 11, 12, 9, 10, 8, 17, 18, 
                                               5, 4, 3, 2, 1, 0), v7);
      ...
      __m512i perm9 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 20, 19, 18, 17, 8, 1, 2, 
                                               3, 4, 5, 6, 7, 16, 9, 10, 11, 
                                               12, 13, 14, 15, 0), v8);
      ...
      __m512i perm11 = _mm512_shuffle_epi8(v10, _mm512_set_epi8(63, 62, 61, 
                                           ...
                                           36, 33, 32, 35, 34, 27, 26, 29, 
                                           28, 31, 30, 17, 16, 19, 18, 21, 
                                           20, 23, 22, 25, 24, 11, 10, 13, 
