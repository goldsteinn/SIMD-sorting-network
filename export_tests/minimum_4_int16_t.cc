...
#define TYPE int16_t
#define N 4
#define SORT_NAME minimum_4_int16_t

#ifndef _SIMD_SORT_minimum_4_int16_t_H_
#define _SIMD_SORT_minimum_4_int16_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) minimum_4_int16_t_vec(__m64 v) {
...
void inline __attribute__((always_inline)) minimum_4_int16_t(int16_t * const arr) {

__m64 _tmp0 = _mm_set1_pi16(int16_t(0x7fff));
__builtin_memcpy(&_tmp0, arr, 8);
__m64 v = _tmp0;
fill_works(v);
v = minimum_4_int16_t_vec(v);
