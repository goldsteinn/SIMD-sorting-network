...
#define TYPE uint8_t
#define N 13
#define SORT_NAME bosenelson_13_uint8_t

#ifndef _SIMD_SORT_bosenelson_13_uint8_t_H_
#define _SIMD_SORT_bosenelson_13_uint8_t_H_
...
bosenelson_13_uint8_t_vec(__m128i v) {
...
bosenelson_13_uint8_t(uint8_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_13_uint8_t_vec(v);
