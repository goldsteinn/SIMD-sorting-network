...
bitonic_9_int8_t_vec(__m128i v) {
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [7,8], [8,7], [4,5], [5,4], [2,3], [3,2], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  7,  8,  4,  5,  2,  3,  0,  1) 
                 */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [6,8], [7,7], [8,6], [0,3], [1,2], [2,1], [3,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  6,  7,  8,  0,  1,  2,  3) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [5,8], [6,7], [7,6], [8,5], [2,3], [3,2], [0,1], [1,0]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  5,  6,  7,  8,  2,  3,  0,  1) 
                 */
      ...
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  3,  4,  5,  6,  7,  8) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [6,7], [7,6], [4,5], [5,4]) */
      /* Perm:  (15, 14, 13, 12, 11, 10,  9,  8,  6,  7,  4,  5) */
      ...
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [11,11], [10,10], [9,9], 
                 [8,8], [0,7], [1,6], [2,5], [3,4], [4,3], [5,2], [6,1], 
                 [7,0]) */
...
bitonic_9_int8_t(int8_t * const arr) {
