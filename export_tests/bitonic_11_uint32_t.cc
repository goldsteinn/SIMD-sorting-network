...
#define N 11
#define SORT_NAME bitonic_11_uint32_t

#ifndef _SIMD_SORT_bitonic_11_uint32_t_H_
#define _SIMD_SORT_bitonic_11_uint32_t_H_
...
bitonic_11_uint32_t_vec(__m512i v) {
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          40, 31, 30, 29, 28, 23, 22, 21, 20, 
                                          27, 26, 25, 24, 19, 18, 17, 16, 11, 
      ...
      __m512i perm8 = _mm512_shuffle_epi8(v7, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          36, 31, 30, 29, 28, 19, 18, 17, 16, 
                                          23, 22, 21, 20, 27, 26, 25, 24, 15, 
...
bitonic_11_uint32_t(uint32_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_11_uint32_t_vec(v);
