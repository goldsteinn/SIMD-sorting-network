...
#define N 6
#define SORT_NAME bitonic_6_uint16_t

#ifndef _SIMD_SORT_bitonic_6_uint16_t_H_
#define _SIMD_SORT_bitonic_6_uint16_t_H_
...
bitonic_6_uint16_t_vec(__m128i v) {
      
      /* Pairs: ([7, 7], [6, 6], [4, 5], [5, 4], [3, 3], [1, 2], [2, 1], [0, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [1, 5], [2, 4], [3, 3], [4, 2], [5, 1], [0, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [4, 5], [5, 4], [1, 3], [0, 2], [3, 1], [2, 
                 0]) */
      ...
      /* Pairs: ([7, 7], [6, 6], [5, 5], [4, 4], [2, 3], [3, 2], [0, 1], [1, 
                 0]) */
      /* Perm:  ( 7,  6,  5,  4,  2,  3,  0,  1) */
      __m128i perm5 = _mm_shufflelo_epi16(v4, 0xb1);
...
bitonic_6_uint16_t(uint16_t * const 
                             arr) {
