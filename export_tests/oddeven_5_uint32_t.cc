...
#define N 5
#define SORT_NAME oddeven_5_uint32_t

#ifndef _SIMD_SORT_oddeven_5_uint32_t_H_
#define _SIMD_SORT_oddeven_5_uint32_t_H_
...
oddeven_5_uint32_t_vec(__m256i v) {
      ...
      __m256i v0 = _mm256_blend_epi32(max0, min0, 0x5);
      ...
      __m256i v2 = _mm256_blend_epi32(max2, min2, 0x3);
      ...
      __m256i v3 = _mm256_blend_epi32(max3, min3, 0x4);
...
oddeven_5_uint32_t(uint32_t * const 
                             arr) {
