...
#define TYPE uint8_t
#define N 9
#define SORT_NAME bosenelson_9_uint8_t

#ifndef _SIMD_SORT_bosenelson_9_uint8_t_H_
#define _SIMD_SORT_bosenelson_9_uint8_t_H_
...
bosenelson_9_uint8_t_vec(__m128i v) {
      ...
      __m128i v10 = _mm_mask_mov_epi8(max10, 0x8, min10);
