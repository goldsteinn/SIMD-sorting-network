...
#define TYPE uint8_t
#define N 6
#define SORT_NAME minimum_6_uint8_t

#ifndef _SIMD_SORT_minimum_6_uint8_t_H_
#define _SIMD_SORT_minimum_6_uint8_t_H_
...
__m64 perm2 = _mm_shuffle_pi8(v1, _mm_set_pi8(7, 6, 2, 4, 0, 5, 1, 3));
...
__m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 4, 5, 2, 3, 0, 1));
__m64 min3 = _mm_min_pu8(v2, perm3);
__m64 max3 = _mm_max_pu8(v2, perm3);
__m64 _tmp4 = (__m64)(0xff00ff00ffUL);
...
void inline __attribute__((always_inline)) minimum_6_uint8_t(uint8_t * const arr) {

__m64 _tmp0 = _mm_set1_pi8(uint8_t(0xff));
__builtin_memcpy(&_tmp0, arr, 6);
__m64 v = _tmp0;
fill_works(v);
v = minimum_6_uint8_t_vec(v);
