...
minimum_6_uint8_t_vec(__m64 v) {
      ...
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 4, 5, 2, 3, 0, 
                                                    1));
      ...
      /* Pairs: ([7,7], [6,6], [5,5], [3,4], [1,2], [0,0]) */
      /* Perm:  ( 7,  6,  5,  3,  4,  1,  2,  0) */
      __m64 perm4 = _mm_shuffle_pi8(v3, _mm_set_pi8(7, 6, 5, 3, 4, 1, 2, 
                                                    0));
...
minimum_6_uint8_t(uint8_t * const arr) 
                             {
