...
#define N 16
#define SORT_NAME bosenelson_16_uint16_t

#ifndef _SIMD_SORT_bosenelson_16_uint16_t_H_
#define _SIMD_SORT_bosenelson_16_uint16_t_H_
...
bosenelson_16_uint16_t_vec(__m256i v) {
...
bosenelson_16_uint16_t(uint16_t * const 
                             arr) {
      
      __m256i v = _mm256_load_si256((__m256i *)arr);
      
      v = bosenelson_16_uint16_t_vec(v);
