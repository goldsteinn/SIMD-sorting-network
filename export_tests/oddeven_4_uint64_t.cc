...
#define N 4
#define SORT_NAME oddeven_4_uint64_t

#ifndef _SIMD_SORT_oddeven_4_uint64_t_H_
#define _SIMD_SORT_oddeven_4_uint64_t_H_
...
oddeven_4_uint64_t_vec(__m256i v) {
...
oddeven_4_uint64_t(uint64_t * const 
                             arr) {
