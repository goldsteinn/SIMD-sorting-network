...
#define N 4
#define SORT_NAME minimum_4_uint32_t

#ifndef _SIMD_SORT_minimum_4_uint32_t_H_
#define _SIMD_SORT_minimum_4_uint32_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_4_uint32_t_vec(__m128i v) {
