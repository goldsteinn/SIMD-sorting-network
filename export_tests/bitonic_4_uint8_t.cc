...
#ifndef _SIMD_SORT_bitonic_4_uint8_t_H_
#define _SIMD_SORT_bitonic_4_uint8_t_H_
...
/* SIMD Sort */
__m64 __attribute__((const)) bitonic_4_uint8_t_vec(__m64 v) {
...
void inline __attribute__((always_inline)) bitonic_4_uint8_t(uint8_t * const arr) {
...
#define TYPE uint8_t
#define N 4
#define SORT_NAME bitonic_4_uint8_t
