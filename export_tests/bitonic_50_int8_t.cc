...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_50_int8_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_50_int8_t(int8_t * const arr) {
...
fill_works(v);_mm512_mask_storeu_epi8((void *)arr, 0x3ffffffffffff, v);
