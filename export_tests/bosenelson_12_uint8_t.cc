...
#define TYPE uint8_t
#define N 12
#define SORT_NAME bosenelson_12_uint8_t

#ifndef _SIMD_SORT_bosenelson_12_uint8_t_H_
#define _SIMD_SORT_bosenelson_12_uint8_t_H_
...
bosenelson_12_uint8_t_vec(__m128i v) {
      ...
      /* Perm:  (15, 14, 13, 12,  8,  9, 10, 11,  6,  7,  2,  3,  4,  5,  0,  
                 1) */
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 8, 9, 
                                       10, 11, 6, 7, 2, 3, 4, 5, 0, 1));
      __m128i min2 = _mm_min_epu8(v1, perm2);
      __m128i max2 = _mm_max_epu8(v1, perm2);
      __m128i v2 = _mm_mask_mov_epi8(max2, 0x34d, min2);
      
      /* Pairs: ([15,15], [14,14], [13,13], [12,12], [5,11], [7,10], [6,9], 
                 [8,8], [1,4], [0,3], [2,2]) */
      /* Perm:  (15, 14, 13, 12,  5,  7,  6,  8, 10,  9, 11,  1,  0,  2,  4,  
                 3) */
      __m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 5, 7, 
                                       6, 8, 10, 9, 11, 1, 0, 2, 4, 3));
      ...
      __m128i v11 = _mm_mask_mov_epi8(max11, 0x20, min11);
...
bosenelson_12_uint8_t(uint8_t * const 
                             arr) {
