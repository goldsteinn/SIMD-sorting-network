...
#define N 4
#define SORT_NAME minimum_4_uint64_t

#ifndef _SIMD_SORT_minimum_4_uint64_t_H_
#define _SIMD_SORT_minimum_4_uint64_t_H_
...
/* SIMD Sort */
__m256i __attribute__((const)) minimum_4_uint64_t_vec(__m256i v) {
...
void inline __attribute__((always_inline)) minimum_4_uint64_t(uint64_t * const arr) {
...
fill_works(v);
v = minimum_4_uint64_t_vec(v);

fill_works(v);_mm256_mask_storeu_epi64((void *)arr, 0xf, v);
