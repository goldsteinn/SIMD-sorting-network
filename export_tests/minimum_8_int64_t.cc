...
#define TYPE int64_t
#define N 8
#define SORT_NAME minimum_8_int64_t

#ifndef _SIMD_SORT_minimum_8_int64_t_H_
#define _SIMD_SORT_minimum_8_int64_t_H_
...
minimum_8_int64_t_vec(__m512i v) {
...
minimum_8_int64_t(int64_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_8_int64_t_vec(v);
