...
#define TYPE int16_t
#define N 5
#define SORT_NAME minimum_5_int16_t

#ifndef _SIMD_SORT_minimum_5_int16_t_H_
#define _SIMD_SORT_minimum_5_int16_t_H_
...
/* SIMD Sort */
__m128i __attribute__((const)) minimum_5_int16_t_vec(__m128i v) {

/* Pairs: ([7,7], [6,6], [5,5], [1,4], [0,3], [2,2]) */
/* Perm:  ( 7,  6,  5,  1,  0,  2,  4,  3) */
__m128i perm0 = _mm_shuffle_epi8(v, _mm_set_epi8(15, 14, 13, 12, 11, 10, 3, 2, 1, 0, 5, 4, 9, 8, 7, 6));
...
__m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(15, 14, 13, 12, 11, 10, 5, 4, 7, 6, 9, 8, 1, 0, 3, 2));
...
__m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 13, 12, 11, 10, 7, 6, 9, 8, 3, 2, 5, 4, 1, 0));
__m128i min3 = _mm_min_epi16(v2, perm3);
__m128i max3 = _mm_max_epi16(v2, perm3);
__m128i v3 = _mm_blend_epi16(max3, min3, 0xa);
...
void inline __attribute__((always_inline)) minimum_5_int16_t(int16_t * const arr) {

__m128i _tmp0 = _mm_set1_epi16(int16_t(0x7fff));
__m128i v = _mm_mask_loadu_epi16(_tmp0, 0x1f, arr);
fill_works(v);
v = minimum_5_int16_t_vec(v);
