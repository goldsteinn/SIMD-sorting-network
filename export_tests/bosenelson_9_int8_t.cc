...
#define TYPE int8_t
#define N 9
#define SORT_NAME bosenelson_9_int8_t

#ifndef _SIMD_SORT_bosenelson_9_int8_t_H_
#define _SIMD_SORT_bosenelson_9_int8_t_H_
...
bosenelson_9_int8_t_vec(__m128i v) {
