...
bitonic_24_uint8_t_vec(__m256i v) {
      ...
      __m256i perm3 = _mm256_permutexvar_epi8(_mm256_set_epi8(31, 30, 29, 28, 
                                              27, 26, 25, 24, 19, 20, 21, 22, 
                                              23, 18, 17, 12, 13, 14, 15, 16, 
...
bitonic_24_uint8_t(uint8_t * const arr) 
                                 {
