...
bitonic_22_uint16_t_vec(__m512i v) {
      ...
      __m512i perm1 = _mm512_shuffle_epi8(v0, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          41, 40, 43, 42, 37, 36, 33, 32, 35, 
                                          34, 31, 30, 27, 26, 29, 28, 25, 24, 
                                          23, 22, 21, 20, 17, 16, 19, 18, 11, 
      ...
      __m512i perm2 = _mm512_shuffle_epi8(v1, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          27, 26, 19, 18, 21, 20, 17, 16, 15, 
                                          14, 11, 10, 13, 12, 3, 2, 5, 4, 7, 
                                          6, 9, 8, 1, 0));
      ...
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               ...
                                               17, 18, 19, 20, 21, 16, 13, 
                                               12, 15, 14, 11, 10, 5, 6, 7, 
                                               8, 9, 4, 0, 1, 2, 3), v2);
      ...
      __m512i perm4 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               20, 21, 17, 16, 19, 18, 14, 
                                               15, 12, 13, 11, 8, 7, 10, 9, 
                                               5, 6, 4, 2, 3, 0, 1), v3);
      ...
      __m512i perm5 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               13, 14, 18, 19, 16, 17, 15, 
                                               20, 21, 12, 11, 9, 10, 7, 8, 
                                               1, 2, 4, 3, 5, 6, 0), v4);
      ...
      __m512i perm7 = _mm512_shuffle_epi8(v6, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          36, 23, 22, 25, 24, 27, 26, 29, 28, 
                                          31, 30, 17, 16, 19, 18, 21, 20, 9, 
                                          8, 7, 6, 11, 10, 15, 14, 13, 12, 1, 
                                          0, 3, 2, 5, 4));
      ...
      __m512i perm8 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 23, 22, 
                                               21, 19, 20, 18, 15, 16, 17, 
                                               14, 11, 12, 13, 10, 7, 8, 9, 
                                               6, 4, 5, 3, 1, 2, 0), v7);
      ...
      __m512i perm11 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                                28, 27, 26, 25, 24, 23, 22, 
                                                17, 16, 19, 18, 21, 20, 15, 
                                                14, 5, 6, 7, 2, 1, 0, 11, 12, 
                                                13, 4, 3, 10, 9, 8), v10);
...
bitonic_22_uint16_t(uint16_t * const 
                             arr) {
