...
#define N 7
#define SORT_NAME oddeven_7_uint16_t

#ifndef _SIMD_SORT_oddeven_7_uint16_t_H_
#define _SIMD_SORT_oddeven_7_uint16_t_H_
...
Sorting Network Information:
	...
	SIMD Type                        : __m128i
	SIMD Instruction Set(s) Used     : AVX512vl, AVX512bw, SSE2, SSE4.1, SSSE3, AVX2
...
oddeven_7_uint16_t_vec(__m128i v) {
      ...
      __m128i perm4 = _mm_shuffle_epi32(v3, uint8_t(0xd8));
      __m128i min4 = _mm_min_epu16(v3, perm4);
      __m128i max4 = _mm_max_epu16(v3, perm4);
      __m128i v4 = _mm_blend_epi32(max4, min4, 0x2);
