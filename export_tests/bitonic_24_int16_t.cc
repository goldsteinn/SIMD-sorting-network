...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_24_int16_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_24_int16_t(int16_t * const arr) {

__m512i v = _mm512_mask_loadu_epi16(_mm512_set1_epi16(int16_t(0x7fff)), 0xffffff, arr);
