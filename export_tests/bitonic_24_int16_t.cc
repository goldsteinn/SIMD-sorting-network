...
#define TYPE int16_t
#define N 24
#define SORT_NAME bitonic_24_int16_t

#ifndef _SIMD_SORT_bitonic_24_int16_t_H_
#define _SIMD_SORT_bitonic_24_int16_t_H_
...
bitonic_24_int16_t_vec(__m512i v) {
      ...
      __m512i perm2 = _mm512_shuffle_epi8(v1, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          34, 31, 30, 29, 28, 25, 24, 27, 26, 
                                          21, 20, 23, 22, 19, 18, 17, 16, 13, 
      ...
      __m512i perm3 = _mm512_permutexvar_epi16(_mm512_set_epi16(31, 30, 29, 
                                               28, 27, 26, 25, 24, 19, 20, 
                                               21, 22, 23, 18, 17, 12, 13, 
                                               14, 15, 16, 11, 6, 7, 8, 9, 
                                               10, 1, 2, 3, 4, 5, 0), v2);
      ...
      __m512i perm5 = _mm512_shuffle_epi8(v4, _mm512_set_epi8(63, 62, 61, 60, 
                                          ...
                                          34, 29, 28, 31, 30, 27, 26, 25, 24, 
                                          21, 20, 23, 22, 17, 16, 19, 18, 15, 
                                          14, 13, 12, 11, 10, 9, 8, 5, 4, 7, 
                                          6, 1, 0, 3, 2));
...
bitonic_24_int16_t(int16_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_24_int16_t_vec(v);
