...
#define TYPE int32_t
#define N 6
#define SORT_NAME bosenelson_6_int32_t

#ifndef _SIMD_SORT_bosenelson_6_int32_t_H_
#define _SIMD_SORT_bosenelson_6_int32_t_H_
...
bosenelson_6_int32_t_vec(__m256i v) {
...
bosenelson_6_int32_t(int32_t * const 
                             arr) {
