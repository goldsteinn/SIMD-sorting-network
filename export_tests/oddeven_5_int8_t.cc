...
#define TYPE int8_t
#define N 5
#define SORT_NAME oddeven_5_int8_t

#ifndef _SIMD_SORT_oddeven_5_int8_t_H_
#define _SIMD_SORT_oddeven_5_int8_t_H_
...
oddeven_5_int8_t_vec(__m64 v) {
      ...
      __m64 perm3 = _mm_shuffle_pi8(v2, _mm_set_pi8(7, 6, 5, 2, 3, 4, 1, 
                                                    0));
