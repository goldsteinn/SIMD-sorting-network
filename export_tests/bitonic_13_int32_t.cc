...
#define TYPE int32_t
#define N 13
#define SORT_NAME bitonic_13_int32_t

#ifndef _SIMD_SORT_bitonic_13_int32_t_H_
#define _SIMD_SORT_bitonic_13_int32_t_H_
...
bitonic_13_int32_t_vec(__m512i v) {
...
bitonic_13_int32_t(int32_t * const arr) 
                             {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = bitonic_13_int32_t_vec(v);
