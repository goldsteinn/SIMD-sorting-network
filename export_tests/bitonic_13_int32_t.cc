...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_13_int32_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_13_int32_t(int32_t * const arr) {

__m512i v = _mm512_mask_loadu_epi32(_mm512_set1_epi32(int32_t(0x7fffffff)), 0x1fff, arr);
v = bitonic_13_int32_t_vec(v);
_mm512_mask_storeu_epi32((void *)arr, 0x1fff, v);
