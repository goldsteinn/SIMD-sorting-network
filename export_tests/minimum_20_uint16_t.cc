...
#define N 20
#define SORT_NAME minimum_20_uint16_t

#ifndef _SIMD_SORT_minimum_20_uint16_t_H_
#define _SIMD_SORT_minimum_20_uint16_t_H_
...
minimum_20_uint16_t_vec(__m512i v) {
      ...
      __m512i v1 = _mm512_mask_mov_epi16(max1, 0x33533, min1);
      ...
      __m512i v2 = _mm512_mask_mov_epi16(max2, 0x55055, min2);
      ...
      __m512i v6 = _mm512_mask_mov_epi16(max6, 0xaaaa, min6);
...
minimum_20_uint16_t(uint16_t * const 
                             arr) {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = minimum_20_uint16_t_vec(v);
