...
/* SIMD Sort */
__m512i __attribute__((const)) bitonic_37_int8_t_vec(__m512i v) {
...
void inline __attribute__((always_inline)) bitonic_37_int8_t(int8_t * const arr) {

__m512i v = _mm512_mask_loadu_epi8(_mm512_set1_epi8(int8_t(0x7f)), 0x1fffffffff, arr);
v = bitonic_37_int8_t_vec(v);
_mm512_mask_storeu_epi8((void *)arr, 0x1fffffffff, v);
