...
#define TYPE uint8_t
#define N 27
#define SORT_NAME batcher_27_uint8_t

#ifndef _SIMD_SORT_batcher_27_uint8_t_H_
#define _SIMD_SORT_batcher_27_uint8_t_H_
...
batcher_27_uint8_t_vec(__m256i v) {
      ...
      __m256i v0 = _mm256_mask_mov_epi8(max0, 0x7ff, min0);
      ...
      __m256i v1 = _mm256_mask_mov_epi8(max1, 0x700ff, min1);
      ...
      __m256i v5 = _mm256_mask_mov_epi8(max5, 0x70f0f0, min5);
      ...
      __m256i v6 = _mm256_mask_mov_epi8(max6, 0x1333330, min6);
