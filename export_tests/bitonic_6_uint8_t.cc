...
#define TYPE uint8_t
#define N 6
#define SORT_NAME bitonic_6_uint8_t

#ifndef _SIMD_SORT_bitonic_6_uint8_t_H_
#define _SIMD_SORT_bitonic_6_uint8_t_H_
...
bitonic_6_uint8_t_vec(__m64 v) {
      ...
      __m64 _tmp1 = (__m64)(0xff0000ff00UL);
      ...
      __m64 _tmp5 = (__m64)(0xff0000ffffUL);
...
bitonic_6_uint8_t(uint8_t * const arr) 
                             {
