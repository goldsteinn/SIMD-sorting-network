...
#define N 8
#define SORT_NAME bosenelson_8_uint32_t

#ifndef _SIMD_SORT_bosenelson_8_uint32_t_H_
#define _SIMD_SORT_bosenelson_8_uint32_t_H_
...
Sorting Network Information:
	...
	SIMD Type                        : __m256i
	SIMD Instruction Set(s) Used     : AVX2, SSE2, AVX, AVX512f, AVX512vl
...
bosenelson_8_uint32_t_vec(__m256i v) {
      ...
      __m256i perm2 = _mm256_permutevar8x32_epi32(v1, _mm256_set_epi32(3, 5, 
                                                  6, 0, 7, 1, 2, 4));
      __m256i min2 = _mm256_min_epu32(v1, perm2);
      __m256i max2 = _mm256_max_epu32(v1, perm2);
      __m256i v2 = _mm256_blend_epi32(max2, min2, 0x2b);
      
      /* Pairs: ([7,7], [2,6], [1,5], [4,4], [3,3], [0,0]) */
      /* Perm:  ( 7,  2,  1,  4,  3,  6,  5,  0) */
      __m256i perm3 = _mm256_permutevar8x32_epi32(v2, _mm256_set_epi32(7, 2, 
                                                  1, 4, 3, 6, 5, 0));
      ...
      __m256i perm5 = _mm256_permute4x64_epi64(v4, 0xd8);
      __m256i min5 = _mm256_min_epu32(v4, perm5);
      __m256i max5 = _mm256_max_epu32(v4, perm5);
      __m256i v5 = _mm256_blend_epi32(max5, min5, 0xc);
      
      /* Pairs: ([7,7], [6,6], [5,5], [3,4], [2,2], [1,1], [0,0]) */
      /* Perm:  ( 7,  6,  5,  3,  4,  2,  1,  0) */
      __m256i perm6 = _mm256_permutevar8x32_epi32(v5, _mm256_set_epi32(7, 6, 
                                                  5, 3, 4, 2, 1, 0));
      __m256i min6 = _mm256_min_epu32(v5, perm6);
      __m256i max6 = _mm256_max_epu32(v5, perm6);
      __m256i v6 = _mm256_blend_epi32(max6, min6, 0x8);
...
bosenelson_8_uint32_t(uint32_t * const 
                             arr) {
