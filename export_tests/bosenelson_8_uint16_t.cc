...
#define N 8
#define SORT_NAME bosenelson_8_uint16_t

#ifndef _SIMD_SORT_bosenelson_8_uint16_t_H_
#define _SIMD_SORT_bosenelson_8_uint16_t_H_
...
bosenelson_8_uint16_t_vec(__m128i v) {
      ...
      __m128i perm2 = _mm_shuffle_epi8(v1, _mm_set_epi8(7, 6, 11, 10, 13, 12, 
                                       1, 0, 15, 14, 3, 2, 5, 4, 9, 8));
      __m128i min2 = _mm_min_epu16(v1, perm2);
      __m128i max2 = _mm_max_epu16(v1, perm2);
      __m128i v2 = _mm_blend_epi16(max2, min2, 0x2b);
      
      /* Pairs: ([7,7], [2,6], [1,5], [4,4], [3,3], [0,0]) */
      /* Perm:  ( 7,  2,  1,  4,  3,  6,  5,  0) */
      __m128i perm3 = _mm_shuffle_epi8(v2, _mm_set_epi8(15, 14, 5, 4, 3, 2, 
                                       9, 8, 7, 6, 13, 12, 11, 10, 1, 0));
      ...
      __m128i perm5 = _mm_shuffle_epi32(v4, uint8_t(0xd8));
      __m128i min5 = _mm_min_epu16(v4, perm5);
      __m128i max5 = _mm_max_epu16(v4, perm5);
      __m128i v5 = _mm_blend_epi32(max5, min5, 0x2);
      ...
      __m128i v6 = _mm_blend_epi16(max6, min6, 0x8);
...
bosenelson_8_uint16_t(uint16_t * const 
                             arr) {
