...
#define N 5
#define SORT_NAME oddeven_5_uint64_t

#ifndef _SIMD_SORT_oddeven_5_uint64_t_H_
#define _SIMD_SORT_oddeven_5_uint64_t_H_
...
oddeven_5_uint64_t_vec(__m512i v) {
      ...
      __m512i v0 = _mm512_mask_mov_epi64(max0, 0x5, min0);
      ...
      __m512i perm3 = _mm512_permutexvar_epi64(_mm512_set_epi64(7, 6, 5, 2, 
                                               3, 4, 1, 0), v2);
      __m512i min3 = _mm512_min_epu64(v2, perm3);
      __m512i max3 = _mm512_max_epu64(v2, perm3);
      __m512i v3 = _mm512_mask_mov_epi64(max3, 0x4, min3);
