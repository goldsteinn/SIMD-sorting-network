...
#define TYPE uint8_t
#define N 36
#define SORT_NAME batcher_36_uint8_t

#ifndef _SIMD_SORT_batcher_36_uint8_t_H_
#define _SIMD_SORT_batcher_36_uint8_t_H_
...
batcher_36_uint8_t_vec(__m512i v) {
      ...
      __m512i perm0 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              ...
                                              10, 9, 8, 7, 6, 5, 4, 19, 18, 
                                              17, 16, 31, 30, 29, 28, 27, 26, 
                                              25, 24, 23, 22, 21, 20, 35, 34, 
                                              33, 32), v);
      ...
      __m512i v1 = _mm512_mask_mov_epi8(max1, 0xf000ff, min1);
      ...
      __m512i v2 = _mm512_mask_mov_epi8(max2, 0xff00f, min2);
      ...
      __m512i v3 = _mm512_mask_mov_epi8(max3, 0xf0f0f, min3);
      ...
      __m512i v4 = _mm512_mask_mov_epi8(max4, 0xf000f03, min4);
      
      __m512i perm5 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              59, 58, 57, 56, 55, 54, 53, 52, 
                                              51, 50, 49, 48, 47, 46, 45, 44, 
                                              43, 42, 41, 40, 39, 38, 37, 36, 
                                              7, 6, 5, 4, 27, 26, 25, 24, 31, 
                                              30, 29, 28, 19, 18, 17, 16, 23, 
                                              22, 21, 20, 11, 10, 9, 8, 15, 
                                              14, 13, 12, 35, 34, 33, 32, 3, 
                                              2, 0, 1), v4);
      __m512i min5 = _mm512_min_epu8(v4, perm5);
      __m512i max5 = _mm512_max_epu8(v4, perm5);
      __m512i v5 = _mm512_mask_mov_epi8(max5, 0xf0f0ff1, min5);
      ...
      __m512i v6 = _mm512_mask_mov_epi8(max6, 0xf0f0f0, min6);
      ...
      __m512i v8 = _mm512_mask_mov_epi8(max8, 0x333333330, min8);
      
      __m512i perm9 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 60, 
                                              59, 58, 57, 56, 55, 54, 53, 52, 
                                              51, 50, 49, 48, 47, 46, 45, 44, 
                                              43, 42, 41, 40, 39, 38, 37, 36, 
                                              34, 35, 3, 2, 31, 30, 15, 14, 
                                              27, 26, 11, 10, 23, 22, 7, 6, 
                                              19, 18, 17, 16, 29, 28, 13, 12, 
                                              25, 24, 9, 8, 21, 20, 5, 4, 33, 
                                              32, 1, 0), v8);
      __m512i min9 = _mm512_min_epu8(v8, perm9);
      __m512i max9 = _mm512_max_epu8(v8, perm9);
      __m512i v9 = _mm512_mask_mov_epi8(max9, 0x40000cccc, min9);
      ...
      __m512i perm10 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               18, 31, 30, 23, 22, 27, 26, 
                                               25, 24, 29, 28, 15, 14, 33, 
                                               32, 3, 2, 21, 20, 7, 6, 11, 
                                               10, 9, 8, 13, 12, 5, 4, 17, 
                                               16, 1, 0), v9);
      __m512i min10 = _mm512_min_epu8(v9, perm10);
      __m512i max10 = _mm512_max_epu8(v9, perm10);
      __m512i v10 = _mm512_mask_mov_epi8(max10, 0xccc0cc, min10);
      ...
      __m512i perm11 = _mm512_permutexvar_epi8(_mm512_set_epi8(63, 62, 61, 
                                               ...
                                               26, 31, 30, 29, 28, 33, 32, 
                                               19, 18, 23, 22, 21, 20, 25, 
                                               24, 11, 10, 15, 14, 13, 12, 
                                               17, 16, 3, 2, 7, 6, 5, 4, 9, 
                                               8, 1, 0), v10);
      __m512i min11 = _mm512_min_epu8(v10, perm11);
      __m512i max11 = _mm512_max_epu8(v10, perm11);
      __m512i v11 = _mm512_mask_mov_epi8(max11, 0xc0c0c0c, min11);
...
batcher_36_uint8_t(uint8_t * const arr) 
                                 {
      
      __m512i v = _mm512_load_si512((__m512i *)arr);
      
      v = batcher_36_uint8_t_vec(v);
