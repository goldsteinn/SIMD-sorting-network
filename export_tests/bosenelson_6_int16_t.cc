...
#define TYPE int16_t
#define N 6
#define SORT_NAME bosenelson_6_int16_t

#ifndef _SIMD_SORT_bosenelson_6_int16_t_H_
#define _SIMD_SORT_bosenelson_6_int16_t_H_
...
bosenelson_6_int16_t_vec(__m128i v) {
...
bosenelson_6_int16_t(int16_t * const 
                             arr) {
      
      __m128i v = _mm_load_si128((__m128i *)arr);
      
      v = bosenelson_6_int16_t_vec(v);
