...
/* SIMD Sort */
__m256i __attribute__((const)) bitonic_5_int32_t_vec(__m256i v) {
...
void inline __attribute__((always_inline)) bitonic_5_int32_t(int32_t * const arr) {

__m256i v = _mm256_mask_loadu_epi32(_mm256_set1_epi32(int32_t(0x7fffffff)), 0x1f, arr);
