...
#define TYPE uint8_t
#define N 8
#define SORT_NAME oddeven_8_uint8_t

#ifndef _SIMD_SORT_oddeven_8_uint8_t_H_
#define _SIMD_SORT_oddeven_8_uint8_t_H_
...
oddeven_8_uint8_t(uint8_t * const arr) 
                             {
